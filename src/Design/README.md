...
StubOverrides/           # Stub overrides
  StubOverrideBasics.cs  # Base class pattern with protected override
...
Sequences (Return().ThenReturn(), Get().ThenGet(), etc.) **repeat the last value** after exhaustion. This matches NSubstitute's behavior for easier migration and more forgiving tests.
...
stub.Add.Return((a, b) => 1).ThenReturn((a, b) => 2).ThenDefault();
calc.Add(0, 0); // Returns 1
calc.Add(0, 0); // Returns 2
