...
Sequences (Return().ThenReturn(), OnGet().ThenGet(), etc.) **repeat the last value** after exhaustion. This matches NSubstitute's behavior for easier migration and more forgiving tests.
