...
partial class EntityRepositoryStub : global::KnockOff.Benchmarks.Interfaces.IRepository<global::KnockOff.Benchmarks.Interfaces.Entity>, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveInterceptor
	{
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Benchmarks.Interfaces.Entity? LastCallArg { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
