...
partial class PropertyServiceStub : global::KnockOff.Benchmarks.Interfaces.IPropertyService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ReadOnlyValueInterceptor
	{
		...
		/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
		public ReadOnlyValueInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

		/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
		public ReadOnlyValueInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
		...
		private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
		{
			private readonly ReadOnlyValueInterceptor _interceptor;

			public PropertyGetTrackingImpl(ReadOnlyValueInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<int>
		{
			...
			public PropertyGetSequenceImpl(ReadOnlyValueInterceptor interceptor) => _interceptor = interceptor;
	...
	public sealed class WriteOnlyValueInterceptor
	{
		...
		/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
		public WriteOnlyValueInterceptor Verifiable() { _isSetVerifiable = true; _setVerifiableTimes = null; return this; }

		/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
		public WriteOnlyValueInterceptor Verifiable(global::KnockOff.Times times) { _isSetVerifiable = true; _setVerifiableTimes = times; return this; }
		...
		{
			private readonly WriteOnlyValueInterceptor _interceptor;

			public PropertySetTrackingImpl(WriteOnlyValueInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertySetSequenceImpl : global::KnockOff.IPropertySetSequence<int>
		{
			...
			public PropertySetSequenceImpl(WriteOnlyValueInterceptor interceptor) => _interceptor = interceptor;
