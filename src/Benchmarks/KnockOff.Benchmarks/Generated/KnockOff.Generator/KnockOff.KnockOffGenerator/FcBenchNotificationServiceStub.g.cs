...
partial class FcBenchNotificationServiceStub
{
	...
	public sealed class SendOrderConfirmationInterceptor
	{
		...
		public global::System.Action<FcBenchNotificationServiceStub, int, int>? OnCall { get; set; }
	...
	public sealed class SendPaymentFailureInterceptor
	{
		...
		/// <summary>Callback invoked when this method is called.</summary>
		public global::System.Action<FcBenchNotificationServiceStub, int, string>? OnCall { get; set; }
	...
	void global::KnockOff.Benchmarks.Benchmarks.IFcBenchNotificationService.SendPaymentFailure(int customerId, string reason)
	{
