...
partial class AsyncServiceStub : global::KnockOff.Benchmarks.Interfaces.IAsyncService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetValueAsyncInterceptor
	{
		...
		{
			if (!times.Validate(CallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetValueAsync", times, CallCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("GetValueAsync", times, CallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("GetValueAsync", global::KnockOff.Times.AtLeastOnce, CallCount);
		}
	...
	public sealed class GetStringValueAsyncInterceptor
	{
		...
		{
			if (!times.Validate(CallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetStringValueAsync", times, CallCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("GetStringValueAsync", times, CallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("GetStringValueAsync", global::KnockOff.Times.AtLeastOnce, CallCount);
		}
