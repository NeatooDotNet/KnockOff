...
partial class AsyncServiceStub : global::KnockOff.Benchmarks.Interfaces.IAsyncService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetValueAsyncInterceptor
	{
		...
		private global::System.Collections.Generic.List<(GetValueAsyncDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetValueAsync", times, TotalCallCount));
		}
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<GetValueAsyncDelegate> OnCallSequence(GetValueAsyncDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetValueAsyncDelegate Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		internal global::System.Threading.Tasks.Task<int> Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetValueAsync");
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetValueAsync", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetValueAsync", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(GetValueAsyncInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetValueAsyncDelegate>
		{
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<GetValueAsyncDelegate> ThenCall(GetValueAsyncDelegate callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<GetValueAsyncDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public sealed class GetStringValueAsyncInterceptor
	{
		...
		private global::System.Collections.Generic.List<(GetStringValueAsyncDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetStringValueAsync", times, TotalCallCount));
		}
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<GetStringValueAsyncDelegate> OnCallSequence(GetStringValueAsyncDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetStringValueAsyncDelegate Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		internal global::System.Threading.Tasks.ValueTask<string> Invoke(bool strict)
		{
			...
			{
				_onCallValueTracking.RecordCall();
				return new global::System.Threading.Tasks.ValueTask<string>(_onCallValue);
			}
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetStringValueAsync");
				return default!;
			}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetStringValueAsync", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetStringValueAsync", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(GetStringValueAsyncInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetStringValueAsyncDelegate>
		{
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<GetStringValueAsyncDelegate> ThenCall(GetStringValueAsyncDelegate callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<GetStringValueAsyncDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public void Verify()
	{
		...
		if (GetValueAsync.CheckVerification() is { } getvalueasyncFailure) failures.Add(getvalueasyncFailure);
		if (GetStringValueAsync.CheckVerification() is { } getstringvalueasyncFailure) failures.Add(getstringvalueasyncFailure);
	...
	public void VerifyAll()
	{
		...
		if (GetValueAsync.CheckVerificationAll() is { } getvalueasyncFailure) failures.Add(getvalueasyncFailure);
		if (GetStringValueAsync.CheckVerificationAll() is { } getstringvalueasyncFailure) failures.Add(getstringvalueasyncFailure);
