...
partial class FcBenchProductRepositoryStub : global::KnockOff.Benchmarks.Benchmarks.IFcBenchProductRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetByIdAsyncInterceptor
	{
		...
		private global::KnockOff.Benchmarks.Benchmarks.FcBenchProduct? _onCallValue = default!;
		...
		public global::KnockOff.IMethodTracking<int> OnCall(global::KnockOff.Benchmarks.Benchmarks.FcBenchProduct? value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
	...
	public sealed class GetAllAsyncInterceptor
	{
		...
		private global::System.Collections.Generic.IEnumerable<global::KnockOff.Benchmarks.Benchmarks.FcBenchProduct> _onCallValue = default!;
		private bool _hasOnCallValue;
		private MethodTrackingImpl? _onCallValueTracking;
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetAllAsync", times, TotalCallCount));
		}
		...
		/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking OnCall(global::System.Collections.Generic.IEnumerable<global::KnockOff.Benchmarks.Benchmarks.FcBenchProduct> value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetAllAsync", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetAllAsync", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
	...
	public sealed class SaveAsyncInterceptor
	{
		...
		/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Benchmarks.Benchmarks.FcBenchProduct> OnCall(global::System.Threading.Tasks.Task value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		internal global::System.Threading.Tasks.Task Invoke(bool strict, global::KnockOff.Benchmarks.Benchmarks.FcBenchProduct product)
		{
			...
			if (_hasOnCallValue && _onCallValueTracking != null)
			{
				_onCallValueTracking.RecordCall(product);
				return _onCallValue;
			}
	...
	public sealed class DeleteAsyncInterceptor
	{
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("DeleteAsync", times, TotalCallCount));
		}
		...
		/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<int> OnCall(global::System.Threading.Tasks.Task value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("DeleteAsync", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("DeleteAsync", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
