...
public class SetupBenchmarks
{
    ...
    public CalculatorStub KnockOff_SetupMultiple()
    {
        ...
        stub.Subtract.Call((int a, int b) => 2);
        stub.Multiply.Call((int a, int b) => 3);
        stub.Divide.Call((double a, double b) => 4.0);
