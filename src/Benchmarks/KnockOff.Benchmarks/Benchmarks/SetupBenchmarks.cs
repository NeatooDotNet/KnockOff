...
public class SetupBenchmarks
{
    ...
    public CalculatorStub KnockOff_SetupMultiple()
    {
        ...
        stub.Subtract.OnCall((a, b) => 2);
        stub.Multiply.OnCall((a, b) => 3);
        stub.Divide.OnCall((a, b) => 4.0);
        stub.Square.OnCall((x) => 5);
        return stub;
    }
