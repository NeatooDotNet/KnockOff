...
public class VerificationBenchmarks
{
    ...
    private IMethodTracking<(int, int)> _knockOffCalculatorTracking = null!;
#pragma warning restore CA1859
    ...
    public void Setup()
    {
        ...
        _knockOffSimpleTracking = _knockOffSimple.DoWork.Call(() => { });
    ...
    {
        _knockOffSimpleTracking.Verify(Called.Exactly(3));
    }
    ...
    {
        var args = _knockOffCalculatorTracking.LastArg;
    ...
    {
        _knockOffSimpleTracking.Verify(Called.AtLeastOnce);
        _knockOffSimpleTracking.Verify(Called.Exactly(3));
        _knockOffCalculatorTracking.Verify(Called.Exactly(2));
    }
