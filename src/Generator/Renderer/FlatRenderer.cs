...
internal static class FlatRenderer
{
	public static string Render(FlatGenerationUnit unit)
	{
		...
		// Justification: Stubbing interfaces with obsolete serialization members (e.g., ISerializable.GetObjectData)
		// generates method signatures that reference SYSLIB0050-obsolete types. The generator cannot know at
		// emit time whether the target interface uses obsolete types, so this blanket suppression is required.
		w.Line("#pragma warning disable SYSLIB0050 // Obsolete serialization API -- generated stubs may implement interfaces with obsolete members");
		w.Line();
	...
	public static string RenderBaseClass(FlatGenerationUnit unit)
	{
		...
		w.Line("// <auto-generated/>");
		w.Line("#nullable enable");
		// Justification: Same as Render() — obsolete serialization interfaces require SYSLIB0050 suppression.
		w.Line("#pragma warning disable SYSLIB0050 // Obsolete serialization API -- generated stubs may implement interfaces with obsolete members");
		w.Line();
