...
internal static class StandaloneClassRenderer
{
    public static string Render(StandaloneClassGenerationUnit unit)
    {
        ...
        // Justification: Stubbing classes that implement interfaces with obsolete serialization members
        // (e.g., ISerializable.GetObjectData) generates method signatures that reference SYSLIB0050-obsolete types.
        // The generator cannot know at emit time whether the target class uses obsolete types, so this blanket
