...
/// <summary>
/// Pre-compiled interceptor for non-void methods with 5 parameters.
...
public sealed class MethodInterceptor5<T1, T2, T3, T4, T5, TReturn>
{
    private readonly string _memberName;

    // Callback
    private Func<T1, T2, T3, T4, T5, TReturn>? _call;
    ...
    // Sequence
    private List<(Func<T1, T2, T3, T4, T5, TReturn> Callback, MethodCallBuilder5 Tracking)>? _sequence;
    ...
    public TReturn Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return matcher.CallReturn(arg1, arg2, arg3, arg4, arg5);
            }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            return _call(arg1, arg2, arg3, arg4, arg5);
        }
        ...
        if (_fallback != null) return _fallback(arg1, arg2, arg3, arg4, arg5);

        // Source fallback
        if (_sourceFallback != null) return _sourceFallback(arg1, arg2, arg3, arg4, arg5);
    ...
    {
        var builder = Return((_, _, _, _, _) => first);
        if (rest.Length == 0)
        {
    ...
    public void SetFallback(Func<T1, T2, T3, T4, T5, TReturn>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, TReturn>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public WhenMatcherValue(Func<T1, T2, T3, T4, T5, bool> predicate, TReturn value)
        {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) => _value;
    ...
    {
        private readonly Func<T1, T2, T3, T4, T5, TReturn> _callback;

        public WhenMatcherCall(Func<T1, T2, T3, T4, T5, TReturn> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) => true;
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) => _callback(arg1, arg2, arg3, arg4, arg5);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) => default!;
        public override bool IsTerminal => true;
    }
    ...
    public sealed class MethodCallBuilder5 : IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, TReturn>, (T1, T2, T3, T4, T5)>
    {
        ...
        public MethodSequence5 ThenReturn(Func<T1, T2, T3, T4, T5, TReturn> callback)
        {
            ElevateToSequence();
        ...
        public MethodSequence5 ThenReturn(TReturn value)
        {
            return ThenReturn((_, _, _, _, _) => value);
        }
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, T5, TReturn> Callback, MethodCallBuilder5 Tracking)>();
                ...
                else if (_interceptor._hasReturnValue)
                {
                    ...
                    _interceptor._sequence.Add(((_, _, _, _, _) => capturedValue, this));
    ...
    public sealed class MethodSequence5 : IMethodReturnSequence<Func<T1, T2, T3, T4, T5, TReturn>>, IMethodReturnSequence, IMethodSequence
    {
        private readonly MethodInterceptor5<T1, T2, T3, T4, T5, TReturn> _interceptor;

        internal MethodSequence5(MethodInterceptor5<T1, T2, T3, T4, T5, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        // Explicit interface implementations
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, TReturn>>.ThenReturn(Func<T1, T2, T3, T4, T5, TReturn> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, TReturn>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: WhenBuilder5
    // ========================================================================
    ...
    public sealed class WhenBuilder5
    {
        ...
        internal WhenBuilder5(MethodInterceptor5<T1, T2, T3, T4, T5, TReturn> interceptor, Func<T1, T2, T3, T4, T5, bool> predicate)
        {
            _interceptor = interceptor;
            _predicate = predicate;
        }
    ...
    public sealed class WhenChain5
    {
        ...
        internal WhenChain5(MethodInterceptor5<T1, T2, T3, T4, T5, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public WhenBuilder5 ThenWhen(Func<T1, T2, T3, T4, T5, bool> predicate)
        {
            return new WhenBuilder5(_interceptor, predicate);
        }

        /// <summary>Adds an unconditional callback as terminal matcher.</summary>
        public WhenChain5 ThenCall(Func<T1, T2, T3, T4, T5, TReturn> callback)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
