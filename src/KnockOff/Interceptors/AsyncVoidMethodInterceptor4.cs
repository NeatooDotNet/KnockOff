...
/// <summary>
/// Pre-compiled async interceptor for void methods with 4 parameters.
...
public sealed class AsyncVoidMethodInterceptor4<T1, T2, T3, T4>
{
    private readonly string _memberName;

    private Func<T1, T2, T3, T4, Task>? _call;
    private MethodCallBuilder4? _callTracking;

    private List<(Func<T1, T2, T3, T4, Task> Callback, MethodCallBuilder4 Tracking)>? _sequence;
    ...
    private Func<T1, T2, T3, T4, Task>? _fallback;
    private Func<T1, T2, T3, T4, Task>? _sourceFallback;

    public AsyncVoidMethodInterceptor4(string memberName)
    {
    ...
    public async Task Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    {
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                await matcher.Call(arg1, arg2, arg3, arg4).ConfigureAwait(false);
                return;
            }
        ...
        if (_sequence != null && _sequenceIndex < _sequence.Count)
        {
            ...
            _sequenceIndex++;
            await callback(arg1, arg2, arg3, arg4).ConfigureAwait(false);
            return;
        }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            await _call(arg1, arg2, arg3, arg4).ConfigureAwait(false);
            return;
        }
        ...
        if (_fallback != null) { await _fallback(arg1, arg2, arg3, arg4).ConfigureAwait(false); return; }
        if (_sourceFallback != null) { await _sourceFallback(arg1, arg2, arg3, arg4).ConfigureAwait(false); return; }
    ...
    public MethodCallBuilder4 Call(Func<T1, T2, T3, T4, Task> asyncCallback)
    {
    ...
    public MethodCallBuilder4 Call(Action<T1, T2, T3, T4> callback)
    {
        return Call((T1 arg1, T2 arg2, T3 arg3, T4 arg4) => { callback(arg1, arg2, arg3, arg4); return Task.CompletedTask; });
    }

    public VoidWhenBuilder4 When(T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    {
        _whenChain ??= new List<VoidWhenMatcherBase>();
        return new VoidWhenBuilder4(this, (a1, a2, a3, a4) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3) && object.Equals(a4, arg4));
    }

    public VoidWhenBuilder4 When(Func<T1, T2, T3, T4, bool> predicate)
    {
        _whenChain ??= new List<VoidWhenMatcherBase>();
        return new VoidWhenBuilder4(this, predicate);
    }

    public void SetFallback(Func<T1, T2, T3, T4, Task>? fallback) => _fallback = fallback;
    public void SetFallback(Action<T1, T2, T3, T4>? fallback) =>
        _fallback = fallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4) => { fallback(a1, a2, a3, a4); return Task.CompletedTask; } : null;
    public void SetSourceFallback(Func<T1, T2, T3, T4, Task>? sourceFallback) => _sourceFallback = sourceFallback;
    public void SetSourceFallback(Action<T1, T2, T3, T4>? sourceFallback) =>
        _sourceFallback = sourceFallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4) => { sourceFallback(a1, a2, a3, a4); return Task.CompletedTask; } : null;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        public VoidWhenMatcherPredicate(Func<T1, T2, T3, T4, bool> predicate) => _predicate = predicate;
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => _predicate(arg1, arg2, arg3, arg4);
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => _callback?.Invoke(arg1, arg2, arg3, arg4) ?? Task.CompletedTask;
        public override bool IsTerminal => false;
        public void SetCallback(Func<T1, T2, T3, T4, Task> callback) => _callback = callback;
    }

    private sealed class VoidWhenMatcherCall : VoidWhenMatcherBase
    {
        private readonly Func<T1, T2, T3, T4, Task> _callback;
        public VoidWhenMatcherCall(Func<T1, T2, T3, T4, Task> callback) => _callback = callback;
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => true;
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => _callback(arg1, arg2, arg3, arg4);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => Task.CompletedTask;
        public override bool IsTerminal => true;
    }

    public sealed class MethodCallBuilder4 : IMethodCallBuilderArgs<Func<T1, T2, T3, T4, Task>, (T1, T2, T3, T4)>
    {
        private readonly AsyncVoidMethodInterceptor4<T1, T2, T3, T4> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4) _lastArgs;

        internal MethodCallBuilder4(AsyncVoidMethodInterceptor4<T1, T2, T3, T4> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence4 ThenCall(Func<T1, T2, T3, T4, Task> asyncCallback)
        {
            ElevateToSequence();
        ...
        public MethodSequence4 ThenCall(Action<T1, T2, T3, T4> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4) => { callback(arg1, arg2, arg3, arg4); return Task.CompletedTask; });
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, Task> Callback, MethodCallBuilder4 Tracking)>();
        ...
        IMethodCallSequence<Func<T1, T2, T3, T4, Task>> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, Task>, (T1, T2, T3, T4)>.ThenCall(Func<T1, T2, T3, T4, Task> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Func<T1, T2, T3, T4, Task>, (T1, T2, T3, T4)> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, Task>, (T1, T2, T3, T4)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Func<T1, T2, T3, T4, Task>, (T1, T2, T3, T4)> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, Task>, (T1, T2, T3, T4)>.Verifiable(Called called) => Verifiable(called);
    }

    public sealed class MethodSequence4 : IMethodCallSequence<Func<T1, T2, T3, T4, Task>>, IMethodCallSequence, IMethodSequence
    {
        private readonly AsyncVoidMethodInterceptor4<T1, T2, T3, T4> _interceptor;
        internal MethodSequence4(AsyncVoidMethodInterceptor4<T1, T2, T3, T4> interceptor) => _interceptor = interceptor;
        ...
        IMethodCallSequence<Func<T1, T2, T3, T4, Task>> IMethodCallSequence<Func<T1, T2, T3, T4, Task>>.ThenCall(Func<T1, T2, T3, T4, Task> callback) => ThenCall(callback);
        IMethodCallSequence<Func<T1, T2, T3, T4, Task>> IMethodCallSequence<Func<T1, T2, T3, T4, Task>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    public sealed class VoidWhenBuilder4
    {
        private readonly AsyncVoidMethodInterceptor4<T1, T2, T3, T4> _interceptor;
        private readonly Func<T1, T2, T3, T4, bool> _predicate;
        private int _matcherIndex = -1;
        internal VoidWhenBuilder4(AsyncVoidMethodInterceptor4<T1, T2, T3, T4> interceptor, Func<T1, T2, T3, T4, bool> predicate) { _interceptor = interceptor; _predicate = predicate; }

        public VoidWhenChain4 Call(Func<T1, T2, T3, T4, Task> asyncCallback)
        {
            ...
            return new VoidWhenChain4(_interceptor, _matcherIndex);
        }

        public VoidWhenChain4 Call(Action<T1, T2, T3, T4> callback) => Call((T1 arg1, T2 arg2, T3 arg3, T4 arg4) => { callback(arg1, arg2, arg3, arg4); return Task.CompletedTask; });

        public VoidWhenChain4 ThenCall(Func<T1, T2, T3, T4, Task> asyncCallback)
        {
            EnsureRegistered();
        ...
        public VoidWhenChain4 ThenCall(Action<T1, T2, T3, T4> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4) => { callback(arg1, arg2, arg3, arg4); return Task.CompletedTask; });
    ...
    public sealed class VoidWhenChain4
    {
        private readonly AsyncVoidMethodInterceptor4<T1, T2, T3, T4> _interceptor;
        private readonly int _currentMatcherIndex;
        internal VoidWhenChain4(AsyncVoidMethodInterceptor4<T1, T2, T3, T4> interceptor, int currentMatcherIndex)
        {
            _interceptor = interceptor;
            _currentMatcherIndex = currentMatcherIndex;
        }

        public VoidWhenBuilder4 ThenWhen(T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            return new VoidWhenBuilder4(_interceptor, (a1, a2, a3, a4) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3) && object.Equals(a4, arg4));
        }

        public VoidWhenBuilder4 ThenWhen(Func<T1, T2, T3, T4, bool> predicate) => new VoidWhenBuilder4(_interceptor, predicate);
        ...
        public VoidWhenChain4 ThenNone()
        {
            _interceptor._whenChain ??= new List<VoidWhenMatcherBase>();
        ...
        public VoidWhenChain4 Verifiable() { _interceptor._whenVerifiable = true; return this; }
    }
}
