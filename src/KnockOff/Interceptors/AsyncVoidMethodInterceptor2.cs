...
/// <summary>
/// Pre-compiled async interceptor for void methods with 2 parameters.
...
public sealed class AsyncVoidMethodInterceptor2<T1, T2>
{
    private readonly string _memberName;

    private Func<T1, T2, Task>? _call;
    private MethodCallBuilder2? _callTracking;

    private List<(Func<T1, T2, Task> Callback, MethodCallBuilder2 Tracking)>? _sequence;
    ...
    private Func<T1, T2, Task>? _fallback;
    private Func<T1, T2, Task>? _sourceFallback;

    public AsyncVoidMethodInterceptor2(string memberName)
    {
    ...
    public async Task Invoke(bool strict, T1 arg1, T2 arg2)
    {
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                await matcher.Call(arg1, arg2).ConfigureAwait(false);
                return;
            }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            await _call(arg1, arg2).ConfigureAwait(false);
            return;
        }
        ...
        if (_fallback != null) { await _fallback(arg1, arg2).ConfigureAwait(false); return; }
        if (_sourceFallback != null) { await _sourceFallback(arg1, arg2).ConfigureAwait(false); return; }
    ...
    public MethodCallBuilder2 Call(Func<T1, T2, Task> asyncCallback)
    {
    ...
    {
        return Call((T1 arg1, T2 arg2) => { callback(arg1, arg2); return Task.CompletedTask; });
    }
    ...
    public void SetFallback(Func<T1, T2, Task>? fallback) => _fallback = fallback;
    public void SetFallback(Action<T1, T2>? fallback) =>
        _fallback = fallback != null ? (T1 a1, T2 a2) => { fallback(a1, a2); return Task.CompletedTask; } : null;
    public void SetSourceFallback(Func<T1, T2, Task>? sourceFallback) => _sourceFallback = sourceFallback;
    public void SetSourceFallback(Action<T1, T2>? sourceFallback) =>
        _sourceFallback = sourceFallback != null ? (T1 a1, T2 a2) => { sourceFallback(a1, a2); return Task.CompletedTask; } : null;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract Task Call(T1 arg1, T2 arg2);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        public override Task Call(T1 arg1, T2 arg2) => _callback?.Invoke(arg1, arg2) ?? Task.CompletedTask;
        public override bool IsTerminal => false;
        public void SetCallback(Func<T1, T2, Task> callback) => _callback = callback;
    }

    private sealed class VoidWhenMatcherCall : VoidWhenMatcherBase
    {
        private readonly Func<T1, T2, Task> _callback;
        public VoidWhenMatcherCall(Func<T1, T2, Task> callback) => _callback = callback;
        public override bool Matches(T1 arg1, T2 arg2) => true;
        public override Task Call(T1 arg1, T2 arg2) => _callback(arg1, arg2);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override Task Call(T1 arg1, T2 arg2) => Task.CompletedTask;
        public override bool IsTerminal => true;
    }

    public sealed class MethodCallBuilder2 : IMethodCallBuilderArgs<Func<T1, T2, Task>, (T1?, T2?)>
    {
        private readonly AsyncVoidMethodInterceptor2<T1, T2> _interceptor;
        internal int _callCount;
        private (T1?, T2?) _lastArgs;

        internal MethodCallBuilder2(AsyncVoidMethodInterceptor2<T1, T2> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence2 ThenCall(Func<T1, T2, Task> asyncCallback)
        {
            ElevateToSequence();
        ...
        public MethodSequence2 ThenCall(Action<T1, T2> callback) => ThenCall((T1 arg1, T2 arg2) => { callback(arg1, arg2); return Task.CompletedTask; });

        public MethodCallBuilder2 Verifiable() { _interceptor._isVerifiable = true; _interceptor._verifiableTimes = null; return this; }
        public MethodCallBuilder2 Verifiable(Called times) { _interceptor._isVerifiable = true; _interceptor._verifiableTimes = times; return this; }

        private void ElevateToSequence()
        {
            if (_interceptor._sequence == null)
            {
                _interceptor._sequence = new List<(Func<T1, T2, Task> Callback, MethodCallBuilder2 Tracking)>();
        ...
        IMethodCallSequence<Func<T1, T2, Task>> IMethodCallBuilderArgs<Func<T1, T2, Task>, (T1?, T2?)>.ThenCall(Func<T1, T2, Task> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Func<T1, T2, Task>, (T1?, T2?)> IMethodCallBuilderArgs<Func<T1, T2, Task>, (T1?, T2?)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Func<T1, T2, Task>, (T1?, T2?)> IMethodCallBuilderArgs<Func<T1, T2, Task>, (T1?, T2?)>.Verifiable(Called called) => Verifiable(called);
    }

    public sealed class MethodSequence2 : IMethodCallSequence<Func<T1, T2, Task>>, IMethodCallSequence, IMethodSequence
    {
        private readonly AsyncVoidMethodInterceptor2<T1, T2> _interceptor;
        internal MethodSequence2(AsyncVoidMethodInterceptor2<T1, T2> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence2 Verifiable() { _interceptor._isVerifiable = true; _interceptor._verifiableTimes = null; return this; }
        public void ThenDefault() => _interceptor._repeatLastValue = false;

        IMethodCallSequence<Func<T1, T2, Task>> IMethodCallSequence<Func<T1, T2, Task>>.ThenCall(Func<T1, T2, Task> callback) => ThenCall(callback);
        IMethodCallSequence<Func<T1, T2, Task>> IMethodCallSequence<Func<T1, T2, Task>>.Verifiable() => Verifiable();
    ...
    public sealed class VoidWhenBuilder2
    {
        private readonly AsyncVoidMethodInterceptor2<T1, T2> _interceptor;
        private readonly Func<T1, T2, bool> _predicate;
        internal VoidWhenBuilder2(AsyncVoidMethodInterceptor2<T1, T2> interceptor, Func<T1, T2, bool> predicate) { _interceptor = interceptor; _predicate = predicate; }

        public VoidWhenChain2 Call(Func<T1, T2, Task> asyncCallback)
        {
        ...
        public VoidWhenChain2 Call(Action<T1, T2> callback) => Call((T1 arg1, T2 arg2) => { callback(arg1, arg2); return Task.CompletedTask; });
    }
    ...
    public sealed class VoidWhenChain2
    {
        ...
        internal VoidWhenChain2(AsyncVoidMethodInterceptor2<T1, T2> interceptor, int currentMatcherIndex)
        {
        ...
        public VoidWhenBuilder2 ThenWhen(Func<T1, T2, bool> predicate) => new VoidWhenBuilder2(_interceptor, predicate);

        public VoidWhenChain2 ThenCall(Func<T1, T2, Task> asyncCallback)
        {
            _interceptor._whenChain ??= new List<VoidWhenMatcherBase>();
        ...
        public VoidWhenChain2 ThenCall(Action<T1, T2> callback) => ThenCall((T1 arg1, T2 arg2) => { callback(arg1, arg2); return Task.CompletedTask; });
        ...
        public VoidWhenChain2 Verifiable() { _interceptor._whenVerifiable = true; return this; }
    }
}
