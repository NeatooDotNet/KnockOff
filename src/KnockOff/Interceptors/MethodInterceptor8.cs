...
/// <summary>
/// Pre-compiled interceptor for non-void methods with 8 parameters.
...
public sealed class MethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>
{
    private readonly string _memberName;

    // Callback
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>? _call;
    ...
    // Sequence
    private List<(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> Callback, MethodCallBuilder8 Tracking)>? _sequence;
    ...
    // Fallback delegates
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>? _fallback;
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>? _sourceFallback;

    // Smart default factory (for NewInstance/ThrowException strategies)
    private readonly Func<TReturn>? _defaultFactory;

    public MethodInterceptor8(string memberName)
    {
        _memberName = memberName;
    }

    /// <summary>Constructor with smart default factory for non-strict unconfigured calls.</summary>
    public MethodInterceptor8(string memberName, Func<TReturn> defaultFactory)
    {
        _memberName = memberName;
    ...
    public TReturn Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return matcher.CallReturn(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
            }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            return _call(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        }
        ...
        if (_fallback != null) return _fallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);

        // Source fallback
        if (_sourceFallback != null) return _sourceFallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    ...
    {
        var builder = Return((_, _, _, _, _, _, _, _) => first);
        if (rest.Length == 0)
        {
    ...
    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public WhenMatcherValue(Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate, TReturn value)
        {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => _value;
    ...
    {
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> _callback;

        public WhenMatcherCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => true;
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => _callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => default!;
        public override bool IsTerminal => true;
    }
    ...
    public sealed class MethodCallBuilder8 : IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>, (T1, T2, T3, T4, T5, T6, T7, T8)>
    {
        private readonly MethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5, T6, T7, T8) _lastArgs;

        internal MethodCallBuilder8(MethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> interceptor)
        {
        ...
        public MethodSequence8 ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback)
        {
            ElevateToSequence();
        ...
        public MethodSequence8 ThenReturn(TReturn value)
        {
            return ThenReturn((_, _, _, _, _, _, _, _) => value);
        }
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> Callback, MethodCallBuilder8 Tracking)>();
                ...
                else if (_interceptor._hasReturnValue)
                {
                    ...
                    _interceptor._sequence.Add(((_, _, _, _, _, _, _, _) => capturedValue, this));
        ...
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>, (T1, T2, T3, T4, T5, T6, T7, T8)>.ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback) => ThenReturn(callback);
        ...
        IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>, (T1, T2, T3, T4, T5, T6, T7, T8)> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>, (T1, T2, T3, T4, T5, T6, T7, T8)>.Verifiable() => Verifiable();
        IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>, (T1, T2, T3, T4, T5, T6, T7, T8)> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>, (T1, T2, T3, T4, T5, T6, T7, T8)>.Verifiable(Called called) => Verifiable(called);
    }
    ...
    public sealed class MethodSequence8 : IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>>, IMethodReturnSequence, IMethodSequence
    {
        private readonly MethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> _interceptor;

        internal MethodSequence8(MethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        // Explicit interface implementations
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>>.ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: WhenBuilder8
    // ========================================================================
    ...
    public sealed class WhenBuilder8
    {
        ...
        internal WhenBuilder8(MethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> interceptor, Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate)
        {
            _interceptor = interceptor;
            _predicate = predicate;
        }
    ...
    public sealed class WhenChain8
    {
        ...
        internal WhenChain8(MethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public WhenBuilder8 ThenWhen(Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate)
        {
            return new WhenBuilder8(_interceptor, predicate);
        }

        /// <summary>Adds an unconditional callback as terminal matcher.</summary>
        public WhenChain8 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
