...
/// <summary>
/// Pre-compiled interceptor for void methods with 4 parameters.
...
public sealed class VoidMethodInterceptor4<T1, T2, T3, T4>
{
    private readonly string _memberName;

    // Callback
    private Action<T1, T2, T3, T4>? _call;
    private MethodCallBuilder4? _callTracking;

    // Sequence
    private List<(Action<T1, T2, T3, T4> Callback, MethodCallBuilder4 Tracking)>? _sequence;
    ...
    // Fallback delegates
    private Action<T1, T2, T3, T4>? _fallback;
    private Action<T1, T2, T3, T4>? _sourceFallback;

    public VoidMethodInterceptor4(string memberName)
    {
    ...
    public void Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                matcher.Call(arg1, arg2, arg3, arg4);
                return;
            }
        ...
        if (_fallback != null) { _fallback(arg1, arg2, arg3, arg4); return; }

        // Source fallback
        if (_sourceFallback != null) { _sourceFallback(arg1, arg2, arg3, arg4); return; }
    ...
    public void SetFallback(Action<T1, T2, T3, T4>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Action<T1, T2, T3, T4>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => _callback?.Invoke(arg1, arg2, arg3, arg4);
        public override bool IsTerminal => false;

        public void SetCallback(Action<T1, T2, T3, T4> callback) => _callback = callback;
    }
    ...
    private sealed class VoidWhenMatcherCall : VoidWhenMatcherBase
    {
        ...
        public VoidWhenMatcherCall(Action<T1, T2, T3, T4> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => true;
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4) => _callback(arg1, arg2, arg3, arg4);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4) { }
        public override bool IsTerminal => true;
    }

    // ========================================================================
    // Inner class: MethodCallBuilder4
    // ========================================================================

    /// <summary>Builder for callback registration. Supports tracking and lazy elevation to sequence.</summary>
    public sealed class MethodCallBuilder4 : IMethodCallBuilderArgs<Action<T1, T2, T3, T4>, (T1, T2, T3, T4)>
    {
        private readonly VoidMethodInterceptor4<T1, T2, T3, T4> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4) _lastArgs;

        internal MethodCallBuilder4(VoidMethodInterceptor4<T1, T2, T3, T4> interceptor)
        {
        ...
        public MethodSequence4 ThenCall(Action<T1, T2, T3, T4> callback)
        {
            ElevateToSequence();
        ...
        /// <summary>Marks for verification by Stub.Verify().</summary>
        public MethodCallBuilder4 Verifiable()
        {
        ...
        /// <summary>Marks for verification by Stub.Verify() with Called constraint.</summary>
        public MethodCallBuilder4 Verifiable(Called times)
        {
            _interceptor._isVerifiable = true;
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Action<T1, T2, T3, T4> Callback, MethodCallBuilder4 Tracking)>();
        ...
        IMethodCallSequence<Action<T1, T2, T3, T4>> IMethodCallBuilderArgs<Action<T1, T2, T3, T4>, (T1, T2, T3, T4)>.ThenCall(Action<T1, T2, T3, T4> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4>, (T1, T2, T3, T4)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4>, (T1, T2, T3, T4)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4>, (T1, T2, T3, T4)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4>, (T1, T2, T3, T4)>.Verifiable(Called called) => Verifiable(called);
    }

    // ========================================================================
    // Inner class: MethodSequence4
    // ========================================================================

    /// <summary>Sequence for void methods. Supports ThenCall chaining.</summary>
    public sealed class MethodSequence4 : IMethodCallSequence<Action<T1, T2, T3, T4>>, IMethodCallSequence, IMethodSequence
    {
        private readonly VoidMethodInterceptor4<T1, T2, T3, T4> _interceptor;

        internal MethodSequence4(VoidMethodInterceptor4<T1, T2, T3, T4> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public MethodSequence4 Verifiable()
        {
            _interceptor._isVerifiable = true;
            _interceptor._verifiableTimes = null;
            return this;
        ...
        // Explicit interface implementations
        IMethodCallSequence<Action<T1, T2, T3, T4>> IMethodCallSequence<Action<T1, T2, T3, T4>>.ThenCall(Action<T1, T2, T3, T4> callback) => ThenCall(callback);
        IMethodCallSequence<Action<T1, T2, T3, T4>> IMethodCallSequence<Action<T1, T2, T3, T4>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: VoidWhenBuilder4
    // ========================================================================
    ...
    public sealed class VoidWhenBuilder4
    {
        ...
        internal VoidWhenBuilder4(VoidMethodInterceptor4<T1, T2, T3, T4> interceptor, Func<T1, T2, T3, T4, bool> predicate)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenChain4 Call(Action<T1, T2, T3, T4> callback)
        {
        ...
        public VoidWhenChain4 ThenCall(Action<T1, T2, T3, T4> callback)
        {
    ...
    public sealed class VoidWhenChain4
    {
        ...
        internal VoidWhenChain4(VoidMethodInterceptor4<T1, T2, T3, T4> interceptor, int currentMatcherIndex)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenBuilder4 ThenWhen(Func<T1, T2, T3, T4, bool> predicate)
        {
            return new VoidWhenBuilder4(_interceptor, predicate);
        }
        ...
        public VoidWhenChain4 Verifiable()
        {
