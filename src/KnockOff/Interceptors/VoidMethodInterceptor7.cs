...
/// <summary>
/// Pre-compiled interceptor for void methods with 7 parameters.
...
public sealed class VoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7>
{
    private readonly string _memberName;

    // Callback
    private Action<T1, T2, T3, T4, T5, T6, T7>? _call;
    private MethodCallBuilder7? _callTracking;

    // Sequence
    private List<(Action<T1, T2, T3, T4, T5, T6, T7> Callback, MethodCallBuilder7 Tracking)>? _sequence;
    ...
    // Fallback delegates
    private Action<T1, T2, T3, T4, T5, T6, T7>? _fallback;
    private Action<T1, T2, T3, T4, T5, T6, T7>? _sourceFallback;

    public VoidMethodInterceptor7(string memberName)
    {
    ...
    public void Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6, arg7))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                matcher.Call(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return;
            }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            _call(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
            return;
        }
        ...
        if (_fallback != null) { _fallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7); return; }

        // Source fallback
        if (_sourceFallback != null) { _sourceFallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7); return; }
    ...
    public void SetFallback(Action<T1, T2, T3, T4, T5, T6, T7>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Action<T1, T2, T3, T4, T5, T6, T7>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        private Action<T1, T2, T3, T4, T5, T6, T7>? _callback;
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => _callback?.Invoke(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        public override bool IsTerminal => false;

        public void SetCallback(Action<T1, T2, T3, T4, T5, T6, T7> callback) => _callback = callback;
    }
    ...
    {
        private readonly Action<T1, T2, T3, T4, T5, T6, T7> _callback;

        public VoidWhenMatcherCall(Action<T1, T2, T3, T4, T5, T6, T7> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => true;
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => _callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) { }
        public override bool IsTerminal => true;
    }

    // ========================================================================
    // Inner class: MethodCallBuilder7
    // ========================================================================

    /// <summary>Builder for callback registration. Supports tracking and lazy elevation to sequence.</summary>
    public sealed class MethodCallBuilder7 : IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6, T7>, (T1, T2, T3, T4, T5, T6, T7)>
    {
        private readonly VoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5, T6, T7) _lastArgs;

        internal MethodCallBuilder7(VoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor)
        {
        ...
        public MethodSequence7 ThenCall(Action<T1, T2, T3, T4, T5, T6, T7> callback)
        {
            ElevateToSequence();
        ...
        /// <summary>Marks for verification by Stub.Verify().</summary>
        public MethodCallBuilder7 Verifiable()
        {
        ...
        /// <summary>Marks for verification by Stub.Verify() with Called constraint.</summary>
        public MethodCallBuilder7 Verifiable(Called times)
        {
            _interceptor._isVerifiable = true;
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Action<T1, T2, T3, T4, T5, T6, T7> Callback, MethodCallBuilder7 Tracking)>();
        ...
        IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6, T7>> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6, T7>, (T1, T2, T3, T4, T5, T6, T7)>.ThenCall(Action<T1, T2, T3, T4, T5, T6, T7> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6, T7>, (T1, T2, T3, T4, T5, T6, T7)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6, T7>, (T1, T2, T3, T4, T5, T6, T7)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6, T7>, (T1, T2, T3, T4, T5, T6, T7)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6, T7>, (T1, T2, T3, T4, T5, T6, T7)>.Verifiable(Called called) => Verifiable(called);
    }

    // ========================================================================
    // Inner class: MethodSequence7
    // ========================================================================

    /// <summary>Sequence for void methods. Supports ThenCall chaining.</summary>
    public sealed class MethodSequence7 : IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6, T7>>, IMethodCallSequence, IMethodSequence
    {
        private readonly VoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> _interceptor;

        internal MethodSequence7(VoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public MethodSequence7 Verifiable()
        {
            _interceptor._isVerifiable = true;
            _interceptor._verifiableTimes = null;
            return this;
        ...
        // Explicit interface implementations
        IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6, T7>> IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6, T7>>.ThenCall(Action<T1, T2, T3, T4, T5, T6, T7> callback) => ThenCall(callback);
        IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6, T7>> IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6, T7>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: VoidWhenBuilder7
    // ========================================================================
    ...
    public sealed class VoidWhenBuilder7
    {
        ...
        internal VoidWhenBuilder7(VoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor, Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenChain7 Call(Action<T1, T2, T3, T4, T5, T6, T7> callback)
        {
        ...
        public VoidWhenChain7 ThenCall(Action<T1, T2, T3, T4, T5, T6, T7> callback)
        {
    ...
    public sealed class VoidWhenChain7
    {
        ...
        internal VoidWhenChain7(VoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor, int currentMatcherIndex)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenBuilder7 ThenWhen(Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate)
        {
            return new VoidWhenBuilder7(_interceptor, predicate);
        }
        ...
        public VoidWhenChain7 Verifiable()
        {
