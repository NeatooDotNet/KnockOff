...
/// <summary>
/// Pre-compiled async interceptor for void methods with 7 parameters.
...
public sealed class AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7>
{
    private readonly string _memberName;

    private Func<T1, T2, T3, T4, T5, T6, T7, Task>? _call;
    private MethodCallBuilder7? _callTracking;

    private List<(Func<T1, T2, T3, T4, T5, T6, T7, Task> Callback, MethodCallBuilder7 Tracking)>? _sequence;
    ...
    private Func<T1, T2, T3, T4, T5, T6, T7, Task>? _fallback;
    private Func<T1, T2, T3, T4, T5, T6, T7, Task>? _sourceFallback;

    public AsyncVoidMethodInterceptor7(string memberName)
    {
    ...
    public async Task Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
    {
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6, arg7))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                await matcher.Call(arg1, arg2, arg3, arg4, arg5, arg6, arg7).ConfigureAwait(false);
                return;
            }
        ...
        if (_sequence != null && _sequenceIndex < _sequence.Count)
        {
            ...
            _sequenceIndex++;
            await callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7).ConfigureAwait(false);
            return;
        }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            await _call(arg1, arg2, arg3, arg4, arg5, arg6, arg7).ConfigureAwait(false);
            return;
        }
        ...
        if (_fallback != null) { await _fallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7).ConfigureAwait(false); return; }
        if (_sourceFallback != null) { await _sourceFallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7).ConfigureAwait(false); return; }
    ...
    public MethodCallBuilder7 Call(Func<T1, T2, T3, T4, T5, T6, T7, Task> asyncCallback)
    {
    ...
    public MethodCallBuilder7 Call(Action<T1, T2, T3, T4, T5, T6, T7> callback)
    {
        return Call((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7); return Task.CompletedTask; });
    }

    public VoidWhenBuilder7 When(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
    {
        _whenChain ??= new List<VoidWhenMatcherBase>();
        return new VoidWhenBuilder7(this, (a1, a2, a3, a4, a5, a6, a7) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3) && object.Equals(a4, arg4) && object.Equals(a5, arg5) && object.Equals(a6, arg6) && object.Equals(a7, arg7));
    }

    public VoidWhenBuilder7 When(Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate)
    {
        _whenChain ??= new List<VoidWhenMatcherBase>();
        return new VoidWhenBuilder7(this, predicate);
    }

    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, T7, Task>? fallback) => _fallback = fallback;
    public void SetFallback(Action<T1, T2, T3, T4, T5, T6, T7>? fallback) =>
        _fallback = fallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7) => { fallback(a1, a2, a3, a4, a5, a6, a7); return Task.CompletedTask; } : null;
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, T7, Task>? sourceFallback) => _sourceFallback = sourceFallback;
    public void SetSourceFallback(Action<T1, T2, T3, T4, T5, T6, T7>? sourceFallback) =>
        _sourceFallback = sourceFallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7) => { sourceFallback(a1, a2, a3, a4, a5, a6, a7); return Task.CompletedTask; } : null;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        private Func<T1, T2, T3, T4, T5, T6, T7, Task>? _callback;
        public VoidWhenMatcherPredicate(Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate) => _predicate = predicate;
        ...
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => _callback?.Invoke(arg1, arg2, arg3, arg4, arg5, arg6, arg7) ?? Task.CompletedTask;
        public override bool IsTerminal => false;
        public void SetCallback(Func<T1, T2, T3, T4, T5, T6, T7, Task> callback) => _callback = callback;
    }

    private sealed class VoidWhenMatcherCall : VoidWhenMatcherBase
    {
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, Task> _callback;
        public VoidWhenMatcherCall(Func<T1, T2, T3, T4, T5, T6, T7, Task> callback) => _callback = callback;
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => true;
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => _callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => Task.CompletedTask;
        public override bool IsTerminal => true;
    }

    public sealed class MethodCallBuilder7 : IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, Task>, (T1, T2, T3, T4, T5, T6, T7)>
    {
        private readonly AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5, T6, T7) _lastArgs;

        internal MethodCallBuilder7(AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence7 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, Task> asyncCallback)
        {
            ElevateToSequence();
        ...
        public MethodSequence7 ThenCall(Action<T1, T2, T3, T4, T5, T6, T7> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7); return Task.CompletedTask; });
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, T5, T6, T7, Task> Callback, MethodCallBuilder7 Tracking)>();
        ...
        IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, Task>> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, Task>, (T1, T2, T3, T4, T5, T6, T7)>.ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, Task> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, Task>, (T1, T2, T3, T4, T5, T6, T7)> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, Task>, (T1, T2, T3, T4, T5, T6, T7)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, Task>, (T1, T2, T3, T4, T5, T6, T7)> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, Task>, (T1, T2, T3, T4, T5, T6, T7)>.Verifiable(Called called) => Verifiable(called);
    }

    public sealed class MethodSequence7 : IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, Task>>, IMethodCallSequence, IMethodSequence
    {
        private readonly AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> _interceptor;
        internal MethodSequence7(AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor) => _interceptor = interceptor;
        ...
        IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, Task>> IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, Task>>.ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, Task> callback) => ThenCall(callback);
        IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, Task>> IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, Task>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    public sealed class VoidWhenBuilder7
    {
        private readonly AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> _interceptor;
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, bool> _predicate;
        private int _matcherIndex = -1;
        internal VoidWhenBuilder7(AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor, Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate) { _interceptor = interceptor; _predicate = predicate; }

        public VoidWhenChain7 Call(Func<T1, T2, T3, T4, T5, T6, T7, Task> asyncCallback)
        {
            ...
            return new VoidWhenChain7(_interceptor, _matcherIndex);
        }

        public VoidWhenChain7 Call(Action<T1, T2, T3, T4, T5, T6, T7> callback) => Call((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7); return Task.CompletedTask; });

        public VoidWhenChain7 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, Task> asyncCallback)
        {
            EnsureRegistered();
        ...
        public VoidWhenChain7 ThenCall(Action<T1, T2, T3, T4, T5, T6, T7> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7); return Task.CompletedTask; });
    ...
    public sealed class VoidWhenChain7
    {
        private readonly AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> _interceptor;
        private readonly int _currentMatcherIndex;
        internal VoidWhenChain7(AsyncVoidMethodInterceptor7<T1, T2, T3, T4, T5, T6, T7> interceptor, int currentMatcherIndex)
        {
            _interceptor = interceptor;
            _currentMatcherIndex = currentMatcherIndex;
        }

        public VoidWhenBuilder7 ThenWhen(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
        {
            return new VoidWhenBuilder7(_interceptor, (a1, a2, a3, a4, a5, a6, a7) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3) && object.Equals(a4, arg4) && object.Equals(a5, arg5) && object.Equals(a6, arg6) && object.Equals(a7, arg7));
        }

        public VoidWhenBuilder7 ThenWhen(Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate) => new VoidWhenBuilder7(_interceptor, predicate);
        ...
        public VoidWhenChain7 ThenNone()
        {
            _interceptor._whenChain ??= new List<VoidWhenMatcherBase>();
        ...
        public VoidWhenChain7 Verifiable() { _interceptor._whenVerifiable = true; return this; }
    }
}
