...
/// <summary>
/// Pre-compiled async interceptor for non-void methods with 6 parameters.
...
public sealed class AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn>
{
    private readonly string _memberName;

    private Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>? _call;
    ...
    private List<(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> Callback, MethodCallBuilder6 Tracking)>? _sequence;
    ...
    private Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>? _fallback;
    private Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>? _sourceFallback;

    // Smart default factory (for NewInstance/ThrowException strategies)
    private readonly Func<TReturn>? _defaultFactory;

    public AsyncMethodInterceptor6(string memberName)
    {
        _memberName = memberName;
    }

    /// <summary>Constructor with smart default factory for non-strict unconfigured calls.</summary>
    public AsyncMethodInterceptor6(string memberName, Func<TReturn> defaultFactory)
    {
        _memberName = memberName;
    ...
    public async Task<TReturn> Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6)
    {
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return await matcher.CallReturn(arg1, arg2, arg3, arg4, arg5, arg6).ConfigureAwait(false);
            }
        ...
        if (_sequence != null && _sequenceIndex < _sequence.Count)
        {
            ...
            _sequenceIndex++;
            return await callback(arg1, arg2, arg3, arg4, arg5, arg6).ConfigureAwait(false);
        }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            return await _call(arg1, arg2, arg3, arg4, arg5, arg6).ConfigureAwait(false);
        }
        ...
        if (_fallback != null) return await _fallback(arg1, arg2, arg3, arg4, arg5, arg6).ConfigureAwait(false);
        if (_sourceFallback != null) return await _sourceFallback(arg1, arg2, arg3, arg4, arg5, arg6).ConfigureAwait(false);
    ...
    public MethodCallBuilder6 Return(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> asyncCallback)
    {
    ...
    {
        return Return((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6)));
    }
    ...
    {
        var builder = Return((T1 _, T2 _, T3 _, T4 _, T5 _, T6 _) => Task.FromResult(first));
    ...
    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>? fallback) => _fallback = fallback;
    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, TReturn>? fallback) =>
        _fallback = fallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6) => Task.FromResult(fallback(a1, a2, a3, a4, a5, a6)) : null;
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>? sourceFallback) => _sourceFallback = sourceFallback;
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, TReturn>? sourceFallback) =>
        _sourceFallback = sourceFallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6) => Task.FromResult(sourceFallback(a1, a2, a3, a4, a5, a6)) : null;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public WhenMatcherValue(Func<T1, T2, T3, T4, T5, T6, bool> predicate, TReturn value) { _predicate = predicate; _value = value; }
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => _predicate(arg1, arg2, arg3, arg4, arg5, arg6);
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => Task.FromResult(_value);
        public override bool IsTerminal => false;
    }

    private sealed class WhenMatcherCall : WhenMatcherBase
    {
        private readonly Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> _callback;
        public WhenMatcherCall(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> callback) => _callback = callback;
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => true;
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => _callback(arg1, arg2, arg3, arg4, arg5, arg6);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => Task.FromResult(default(TReturn)!);
        public override bool IsTerminal => true;
    }

    public sealed class MethodCallBuilder6 : IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>, (T1, T2, T3, T4, T5, T6)>
    {
        private readonly AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5, T6) _lastArgs;

        internal MethodCallBuilder6(AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence6 ThenReturn(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> asyncCallback)
        {
            ElevateToSequence();
        ...
        public MethodSequence6 ThenReturn(Func<T1, T2, T3, T4, T5, T6, TReturn> callback) => ThenReturn((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6)));
        public MethodSequence6 ThenReturn(TReturn value) => ThenReturn((_, _, _, _, _, _) => Task.FromResult(value));

        public MethodSequence6 ThenReturn(params TReturn[] values)
        {
            if (values.Length == 0) { ElevateToSequence(); return new MethodSequence6(_interceptor); }
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> Callback, MethodCallBuilder6 Tracking)>();
                ...
                else if (_interceptor._hasReturnValue)
                {
                    ...
                    _interceptor._sequence.Add(((_, _, _, _, _, _) => Task.FromResult(capturedValue), this));
        ...
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>, (T1, T2, T3, T4, T5, T6)>.ThenReturn(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> callback) => ThenReturn(callback);
        ...
        IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>, (T1, T2, T3, T4, T5, T6)> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>, (T1, T2, T3, T4, T5, T6)>.Verifiable() => Verifiable();
        IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>, (T1, T2, T3, T4, T5, T6)> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>, (T1, T2, T3, T4, T5, T6)>.Verifiable(Called called) => Verifiable(called);
    }

    public sealed class MethodSequence6 : IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>>, IMethodReturnSequence, IMethodSequence
    {
        private readonly AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> _interceptor;
        internal MethodSequence6(AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence6 ThenReturn(Func<T1, T2, T3, T4, T5, T6, TReturn> callback) => ThenReturn((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6)));
        public MethodSequence6 ThenReturn(TReturn value) => ThenReturn((_, _, _, _, _, _) => Task.FromResult(value));
        public MethodSequence6 ThenReturn(params TReturn[] values) { foreach (var v in values) ThenReturn(v); return this; }
        ...
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>>.ThenReturn(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, Task<TReturn>>>.Verifiable() => Verifiable();
    ...
    public sealed class WhenBuilder6
    {
        private readonly AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> _interceptor;
        private readonly Func<T1, T2, T3, T4, T5, T6, bool> _predicate;
        internal WhenBuilder6(AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> interceptor, Func<T1, T2, T3, T4, T5, T6, bool> predicate) { _interceptor = interceptor; _predicate = predicate; }
    ...
    {
        private readonly AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> _interceptor;
        internal WhenChain6(AsyncMethodInterceptor6<T1, T2, T3, T4, T5, T6, TReturn> interceptor) => _interceptor = interceptor;
        ...
        public WhenBuilder6 ThenWhen(Func<T1, T2, T3, T4, T5, T6, bool> predicate) => new WhenBuilder6(_interceptor, predicate);

        public WhenChain6 ThenCall(Func<T1, T2, T3, T4, T5, T6, Task<TReturn>> asyncCallback)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
        ...
        public WhenChain6 ThenCall(Func<T1, T2, T3, T4, T5, T6, TReturn> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6)));
        ...
        public WhenChain6 Verifiable() { _interceptor._whenVerifiable = true; return this; }
    }
}
