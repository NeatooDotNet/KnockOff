...
/// <summary>
/// Pre-compiled interceptor for non-void methods with 3 parameters.
...
public sealed class MethodInterceptor3<T1, T2, T3, TReturn>
{
    private readonly string _memberName;

    // Callback
    private Func<T1, T2, T3, TReturn>? _call;
    ...
    // Sequence
    private List<(Func<T1, T2, T3, TReturn> Callback, MethodCallBuilder3 Tracking)>? _sequence;
    ...
    public TReturn Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return matcher.CallReturn(arg1, arg2, arg3);
            }
        ...
        if (_fallback != null) return _fallback(arg1, arg2, arg3);

        // Source fallback
        if (_sourceFallback != null) return _sourceFallback(arg1, arg2, arg3);
    ...
    public void SetFallback(Func<T1, T2, T3, TReturn>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Func<T1, T2, T3, TReturn>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public WhenMatcherValue(Func<T1, T2, T3, bool> predicate, TReturn value)
        {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3) => _value;
    ...
    {
        private readonly Func<T1, T2, T3, TReturn> _callback;

        public WhenMatcherCall(Func<T1, T2, T3, TReturn> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3) => true;
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3) => _callback(arg1, arg2, arg3);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3) => default!;
        public override bool IsTerminal => true;
    }

    // ========================================================================
    // Inner class: MethodCallBuilder3
    // ========================================================================

    /// <summary>Builder for callback registration. Supports tracking and lazy elevation to sequence.</summary>
    public sealed class MethodCallBuilder3 : IMethodReturnBuilderArgs<Func<T1, T2, T3, TReturn>, (T1, T2, T3)>
    {
        private readonly MethodInterceptor3<T1, T2, T3, TReturn> _interceptor;
        internal int _callCount;
        private (T1, T2, T3) _lastArgs;

        internal MethodCallBuilder3(MethodInterceptor3<T1, T2, T3, TReturn> interceptor)
        {
        ...
        public MethodSequence3 ThenReturn(Func<T1, T2, T3, TReturn> callback)
        {
            ElevateToSequence();
        ...
        public MethodSequence3 ThenReturn(TReturn value)
        {
            return ThenReturn((_, _, _) => value);
        }
        ...
        /// <summary>Marks for verification by Stub.Verify().</summary>
        public MethodCallBuilder3 Verifiable()
        {
        ...
        /// <summary>Marks for verification by Stub.Verify() with Called constraint.</summary>
        public MethodCallBuilder3 Verifiable(Called times)
        {
            _interceptor._isVerifiable = true;
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, TReturn> Callback, MethodCallBuilder3 Tracking)>();
        ...
        IMethodReturnSequence<Func<T1, T2, T3, TReturn>> IMethodReturnBuilderArgs<Func<T1, T2, T3, TReturn>, (T1, T2, T3)>.ThenReturn(Func<T1, T2, T3, TReturn> callback) => ThenReturn(callback);
        ...
        IMethodReturnBuilderArgs<Func<T1, T2, T3, TReturn>, (T1, T2, T3)> IMethodReturnBuilderArgs<Func<T1, T2, T3, TReturn>, (T1, T2, T3)>.Verifiable() => Verifiable();
        IMethodReturnBuilderArgs<Func<T1, T2, T3, TReturn>, (T1, T2, T3)> IMethodReturnBuilderArgs<Func<T1, T2, T3, TReturn>, (T1, T2, T3)>.Verifiable(Called called) => Verifiable(called);
    }

    // ========================================================================
    // Inner class: MethodSequence3
    // ========================================================================

    /// <summary>Sequence for non-void methods. Supports ThenReturn chaining.</summary>
    public sealed class MethodSequence3 : IMethodReturnSequence<Func<T1, T2, T3, TReturn>>, IMethodReturnSequence, IMethodSequence
    {
        private readonly MethodInterceptor3<T1, T2, T3, TReturn> _interceptor;

        internal MethodSequence3(MethodInterceptor3<T1, T2, T3, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public MethodSequence3 Verifiable()
        {
            _interceptor._isVerifiable = true;
            _interceptor._verifiableTimes = null;
            return this;
        ...
        // Explicit interface implementations
        IMethodReturnSequence<Func<T1, T2, T3, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, TReturn>>.ThenReturn(Func<T1, T2, T3, TReturn> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, T3, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, TReturn>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: WhenBuilder3
    // ========================================================================
    ...
    public sealed class WhenBuilder3
    {
        ...
        internal WhenBuilder3(MethodInterceptor3<T1, T2, T3, TReturn> interceptor, Func<T1, T2, T3, bool> predicate)
        {
            _interceptor = interceptor;
            _predicate = predicate;
        }
    ...
    public sealed class WhenChain3
    {
        ...
        internal WhenChain3(MethodInterceptor3<T1, T2, T3, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public WhenBuilder3 ThenWhen(Func<T1, T2, T3, bool> predicate)
        {
            return new WhenBuilder3(_interceptor, predicate);
        }

        /// <summary>Adds an unconditional callback as terminal matcher.</summary>
        public WhenChain3 ThenCall(Func<T1, T2, T3, TReturn> callback)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
