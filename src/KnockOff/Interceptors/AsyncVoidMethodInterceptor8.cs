...
/// <summary>
/// Pre-compiled async interceptor for void methods with 8 parameters.
...
public sealed class AsyncVoidMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8>
{
    private readonly string _memberName;

    private Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>? _call;
    private MethodCallBuilder8? _callTracking;

    private List<(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> Callback, MethodCallBuilder8 Tracking)>? _sequence;
    ...
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>? _fallback;
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>? _sourceFallback;

    public AsyncVoidMethodInterceptor8(string memberName)
    {
    ...
    public async Task Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8)
    {
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                await matcher.Call(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false);
                return;
            }
        ...
        if (_sequence != null && _sequenceIndex < _sequence.Count)
        {
            ...
            _sequenceIndex++;
            await callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false);
            return;
        }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            await _call(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false);
            return;
        }
        ...
        if (_fallback != null) { await _fallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false); return; }
        if (_sourceFallback != null) { await _sourceFallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false); return; }
    ...
    public MethodCallBuilder8 Call(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> asyncCallback)
    {
    ...
    {
        return Call((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8); return Task.CompletedTask; });
    }
    ...
    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>? fallback) => _fallback = fallback;
    public void SetFallback(Action<T1, T2, T3, T4, T5, T6, T7, T8>? fallback) =>
        _fallback = fallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7, T8 a8) => { fallback(a1, a2, a3, a4, a5, a6, a7, a8); return Task.CompletedTask; } : null;
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>? sourceFallback) => _sourceFallback = sourceFallback;
    public void SetSourceFallback(Action<T1, T2, T3, T4, T5, T6, T7, T8>? sourceFallback) =>
        _sourceFallback = sourceFallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7, T8 a8) => { sourceFallback(a1, a2, a3, a4, a5, a6, a7, a8); return Task.CompletedTask; } : null;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        private Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>? _callback;
        ...
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => _callback?.Invoke(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) ?? Task.CompletedTask;
        public override bool IsTerminal => false;
        public void SetCallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> callback) => _callback = callback;
    }

    private sealed class VoidWhenMatcherCall : VoidWhenMatcherBase
    {
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> _callback;
        public VoidWhenMatcherCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> callback) => _callback = callback;
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => true;
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => _callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override Task Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => Task.CompletedTask;
        public override bool IsTerminal => true;
    }

    public sealed class MethodCallBuilder8 : IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>, (T1, T2, T3, T4, T5, T6, T7, T8)>
    {
        private readonly AsyncVoidMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5, T6, T7, T8) _lastArgs;

        internal MethodCallBuilder8(AsyncVoidMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence8 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> asyncCallback)
        {
            ElevateToSequence();
        ...
        public MethodSequence8 ThenCall(Action<T1, T2, T3, T4, T5, T6, T7, T8> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8); return Task.CompletedTask; });
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> Callback, MethodCallBuilder8 Tracking)>();
        ...
        IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>, (T1, T2, T3, T4, T5, T6, T7, T8)>.ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>, (T1, T2, T3, T4, T5, T6, T7, T8)> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>, (T1, T2, T3, T4, T5, T6, T7, T8)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>, (T1, T2, T3, T4, T5, T6, T7, T8)> IMethodCallBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>, (T1, T2, T3, T4, T5, T6, T7, T8)>.Verifiable(Called called) => Verifiable(called);
    }

    public sealed class MethodSequence8 : IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>>, IMethodCallSequence, IMethodSequence
    {
        private readonly AsyncVoidMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8> _interceptor;
        internal MethodSequence8(AsyncVoidMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8> interceptor) => _interceptor = interceptor;
        ...
        IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>> IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>>.ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> callback) => ThenCall(callback);
        IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>> IMethodCallSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task>>.Verifiable() => Verifiable();
    ...
    public sealed class VoidWhenBuilder8
    {
        ...
        internal VoidWhenBuilder8(AsyncVoidMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8> interceptor, Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate) { _interceptor = interceptor; _predicate = predicate; }

        public VoidWhenChain8 Call(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> asyncCallback)
        {
            ...
            return new VoidWhenChain8(_interceptor, _matcherIndex);
        }

        public VoidWhenChain8 Call(Action<T1, T2, T3, T4, T5, T6, T7, T8> callback) => Call((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8); return Task.CompletedTask; });

        public VoidWhenChain8 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> asyncCallback)
        {
            EnsureRegistered();
        ...
        public VoidWhenChain8 ThenCall(Action<T1, T2, T3, T4, T5, T6, T7, T8> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => { callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8); return Task.CompletedTask; });
    ...
    public sealed class VoidWhenChain8
    {
        ...
        internal VoidWhenChain8(AsyncVoidMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8> interceptor, int currentMatcherIndex)
        {
        ...
        public VoidWhenBuilder8 ThenWhen(Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate) => new VoidWhenBuilder8(_interceptor, predicate);
        ...
        public VoidWhenChain8 Verifiable() { _interceptor._whenVerifiable = true; return this; }
    }
}
