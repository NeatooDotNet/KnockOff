...
/// <summary>
/// Pre-compiled interceptor for non-void methods with 2 parameters.
...
public sealed class MethodInterceptor2<T1, T2, TReturn>
{
    private readonly string _memberName;

    // Callback
    private Func<T1, T2, TReturn>? _call;
    ...
    // Sequence
    private List<(Func<T1, T2, TReturn> Callback, MethodCallBuilder2 Tracking)>? _sequence;
    ...
    public TReturn Invoke(bool strict, T1 arg1, T2 arg2)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return matcher.CallReturn(arg1, arg2);
            }
        ...
        if (_fallback != null) return _fallback(arg1, arg2);

        // Source fallback
        if (_sourceFallback != null) return _sourceFallback(arg1, arg2);
    ...
    public void SetFallback(Func<T1, T2, TReturn>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Func<T1, T2, TReturn>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract TReturn CallReturn(T1 arg1, T2 arg2);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2) => _value;
    ...
    {
        private readonly Func<T1, T2, TReturn> _callback;

        public WhenMatcherCall(Func<T1, T2, TReturn> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2) => true;
        public override TReturn CallReturn(T1 arg1, T2 arg2) => _callback(arg1, arg2);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2) => default!;
        public override bool IsTerminal => true;
    }
    ...
    public sealed class MethodCallBuilder2 : IMethodReturnBuilderArgs<Func<T1, T2, TReturn>, (T1, T2)>
    {
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, TReturn> Callback, MethodCallBuilder2 Tracking)>();
    ...
    public sealed class MethodSequence2 : IMethodReturnSequence<Func<T1, T2, TReturn>>, IMethodReturnSequence, IMethodSequence
    {
        private readonly MethodInterceptor2<T1, T2, TReturn> _interceptor;

        internal MethodSequence2(MethodInterceptor2<T1, T2, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        // Explicit interface implementations
        IMethodReturnSequence<Func<T1, T2, TReturn>> IMethodReturnSequence<Func<T1, T2, TReturn>>.ThenReturn(Func<T1, T2, TReturn> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, TReturn>> IMethodReturnSequence<Func<T1, T2, TReturn>>.Verifiable() => Verifiable();
    ...
    public sealed class WhenBuilder2
    {
        ...
        internal WhenBuilder2(MethodInterceptor2<T1, T2, TReturn> interceptor, Func<T1, T2, bool> predicate)
        {
            _interceptor = interceptor;
            _predicate = predicate;
        }
    ...
    public sealed class WhenChain2
    {
        ...
        internal WhenChain2(MethodInterceptor2<T1, T2, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
