...
/// <summary>
/// Pre-compiled interceptor for non-void methods with 7 parameters.
...
public sealed class MethodInterceptor7<T1, T2, T3, T4, T5, T6, T7, TReturn>
{
    private readonly string _memberName;

    // Callback
    private Func<T1, T2, T3, T4, T5, T6, T7, TReturn>? _call;
    ...
    // Sequence
    private List<(Func<T1, T2, T3, T4, T5, T6, T7, TReturn> Callback, MethodCallBuilder7 Tracking)>? _sequence;
    ...
    // Fallback delegates
    private Func<T1, T2, T3, T4, T5, T6, T7, TReturn>? _fallback;
    private Func<T1, T2, T3, T4, T5, T6, T7, TReturn>? _sourceFallback;

    // Smart default factory (for NewInstance/ThrowException strategies)
    private readonly Func<TReturn>? _defaultFactory;

    public MethodInterceptor7(string memberName)
    {
        _memberName = memberName;
    }

    /// <summary>Constructor with smart default factory for non-strict unconfigured calls.</summary>
    public MethodInterceptor7(string memberName, Func<TReturn> defaultFactory)
    {
        _memberName = memberName;
    ...
    public TReturn Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6, arg7))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return matcher.CallReturn(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
            }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            return _call(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        }
        ...
        if (_fallback != null) return _fallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7);

        // Source fallback
        if (_sourceFallback != null) return _sourceFallback(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    ...
    {
        var builder = Return((_, _, _, _, _, _, _) => first);
        if (rest.Length == 0)
        {
    ...
    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, T7, TReturn>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, T7, TReturn>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public WhenMatcherValue(Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate, TReturn value)
        {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => _value;
    ...
    {
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, TReturn> _callback;

        public WhenMatcherCall(Func<T1, T2, T3, T4, T5, T6, T7, TReturn> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => true;
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => _callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override TReturn CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) => default!;
        public override bool IsTerminal => true;
    }
    ...
    public sealed class MethodCallBuilder7 : IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>, (T1, T2, T3, T4, T5, T6, T7)>
    {
        private readonly MethodInterceptor7<T1, T2, T3, T4, T5, T6, T7, TReturn> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5, T6, T7) _lastArgs;

        internal MethodCallBuilder7(MethodInterceptor7<T1, T2, T3, T4, T5, T6, T7, TReturn> interceptor)
        {
        ...
        public MethodSequence7 ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, TReturn> callback)
        {
            ElevateToSequence();
        ...
        public MethodSequence7 ThenReturn(TReturn value)
        {
            return ThenReturn((_, _, _, _, _, _, _) => value);
        }
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, T5, T6, T7, TReturn> Callback, MethodCallBuilder7 Tracking)>();
                ...
                else if (_interceptor._hasReturnValue)
                {
                    ...
                    _interceptor._sequence.Add(((_, _, _, _, _, _, _) => capturedValue, this));
        ...
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>, (T1, T2, T3, T4, T5, T6, T7)>.ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, TReturn> callback) => ThenReturn(callback);
        ...
        IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>, (T1, T2, T3, T4, T5, T6, T7)> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>, (T1, T2, T3, T4, T5, T6, T7)>.Verifiable() => Verifiable();
        IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>, (T1, T2, T3, T4, T5, T6, T7)> IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>, (T1, T2, T3, T4, T5, T6, T7)>.Verifiable(Called called) => Verifiable(called);
    }
    ...
    public sealed class MethodSequence7 : IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>>, IMethodReturnSequence, IMethodSequence
    {
        private readonly MethodInterceptor7<T1, T2, T3, T4, T5, T6, T7, TReturn> _interceptor;

        internal MethodSequence7(MethodInterceptor7<T1, T2, T3, T4, T5, T6, T7, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        // Explicit interface implementations
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>>.ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, TReturn> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, TReturn>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: WhenBuilder7
    // ========================================================================
    ...
    public sealed class WhenBuilder7
    {
        ...
        internal WhenBuilder7(MethodInterceptor7<T1, T2, T3, T4, T5, T6, T7, TReturn> interceptor, Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate)
        {
            _interceptor = interceptor;
            _predicate = predicate;
        }
    ...
    public sealed class WhenChain7
    {
        ...
        internal WhenChain7(MethodInterceptor7<T1, T2, T3, T4, T5, T6, T7, TReturn> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public WhenBuilder7 ThenWhen(Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate)
        {
            return new WhenBuilder7(_interceptor, predicate);
        }

        /// <summary>Adds an unconditional callback as terminal matcher.</summary>
        public WhenChain7 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, TReturn> callback)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
