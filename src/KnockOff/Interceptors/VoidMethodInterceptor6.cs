...
/// <summary>
/// Pre-compiled interceptor for void methods with 6 parameters.
...
public sealed class VoidMethodInterceptor6<T1, T2, T3, T4, T5, T6>
{
    private readonly string _memberName;

    // Callback
    private Action<T1, T2, T3, T4, T5, T6>? _call;
    private MethodCallBuilder6? _callTracking;

    // Sequence
    private List<(Action<T1, T2, T3, T4, T5, T6> Callback, MethodCallBuilder6 Tracking)>? _sequence;
    ...
    // Fallback delegates
    private Action<T1, T2, T3, T4, T5, T6>? _fallback;
    private Action<T1, T2, T3, T4, T5, T6>? _sourceFallback;

    public VoidMethodInterceptor6(string memberName)
    {
    ...
    public void Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                matcher.Call(arg1, arg2, arg3, arg4, arg5, arg6);
                return;
            }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            _call(arg1, arg2, arg3, arg4, arg5, arg6);
            return;
        }
        ...
        if (_fallback != null) { _fallback(arg1, arg2, arg3, arg4, arg5, arg6); return; }

        // Source fallback
        if (_sourceFallback != null) { _sourceFallback(arg1, arg2, arg3, arg4, arg5, arg6); return; }
    ...
    public void SetFallback(Action<T1, T2, T3, T4, T5, T6>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Action<T1, T2, T3, T4, T5, T6>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        private Action<T1, T2, T3, T4, T5, T6>? _callback;
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => _callback?.Invoke(arg1, arg2, arg3, arg4, arg5, arg6);
        public override bool IsTerminal => false;

        public void SetCallback(Action<T1, T2, T3, T4, T5, T6> callback) => _callback = callback;
    }
    ...
    {
        private readonly Action<T1, T2, T3, T4, T5, T6> _callback;

        public VoidWhenMatcherCall(Action<T1, T2, T3, T4, T5, T6> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => true;
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) => _callback(arg1, arg2, arg3, arg4, arg5, arg6);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) { }
        public override bool IsTerminal => true;
    }
    ...
    public sealed class MethodCallBuilder6 : IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6>, (T1, T2, T3, T4, T5, T6)>
    {
        private readonly VoidMethodInterceptor6<T1, T2, T3, T4, T5, T6> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5, T6) _lastArgs;

        internal MethodCallBuilder6(VoidMethodInterceptor6<T1, T2, T3, T4, T5, T6> interceptor)
        {
        ...
        public MethodSequence6 ThenCall(Action<T1, T2, T3, T4, T5, T6> callback)
        {
            ElevateToSequence();
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Action<T1, T2, T3, T4, T5, T6> Callback, MethodCallBuilder6 Tracking)>();
        ...
        IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6>> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6>, (T1, T2, T3, T4, T5, T6)>.ThenCall(Action<T1, T2, T3, T4, T5, T6> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6>, (T1, T2, T3, T4, T5, T6)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6>, (T1, T2, T3, T4, T5, T6)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6>, (T1, T2, T3, T4, T5, T6)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5, T6>, (T1, T2, T3, T4, T5, T6)>.Verifiable(Called called) => Verifiable(called);
    }
    ...
    public sealed class MethodSequence6 : IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6>>, IMethodCallSequence, IMethodSequence
    {
        private readonly VoidMethodInterceptor6<T1, T2, T3, T4, T5, T6> _interceptor;

        internal MethodSequence6(VoidMethodInterceptor6<T1, T2, T3, T4, T5, T6> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        // Explicit interface implementations
        IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6>> IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6>>.ThenCall(Action<T1, T2, T3, T4, T5, T6> callback) => ThenCall(callback);
        IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6>> IMethodCallSequence<Action<T1, T2, T3, T4, T5, T6>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: VoidWhenBuilder6
    // ========================================================================
    ...
    public sealed class VoidWhenBuilder6
    {
        ...
        internal VoidWhenBuilder6(VoidMethodInterceptor6<T1, T2, T3, T4, T5, T6> interceptor, Func<T1, T2, T3, T4, T5, T6, bool> predicate)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenChain6 Call(Action<T1, T2, T3, T4, T5, T6> callback)
        {
        ...
        public VoidWhenChain6 ThenCall(Action<T1, T2, T3, T4, T5, T6> callback)
        {
    ...
    public sealed class VoidWhenChain6
    {
        ...
        internal VoidWhenChain6(VoidMethodInterceptor6<T1, T2, T3, T4, T5, T6> interceptor, int currentMatcherIndex)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenBuilder6 ThenWhen(Func<T1, T2, T3, T4, T5, T6, bool> predicate)
        {
            return new VoidWhenBuilder6(_interceptor, predicate);
        }
        ...
        public VoidWhenChain6 Verifiable()
        {
