...
/// <summary>
/// Pre-compiled interceptor for void methods with 5 parameters.
...
public sealed class VoidMethodInterceptor5<T1, T2, T3, T4, T5>
{
    private readonly string _memberName;

    // Callback
    private Action<T1, T2, T3, T4, T5>? _call;
    private MethodCallBuilder5? _callTracking;

    // Sequence
    private List<(Action<T1, T2, T3, T4, T5> Callback, MethodCallBuilder5 Tracking)>? _sequence;
    ...
    // Fallback delegates
    private Action<T1, T2, T3, T4, T5>? _fallback;
    private Action<T1, T2, T3, T4, T5>? _sourceFallback;

    public VoidMethodInterceptor5(string memberName)
    {
    ...
    public void Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
    {
        // When chain
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                matcher.Call(arg1, arg2, arg3, arg4, arg5);
                return;
            }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            _call(arg1, arg2, arg3, arg4, arg5);
            return;
        }
        ...
        if (_fallback != null) { _fallback(arg1, arg2, arg3, arg4, arg5); return; }

        // Source fallback
        if (_sourceFallback != null) { _sourceFallback(arg1, arg2, arg3, arg4, arg5); return; }
    ...
    public void SetFallback(Action<T1, T2, T3, T4, T5>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Action<T1, T2, T3, T4, T5>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) => _callback?.Invoke(arg1, arg2, arg3, arg4, arg5);
        public override bool IsTerminal => false;

        public void SetCallback(Action<T1, T2, T3, T4, T5> callback) => _callback = callback;
    }
    ...
    private sealed class VoidWhenMatcherCall : VoidWhenMatcherBase
    {
        ...
        public VoidWhenMatcherCall(Action<T1, T2, T3, T4, T5> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) => true;
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) => _callback(arg1, arg2, arg3, arg4, arg5);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) { }
        public override bool IsTerminal => true;
    }

    // ========================================================================
    // Inner class: MethodCallBuilder5
    // ========================================================================

    /// <summary>Builder for callback registration. Supports tracking and lazy elevation to sequence.</summary>
    public sealed class MethodCallBuilder5 : IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5>, (T1, T2, T3, T4, T5)>
    {
        private readonly VoidMethodInterceptor5<T1, T2, T3, T4, T5> _interceptor;
        internal int _callCount;
        private (T1, T2, T3, T4, T5) _lastArgs;

        internal MethodCallBuilder5(VoidMethodInterceptor5<T1, T2, T3, T4, T5> interceptor)
        {
        ...
        public MethodSequence5 ThenCall(Action<T1, T2, T3, T4, T5> callback)
        {
            ElevateToSequence();
        ...
        /// <summary>Marks for verification by Stub.Verify().</summary>
        public MethodCallBuilder5 Verifiable()
        {
        ...
        /// <summary>Marks for verification by Stub.Verify() with Called constraint.</summary>
        public MethodCallBuilder5 Verifiable(Called times)
        {
            _interceptor._isVerifiable = true;
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Action<T1, T2, T3, T4, T5> Callback, MethodCallBuilder5 Tracking)>();
        ...
        IMethodCallSequence<Action<T1, T2, T3, T4, T5>> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5>, (T1, T2, T3, T4, T5)>.ThenCall(Action<T1, T2, T3, T4, T5> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5>, (T1, T2, T3, T4, T5)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5>, (T1, T2, T3, T4, T5)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5>, (T1, T2, T3, T4, T5)> IMethodCallBuilderArgs<Action<T1, T2, T3, T4, T5>, (T1, T2, T3, T4, T5)>.Verifiable(Called called) => Verifiable(called);
    }

    // ========================================================================
    // Inner class: MethodSequence5
    // ========================================================================

    /// <summary>Sequence for void methods. Supports ThenCall chaining.</summary>
    public sealed class MethodSequence5 : IMethodCallSequence<Action<T1, T2, T3, T4, T5>>, IMethodCallSequence, IMethodSequence
    {
        private readonly VoidMethodInterceptor5<T1, T2, T3, T4, T5> _interceptor;

        internal MethodSequence5(VoidMethodInterceptor5<T1, T2, T3, T4, T5> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        public MethodSequence5 Verifiable()
        {
            _interceptor._isVerifiable = true;
            _interceptor._verifiableTimes = null;
            return this;
        ...
        // Explicit interface implementations
        IMethodCallSequence<Action<T1, T2, T3, T4, T5>> IMethodCallSequence<Action<T1, T2, T3, T4, T5>>.ThenCall(Action<T1, T2, T3, T4, T5> callback) => ThenCall(callback);
        IMethodCallSequence<Action<T1, T2, T3, T4, T5>> IMethodCallSequence<Action<T1, T2, T3, T4, T5>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: VoidWhenBuilder5
    // ========================================================================
    ...
    public sealed class VoidWhenBuilder5
    {
        ...
        internal VoidWhenBuilder5(VoidMethodInterceptor5<T1, T2, T3, T4, T5> interceptor, Func<T1, T2, T3, T4, T5, bool> predicate)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenChain5 Call(Action<T1, T2, T3, T4, T5> callback)
        {
        ...
        public VoidWhenChain5 ThenCall(Action<T1, T2, T3, T4, T5> callback)
        {
    ...
    public sealed class VoidWhenChain5
    {
        ...
        internal VoidWhenChain5(VoidMethodInterceptor5<T1, T2, T3, T4, T5> interceptor, int currentMatcherIndex)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenBuilder5 ThenWhen(Func<T1, T2, T3, T4, T5, bool> predicate)
        {
            return new VoidWhenBuilder5(_interceptor, predicate);
        }
        ...
        public VoidWhenChain5 Verifiable()
        {
