...
/// <summary>
/// Pre-compiled async interceptor for non-void methods with 3 parameters.
...
public sealed class AsyncMethodInterceptor3<T1, T2, T3, TReturn>
{
    private readonly string _memberName;

    private Func<T1, T2, T3, Task<TReturn>>? _call;
    private MethodCallBuilder3? _callTracking;

    private TReturn _returnValue = default!;
    private bool _hasReturnValue;
    private MethodCallBuilder3? _returnValueTracking;

    private List<(Func<T1, T2, T3, Task<TReturn>> Callback, MethodCallBuilder3 Tracking)>? _sequence;
    ...
    private Func<T1, T2, T3, Task<TReturn>>? _fallback;
    private Func<T1, T2, T3, Task<TReturn>>? _sourceFallback;

    // Smart default factory (for NewInstance/ThrowException strategies)
    private readonly Func<TReturn>? _defaultFactory;

    public AsyncMethodInterceptor3(string memberName)
    {
        _memberName = memberName;
    }

    /// <summary>Constructor with smart default factory for non-strict unconfigured calls.</summary>
    public AsyncMethodInterceptor3(string memberName, Func<TReturn> defaultFactory)
    {
        _memberName = memberName;
    ...
    public async Task<TReturn> Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3)
    {
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return await matcher.CallReturn(arg1, arg2, arg3).ConfigureAwait(false);
            }
        ...
        if (_sequence != null && _sequenceIndex < _sequence.Count)
        {
            ...
            _sequenceIndex++;
            return await callback(arg1, arg2, arg3).ConfigureAwait(false);
        }

        if (_hasReturnValue && _returnValueTracking != null)
        {
            _returnValueTracking.RecordCall(arg1, arg2, arg3);
            return _returnValue;
        }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            return await _call(arg1, arg2, arg3).ConfigureAwait(false);
        }
        ...
        if (_fallback != null) return await _fallback(arg1, arg2, arg3).ConfigureAwait(false);
        if (_sourceFallback != null) return await _sourceFallback(arg1, arg2, arg3).ConfigureAwait(false);
    ...
    public MethodCallBuilder3 Return(Func<T1, T2, T3, Task<TReturn>> asyncCallback)
    {
    ...
    public MethodCallBuilder3 Return(Func<T1, T2, T3, TReturn> callback)
    {
        return Return((T1 arg1, T2 arg2, T3 arg3) => Task.FromResult(callback(arg1, arg2, arg3)));
    }

    public MethodCallBuilder3 Return(TReturn value)
    {
        var builder = new MethodCallBuilder3(this);
        _sequence = null; _sequenceIndex = 0;
        _isVerifiable = false; _verifiableTimes = null;
    ...
    public MethodSequence3 Return(TReturn first, params TReturn[] rest)
    {
        var builder = Return((T1 _, T2 _, T3 _) => Task.FromResult(first));
    ...
    public WhenBuilder3 When(T1 arg1, T2 arg2, T3 arg3)
    {
        _whenChain ??= new List<WhenMatcherBase>();
        return new WhenBuilder3(this, (a1, a2, a3) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3));
    }

    public WhenBuilder3 When(Func<T1, T2, T3, bool> predicate)
    {
        _whenChain ??= new List<WhenMatcherBase>();
        return new WhenBuilder3(this, predicate);
    }

    public void SetFallback(Func<T1, T2, T3, Task<TReturn>>? fallback) => _fallback = fallback;
    public void SetFallback(Func<T1, T2, T3, TReturn>? fallback) =>
        _fallback = fallback != null ? (T1 a1, T2 a2, T3 a3) => Task.FromResult(fallback(a1, a2, a3)) : null;
    public void SetSourceFallback(Func<T1, T2, T3, Task<TReturn>>? sourceFallback) => _sourceFallback = sourceFallback;
    public void SetSourceFallback(Func<T1, T2, T3, TReturn>? sourceFallback) =>
        _sourceFallback = sourceFallback != null ? (T1 a1, T2 a2, T3 a3) => Task.FromResult(sourceFallback(a1, a2, a3)) : null;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public WhenMatcherValue(Func<T1, T2, T3, bool> predicate, TReturn value) { _predicate = predicate; _value = value; }
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3) => _predicate(arg1, arg2, arg3);
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3) => Task.FromResult(_value);
        public override bool IsTerminal => false;
    }

    private sealed class WhenMatcherCall : WhenMatcherBase
    {
        private readonly Func<T1, T2, T3, Task<TReturn>> _callback;
        public WhenMatcherCall(Func<T1, T2, T3, Task<TReturn>> callback) => _callback = callback;
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3) => true;
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3) => _callback(arg1, arg2, arg3);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3) => Task.FromResult(default(TReturn)!);
        public override bool IsTerminal => true;
    }

    public sealed class MethodCallBuilder3 : IMethodReturnBuilderArgs<Func<T1, T2, T3, Task<TReturn>>, (T1, T2, T3)>
    {
        private readonly AsyncMethodInterceptor3<T1, T2, T3, TReturn> _interceptor;
        internal int _callCount;
        private (T1, T2, T3) _lastArgs;

        internal MethodCallBuilder3(AsyncMethodInterceptor3<T1, T2, T3, TReturn> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence3 ThenReturn(Func<T1, T2, T3, Task<TReturn>> asyncCallback)
        {
            ElevateToSequence();
        ...
        public MethodSequence3 ThenReturn(Func<T1, T2, T3, TReturn> callback) => ThenReturn((T1 arg1, T2 arg2, T3 arg3) => Task.FromResult(callback(arg1, arg2, arg3)));
        public MethodSequence3 ThenReturn(TReturn value) => ThenReturn((_, _, _) => Task.FromResult(value));

        public MethodSequence3 ThenReturn(params TReturn[] values)
        {
            if (values.Length == 0) { ElevateToSequence(); return new MethodSequence3(_interceptor); }
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, Task<TReturn>> Callback, MethodCallBuilder3 Tracking)>();
                ...
                else if (_interceptor._hasReturnValue)
                {
                    ...
                    _interceptor._sequence.Add(((_, _, _) => Task.FromResult(capturedValue), this));
        ...
        IMethodReturnSequence<Func<T1, T2, T3, Task<TReturn>>> IMethodReturnBuilderArgs<Func<T1, T2, T3, Task<TReturn>>, (T1, T2, T3)>.ThenReturn(Func<T1, T2, T3, Task<TReturn>> callback) => ThenReturn(callback);
        ...
        IMethodReturnBuilderArgs<Func<T1, T2, T3, Task<TReturn>>, (T1, T2, T3)> IMethodReturnBuilderArgs<Func<T1, T2, T3, Task<TReturn>>, (T1, T2, T3)>.Verifiable() => Verifiable();
        IMethodReturnBuilderArgs<Func<T1, T2, T3, Task<TReturn>>, (T1, T2, T3)> IMethodReturnBuilderArgs<Func<T1, T2, T3, Task<TReturn>>, (T1, T2, T3)>.Verifiable(Called called) => Verifiable(called);
    }

    public sealed class MethodSequence3 : IMethodReturnSequence<Func<T1, T2, T3, Task<TReturn>>>, IMethodReturnSequence, IMethodSequence
    {
        private readonly AsyncMethodInterceptor3<T1, T2, T3, TReturn> _interceptor;
        internal MethodSequence3(AsyncMethodInterceptor3<T1, T2, T3, TReturn> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence3 ThenReturn(Func<T1, T2, T3, TReturn> callback) => ThenReturn((T1 arg1, T2 arg2, T3 arg3) => Task.FromResult(callback(arg1, arg2, arg3)));
        public MethodSequence3 ThenReturn(TReturn value) => ThenReturn((_, _, _) => Task.FromResult(value));
        public MethodSequence3 ThenReturn(params TReturn[] values) { foreach (var v in values) ThenReturn(v); return this; }
        ...
        IMethodReturnSequence<Func<T1, T2, T3, Task<TReturn>>> IMethodReturnSequence<Func<T1, T2, T3, Task<TReturn>>>.ThenReturn(Func<T1, T2, T3, Task<TReturn>> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, T3, Task<TReturn>>> IMethodReturnSequence<Func<T1, T2, T3, Task<TReturn>>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    public sealed class WhenBuilder3
    {
        private readonly AsyncMethodInterceptor3<T1, T2, T3, TReturn> _interceptor;
        private readonly Func<T1, T2, T3, bool> _predicate;
        internal WhenBuilder3(AsyncMethodInterceptor3<T1, T2, T3, TReturn> interceptor, Func<T1, T2, T3, bool> predicate) { _interceptor = interceptor; _predicate = predicate; }

        public WhenChain3 Return(TReturn value)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
            _interceptor._whenChain.Add(new WhenMatcherValue(_predicate, value));
            return new WhenChain3(_interceptor);
        }
    }

    public sealed class WhenChain3
    {
        private readonly AsyncMethodInterceptor3<T1, T2, T3, TReturn> _interceptor;
        internal WhenChain3(AsyncMethodInterceptor3<T1, T2, T3, TReturn> interceptor) => _interceptor = interceptor;

        /// <summary>Adds another matcher with exact value matching.</summary>
        public WhenBuilder3 ThenWhen(T1 arg1, T2 arg2, T3 arg3)
        {
            return new WhenBuilder3(_interceptor, (a1, a2, a3) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3));
        }

        public WhenBuilder3 ThenWhen(Func<T1, T2, T3, bool> predicate) => new WhenBuilder3(_interceptor, predicate);

        public WhenChain3 ThenCall(Func<T1, T2, T3, Task<TReturn>> asyncCallback)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
        ...
        public WhenChain3 ThenCall(Func<T1, T2, T3, TReturn> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3) => Task.FromResult(callback(arg1, arg2, arg3)));

        public WhenChain3 ThenNone()
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
        ...
        public WhenChain3 Verifiable() { _interceptor._whenVerifiable = true; return this; }
    }
}
