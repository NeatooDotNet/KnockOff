...
/// <summary>
/// Pre-compiled async interceptor for non-void methods with 8 parameters.
...
public sealed class AsyncMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>
{
    private readonly string _memberName;

    private Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>? _call;
    private MethodCallBuilder8? _callTracking;

    private TReturn _returnValue = default!;
    private bool _hasReturnValue;
    private MethodCallBuilder8? _returnValueTracking;

    private List<(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> Callback, MethodCallBuilder8 Tracking)>? _sequence;
    ...
    public async Task<TReturn> Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8)
    {
        if (_whenChain != null && _whenChainHead < _whenChain.Count)
        {
            ...
            if (matcher.Matches(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8))
            {
                ...
                if (_whenChainHead < _whenChain.Count - 1)
                    _whenChainHead++;
                return await matcher.CallReturn(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false);
            }
        ...
        if (_sequence != null && _sequenceIndex < _sequence.Count)
        {
            ...
            _sequenceIndex++;
            return await callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false);
        }

        if (_hasReturnValue && _returnValueTracking != null)
        {
            _returnValueTracking.RecordCall(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
            return _returnValue;
        }
        ...
        if (_call != null && _callTracking != null)
        {
            ...
            return await _call(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8).ConfigureAwait(false);
        }
    ...
    public MethodCallBuilder8 Return(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> asyncCallback)
    {
    ...
    public MethodCallBuilder8 Return(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback)
    {
        return Return((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)));
    }

    public MethodCallBuilder8 Return(TReturn value)
    {
        var builder = new MethodCallBuilder8(this);
        _sequence = null; _sequenceIndex = 0;
        _isVerifiable = false; _verifiableTimes = null;
    ...
    public MethodSequence8 Return(TReturn first, params TReturn[] rest)
    {
        var builder = Return((T1 _, T2 _, T3 _, T4 _, T5 _, T6 _, T7 _, T8 _) => Task.FromResult(first));
    ...
    public WhenBuilder8 When(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8)
    {
        _whenChain ??= new List<WhenMatcherBase>();
        return new WhenBuilder8(this, (a1, a2, a3, a4, a5, a6, a7, a8) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3) && object.Equals(a4, arg4) && object.Equals(a5, arg5) && object.Equals(a6, arg6) && object.Equals(a7, arg7) && object.Equals(a8, arg8));
    }

    public WhenBuilder8 When(Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate)
    {
        _whenChain ??= new List<WhenMatcherBase>();
        return new WhenBuilder8(this, predicate);
    }

    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>? fallback) => _fallback = fallback;
    public void SetFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>? fallback) =>
        _fallback = fallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7, T8 a8) => Task.FromResult(fallback(a1, a2, a3, a4, a5, a6, a7, a8)) : null;
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>? sourceFallback) => _sourceFallback = sourceFallback;
    public void SetSourceFallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn>? sourceFallback) =>
        _sourceFallback = sourceFallback != null ? (T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6, T7 a7, T8 a8) => Task.FromResult(sourceFallback(a1, a2, a3, a4, a5, a6, a7, a8)) : null;
    ...
    private abstract class WhenMatcherBase
    {
        ...
        public abstract Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8);
    ...
    private sealed class WhenMatcherValue : WhenMatcherBase
    {
        ...
        public WhenMatcherValue(Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate, TReturn value) { _predicate = predicate; _value = value; }
        ...
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => Task.FromResult(_value);
        public override bool IsTerminal => false;
    }

    private sealed class WhenMatcherCall : WhenMatcherBase
    {
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> _callback;
        public WhenMatcherCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> callback) => _callback = callback;
        public override bool Matches(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => true;
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => _callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    ...
    private sealed class WhenMatcherNone : WhenMatcherBase
    {
        ...
        public override Task<TReturn> CallReturn(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => Task.FromResult(default(TReturn)!);
        public override bool IsTerminal => true;
    }
    ...
    public sealed class MethodCallBuilder8 : IMethodReturnBuilderArgs<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>, (T1, T2, T3, T4, T5, T6, T7, T8)>
    {
        ...
        public MethodSequence8 ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> asyncCallback)
        {
            ElevateToSequence();
        ...
        public MethodSequence8 ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback) => ThenReturn((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)));
        public MethodSequence8 ThenReturn(TReturn value) => ThenReturn((_, _, _, _, _, _, _, _) => Task.FromResult(value));

        public MethodSequence8 ThenReturn(params TReturn[] values)
        {
            if (values.Length == 0) { ElevateToSequence(); return new MethodSequence8(_interceptor); }
            var seq = ThenReturn(values[0]);
            for (int i = 1; i < values.Length; i++) seq.ThenReturn(values[i]);
            return seq;
        }

        public MethodCallBuilder8 Verifiable() { _interceptor._isVerifiable = true; _interceptor._verifiableTimes = null; return this; }
        public MethodCallBuilder8 Verifiable(Called times) { _interceptor._isVerifiable = true; _interceptor._verifiableTimes = times; return this; }

        private void ElevateToSequence()
        {
            if (_interceptor._sequence == null)
            {
                _interceptor._sequence = new List<(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> Callback, MethodCallBuilder8 Tracking)>();
                ...
                else if (_interceptor._hasReturnValue)
                {
                    ...
                    _interceptor._sequence.Add(((_, _, _, _, _, _, _, _) => Task.FromResult(capturedValue), this));
    ...
    {
        private readonly AsyncMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> _interceptor;
        internal MethodSequence8(AsyncMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> interceptor) => _interceptor = interceptor;
        ...
        public MethodSequence8 ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback) => ThenReturn((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)));
        public MethodSequence8 ThenReturn(TReturn value) => ThenReturn((_, _, _, _, _, _, _, _) => Task.FromResult(value));
        public MethodSequence8 ThenReturn(params TReturn[] values) { foreach (var v in values) ThenReturn(v); return this; }
        ...
        public MethodSequence8 Verifiable() { _interceptor._isVerifiable = true; _interceptor._verifiableTimes = null; return this; }
        public void ThenDefault() => _interceptor._repeatLastValue = false;

        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>>.ThenReturn(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> callback) => ThenReturn(callback);
        IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>> IMethodReturnSequence<Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    public sealed class WhenBuilder8
    {
        private readonly AsyncMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> _interceptor;
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> _predicate;
        internal WhenBuilder8(AsyncMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> interceptor, Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate) { _interceptor = interceptor; _predicate = predicate; }

        public WhenChain8 Return(TReturn value)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
            _interceptor._whenChain.Add(new WhenMatcherValue(_predicate, value));
            return new WhenChain8(_interceptor);
        }
    }

    public sealed class WhenChain8
    {
        private readonly AsyncMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> _interceptor;
        internal WhenChain8(AsyncMethodInterceptor8<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> interceptor) => _interceptor = interceptor;

        /// <summary>Adds another matcher with exact value matching.</summary>
        public WhenBuilder8 ThenWhen(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8)
        {
            return new WhenBuilder8(_interceptor, (a1, a2, a3, a4, a5, a6, a7, a8) => object.Equals(a1, arg1) && object.Equals(a2, arg2) && object.Equals(a3, arg3) && object.Equals(a4, arg4) && object.Equals(a5, arg5) && object.Equals(a6, arg6) && object.Equals(a7, arg7) && object.Equals(a8, arg8));
        }

        public WhenBuilder8 ThenWhen(Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate) => new WhenBuilder8(_interceptor, predicate);

        public WhenChain8 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task<TReturn>> asyncCallback)
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
        ...
        public WhenChain8 ThenCall(Func<T1, T2, T3, T4, T5, T6, T7, T8, TReturn> callback) => ThenCall((T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) => Task.FromResult(callback(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)));

        public WhenChain8 ThenNone()
        {
            _interceptor._whenChain ??= new List<WhenMatcherBase>();
        ...
        public WhenChain8 Verifiable() { _interceptor._whenVerifiable = true; return this; }
    }
}
