...
/// <summary>
/// Pre-compiled interceptor for void methods with 3 parameters.
...
public sealed class VoidMethodInterceptor3<T1, T2, T3>
{
    private readonly string _memberName;

    // Callback
    private Action<T1, T2, T3>? _call;
    private MethodCallBuilder3? _callTracking;

    // Sequence
    private List<(Action<T1, T2, T3> Callback, MethodCallBuilder3 Tracking)>? _sequence;
    ...
    // Fallback delegates
    private Action<T1, T2, T3>? _fallback;
    private Action<T1, T2, T3>? _sourceFallback;

    public VoidMethodInterceptor3(string memberName)
    {
    ...
    public void Invoke(bool strict, T1 arg1, T2 arg2, T3 arg3)
    {
        // When chain
        ...
        if (_fallback != null) { _fallback(arg1, arg2, arg3); return; }

        // Source fallback
        if (_sourceFallback != null) { _sourceFallback(arg1, arg2, arg3); return; }
    ...
    public void SetFallback(Action<T1, T2, T3>? fallback) => _fallback = fallback;

    /// <summary>Sets the source fallback delegate for source delegation.</summary>
    public void SetSourceFallback(Action<T1, T2, T3>? sourceFallback) => _sourceFallback = sourceFallback;
    ...
    private abstract class VoidWhenMatcherBase
    {
        ...
        public abstract void Call(T1 arg1, T2 arg2, T3 arg3);
    ...
    private sealed class VoidWhenMatcherPredicate : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3) => _callback?.Invoke(arg1, arg2, arg3);
        public override bool IsTerminal => false;

        public void SetCallback(Action<T1, T2, T3> callback) => _callback = callback;
    }
    ...
    private sealed class VoidWhenMatcherCall : VoidWhenMatcherBase
    {
        ...
        public VoidWhenMatcherCall(Action<T1, T2, T3> callback) => _callback = callback;

        public override bool Matches(T1 arg1, T2 arg2, T3 arg3) => true;
        public override void Call(T1 arg1, T2 arg2, T3 arg3) => _callback(arg1, arg2, arg3);
    ...
    private sealed class VoidWhenMatcherNone : VoidWhenMatcherBase
    {
        ...
        public override void Call(T1 arg1, T2 arg2, T3 arg3) { }
        public override bool IsTerminal => true;
    }
    ...
    public sealed class MethodCallBuilder3 : IMethodCallBuilderArgs<Action<T1, T2, T3>, (T1, T2, T3)>
    {
        private readonly VoidMethodInterceptor3<T1, T2, T3> _interceptor;
        internal int _callCount;
        private (T1, T2, T3) _lastArgs;

        internal MethodCallBuilder3(VoidMethodInterceptor3<T1, T2, T3> interceptor)
        {
        ...
        public MethodSequence3 ThenCall(Action<T1, T2, T3> callback)
        {
            ElevateToSequence();
        ...
        private void ElevateToSequence()
        {
            ...
            {
                _interceptor._sequence = new List<(Action<T1, T2, T3> Callback, MethodCallBuilder3 Tracking)>();
        ...
        IMethodCallSequence<Action<T1, T2, T3>> IMethodCallBuilderArgs<Action<T1, T2, T3>, (T1, T2, T3)>.ThenCall(Action<T1, T2, T3> callback) => ThenCall(callback);
        ...
        IMethodCallBuilderArgs<Action<T1, T2, T3>, (T1, T2, T3)> IMethodCallBuilderArgs<Action<T1, T2, T3>, (T1, T2, T3)>.Verifiable() => Verifiable();
        IMethodCallBuilderArgs<Action<T1, T2, T3>, (T1, T2, T3)> IMethodCallBuilderArgs<Action<T1, T2, T3>, (T1, T2, T3)>.Verifiable(Called called) => Verifiable(called);
    }
    ...
    public sealed class MethodSequence3 : IMethodCallSequence<Action<T1, T2, T3>>, IMethodCallSequence, IMethodSequence
    {
        private readonly VoidMethodInterceptor3<T1, T2, T3> _interceptor;

        internal MethodSequence3(VoidMethodInterceptor3<T1, T2, T3> interceptor)
        {
            _interceptor = interceptor;
        }
        ...
        // Explicit interface implementations
        IMethodCallSequence<Action<T1, T2, T3>> IMethodCallSequence<Action<T1, T2, T3>>.ThenCall(Action<T1, T2, T3> callback) => ThenCall(callback);
        IMethodCallSequence<Action<T1, T2, T3>> IMethodCallSequence<Action<T1, T2, T3>>.Verifiable() => Verifiable();
        IMethodSequence IMethodSequence.Verifiable() => Verifiable();
    }

    // ========================================================================
    // Inner class: VoidWhenBuilder3
    // ========================================================================
    ...
    public sealed class VoidWhenBuilder3
    {
        ...
        internal VoidWhenBuilder3(VoidMethodInterceptor3<T1, T2, T3> interceptor, Func<T1, T2, T3, bool> predicate)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenChain3 Call(Action<T1, T2, T3> callback)
        {
            ((VoidWhenMatcherPredicate)_interceptor._whenChain![_matcherIndex]).SetCallback(callback);
            return new VoidWhenChain3(_interceptor, _matcherIndex);
        }

        public VoidWhenChain3 ThenCall(Action<T1, T2, T3> callback) { _interceptor._whenChain!.Add(new VoidWhenMatcherCall(callback)); return new VoidWhenChain3(_interceptor, _matcherIndex); }
        public void Verify(Called times) { if (_interceptor._whenChain == null || _matcherIndex >= _interceptor._whenChain.Count) return; var c = _interceptor._whenChain[_matcherIndex].CallCount; if (!times.Validate(c)) throw new VerificationException(new VerificationFailure("When matcher", times, c)); }
    }

    // ========================================================================
    // Inner class: VoidWhenChain3
    // ========================================================================
    ...
    public sealed class VoidWhenChain3
    {
        ...
        internal VoidWhenChain3(VoidMethodInterceptor3<T1, T2, T3> interceptor, int currentMatcherIndex)
        {
            _interceptor = interceptor;
        ...
        public VoidWhenBuilder3 ThenWhen(Func<T1, T2, T3, bool> predicate)
        {
            return new VoidWhenBuilder3(_interceptor, predicate);
        }

        /// <summary>Adds an unconditional callback as terminal matcher.</summary>
        public VoidWhenChain3 ThenCall(Action<T1, T2, T3> callback)
        {
            _interceptor._whenChain ??= new List<VoidWhenMatcherBase>();
        ...
        public VoidWhenChain3 Verifiable()
        {
