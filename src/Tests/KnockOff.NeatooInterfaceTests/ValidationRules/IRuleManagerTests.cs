...
public partial class IRuleManagerTests
{
    ...
    public async Task RunRules_PropertyName_CapturesArgument()
    {
        ...
        stub.RunRules.Return((propOrFlag, token) =>
        {
    ...
    public async Task RunRules_WithCancellation_PassesToken()
    {
        ...
        stub.RunRules.Return((Stubs.IRuleManager_RunRulesInterceptor.RunRulesDelegate_String_Threading_CancellationToken_Threading_Tasks_Task)((prop, token) =>
        {
            capturedToken = token;
            return Task.CompletedTask;
        }));
    ...
    public async Task RunRule_Generic_TracksTypeArgument()
    {
        ...
        stub.RunRuleGeneric.Of<TestRuleForManager>().Verify(Called.Once);
    }
    ...
    public async Task RunRule_Generic_DifferentTypes_TrackedSeparately()
    {
        ...
        stub.RunRuleGeneric.Of<TestRuleForManager>().Verify(Called.Exactly(2));
        stub.RunRuleGeneric.Of<AnotherTestRule>().Verify(Called.Once);
    }
    ...
    public async Task Reset_ClearsMethodTracking()
    {
        ...
        stub.RunRules.Verify(Called.Never);
    }
    ...
    public async Task Reset_GenericMethod_ClearsAllTypeArgs()
    {
        ...
        stub.RunRuleGeneric.Verify(Called.Never);
    }
...
public class IRuleManagerStandaloneTests
{
    ...
    public async Task RunRules_TracksCall()
    {
        ...
        var tracking = stub.RunRules.Return((string propertyName, CancellationToken? token) => Task.CompletedTask);
