...
public partial class IRuleTests
{
    ...
    public void Executed_CanBeConfigured()
    {
        ...
        stub.Executed.VerifyGet(Called.Once);
    }
    ...
    public async Task RunRule_TracksCall()
    {
        ...
        stub.RunRule.Call((IValidateBase target, CancellationToken? token) => Task.FromResult<IRuleMessages>(RuleMessages.None));
    ...
    public async Task RunRule_CanExecuteCallback()
    {
        ...
        stub.RunRule.Call((IValidateBase target, CancellationToken? token) =>
        {
    ...
    public async Task RunRule_ReturnsConfiguredResult()
    {
        ...
        stub.RunRule.Call((IValidateBase target, CancellationToken? token) => Task.FromResult<IRuleMessages>(expectedMessages));
    ...
    public void OnRuleAdded_TracksCall()
    {
        ...
        stub.OnRuleAdded.Verify(Called.Once);
    }
    ...
    public void Reset_ClearsPropertyTracking()
    {
        ...
        stub.Executed.VerifyGet(Called.Never);
    }
    ...
    public async Task Reset_ClearsMethodTracking()
    {
        ...
        stub.RunRule.Verify(Called.Never);
    }
...
public class IRuleStandaloneTests
{
    ...
    public async Task RunRule_TracksCall()
    {
        ...
        // Must provide OnCall for methods with return types
        var tracking = stub.RunRule.Call((IValidateBase target, CancellationToken? token) => Task.FromResult<IRuleMessages>(RuleMessages.None));
