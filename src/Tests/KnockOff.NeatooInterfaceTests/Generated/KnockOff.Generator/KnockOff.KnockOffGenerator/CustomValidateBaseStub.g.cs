...
partial class CustomValidateBaseStub
{
	...
	/// <summary>Interceptor for CustomProperty.</summary>
	...
	/// <summary>Returns this instance as global::KnockOff.NeatooInterfaceTests.ValidationRules.ICustomValidateBase.</summary>
	public global::KnockOff.NeatooInterfaceTests.ValidationRules.ICustomValidateBase AsCustomValidateBase() => this;
	...
	/// <summary>Backing storage for CustomProperty.</summary>
	protected string CustomPropertyBacking { get; set; } = "";
	...
	{
		get { CustomProperty.RecordGet(); return CustomProperty.OnGet?.Invoke(this) ?? CustomPropertyBacking; }
	}
