...
partial class CustomValidateBaseStub : global::KnockOff.NeatooInterfaceTests.ValidationRules.ICustomValidateBase, global::Neatoo.IValidateBase, global::System.ComponentModel.INotifyPropertyChanged, global::Neatoo.INotifyNeatooPropertyChanged, global::Neatoo.IValidateMetaProperties, global::KnockOff.IKnockOffStub
{
	...
	public sealed class CustomPropertyInterceptor
	{
		...
		public CustomPropertyInterceptor Verifiable() { _isVerifiable = true; _verifiableTimes = null; return this; }
		...
		public CustomPropertyInterceptor Verifiable(global::KnockOff.Times times) { _isVerifiable = true; _verifiableTimes = times; return this; }
		...
		public void VerifyGet(global::KnockOff.Times times)
		{
			if (!times.Validate(GetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("CustomProperty (get)", times, GetCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			var totalCount = GetCount;
			return times.Validate(totalCount) ? null : new global::KnockOff.VerificationFailure("CustomProperty", times, totalCount);
		}
	...
	public sealed class ClearAllMessagesInterceptor
	{
		...
		private global::System.Action<CustomValidateBaseStub>? _onCall;
		private MethodTrackingImpl? _onCallTracking;

		private global::System.Collections.Generic.List<(global::System.Action<CustomValidateBaseStub> Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<CustomValidateBaseStub>> OnCallSequence(global::System.Action<CustomValidateBaseStub> callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(global::System.Action<CustomValidateBaseStub> Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<CustomValidateBaseStub>>
		{
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<CustomValidateBaseStub>> ThenCall(global::System.Action<CustomValidateBaseStub> callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<CustomValidateBaseStub>> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
