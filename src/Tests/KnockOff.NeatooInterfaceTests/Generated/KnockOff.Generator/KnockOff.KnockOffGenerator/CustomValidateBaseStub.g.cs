...
partial class CustomValidateBaseStub : global::KnockOff.NeatooInterfaceTests.ValidationRules.ICustomValidateBase, global::Neatoo.IValidateBase, global::System.ComponentModel.INotifyPropertyChanged, global::Neatoo.INotifyNeatooPropertyChanged, global::Neatoo.IValidateMetaProperties, global::KnockOff.IKnockOffStub
{
	...
	public sealed class CustomPropertyInterceptor
	{
		...
		internal string InvokeGet(bool strict)
		{
			...
			if (_getSequence != null && _getSequenceIndex >= _getSequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("CustomProperty (get)");
				return "";
			}

			if (_source is { } src) return src.CustomProperty;

			if (strict) throw global::KnockOff.StubException.NotConfigured("", "CustomProperty");
			return "";
		}
		...
		public void Verify(global::KnockOff.Times times)
		{
			...
			if (!times.Validate(totalCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("CustomProperty", times, totalCount));
		}
		...
		public void VerifyGet(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalGetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("CustomProperty (get)", times, TotalGetCount));
		}

		/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
		public CustomPropertyInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
		...
		public CustomPropertyInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			if (_isGetVerifiable)
			{
				...
				if (!times.Validate(TotalGetCount)) return new global::KnockOff.VerificationFailure("CustomProperty (get)", times, TotalGetCount);
			}
			return null;
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			var totalCount = TotalGetCount;
			return totalCount >= 1 ? null : new global::KnockOff.VerificationFailure("CustomProperty", global::KnockOff.Times.AtLeastOnce, totalCount);
		}
		...
		{
			private readonly CustomPropertyInterceptor _interceptor;

			public PropertyGetTrackingImpl(CustomPropertyInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<string>
		{
			...
			public PropertyGetSequenceImpl(CustomPropertyInterceptor interceptor) => _interceptor = interceptor;
	...
	public void Verify()
	{
		...
		if (CustomProperty.CheckVerification() is { } custompropertyFailure) failures.Add(custompropertyFailure);
	...
	public void VerifyAll()
	{
		...
		if (CustomProperty.CheckVerificationAll() is { } custompropertyFailure) failures.Add(custompropertyFailure);
	...
	{
		get => CustomProperty.InvokeGet(Strict);
	}
