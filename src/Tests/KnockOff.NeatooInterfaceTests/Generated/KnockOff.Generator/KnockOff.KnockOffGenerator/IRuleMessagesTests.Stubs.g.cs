...
partial class IRuleMessagesTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IRuleMessages_CountInterceptor
		{
			...
			public IRuleMessages_CountInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
			...
			public IRuleMessages_CountInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			{
				private readonly IRuleMessages_CountInterceptor _interceptor;

				public PropertyGetTrackingImpl(IRuleMessages_CountInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<int>
			{
				...
				public PropertyGetSequenceImpl(IRuleMessages_CountInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IRuleMessages_IsReadOnlyInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public IRuleMessages_IsReadOnlyInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public IRuleMessages_IsReadOnlyInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly IRuleMessages_IsReadOnlyInterceptor _interceptor;

				public PropertyGetTrackingImpl(IRuleMessages_IsReadOnlyInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<bool>
			{
				...
				public PropertyGetSequenceImpl(IRuleMessages_IsReadOnlyInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IRuleMessages_IndexerInterceptor
		{
			...
			public IRuleMessages_IndexerInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; _isSetVerifiable = true; _setVerifiableTimes = null; return this; }
			...
			public IRuleMessages_IndexerInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; _isSetVerifiable = true; _setVerifiableTimes = times; return this; }
			...
			{
				private readonly IRuleMessages_IndexerInterceptor _interceptor;

				public IndexerGetTrackingImpl(IRuleMessages_IndexerInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class IndexerGetSequenceImpl : global::KnockOff.IIndexerGetSequence<int, global::Neatoo.Rules.IRuleMessage>
			{
				...
				public IndexerGetSequenceImpl(IRuleMessages_IndexerInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class IndexerSetTrackingImpl : global::KnockOff.IIndexerSetTracking<int, global::Neatoo.Rules.IRuleMessage>
			{
				...
				public IndexerSetTrackingImpl(IRuleMessages_IndexerInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class IndexerSetSequenceImpl : global::KnockOff.IIndexerSetSequence<int, global::Neatoo.Rules.IRuleMessage>
			{
				...
				public IndexerSetSequenceImpl(IRuleMessages_IndexerInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IRuleMessages_GetEnumeratorInterceptor
		{
			...
			private global::System.Collections.Generic.IEnumerator<global::Neatoo.Rules.IRuleMessage> _onCallValue = default!;
			private bool _hasOnCallValue;
			private MethodTrackingImpl? _onCallValueTracking;
			...
			/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
			public global::KnockOff.IMethodTracking OnCall(global::System.Collections.Generic.IEnumerator<global::Neatoo.Rules.IRuleMessage> value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
