...
partial class ValidateListBaseOfTStub : global::Neatoo.IValidateListBase<global::Neatoo.IValidateBase>, global::System.Collections.Generic.IList<global::Neatoo.IValidateBase>, global::System.Collections.Generic.ICollection<global::Neatoo.IValidateBase>, global::System.Collections.Generic.IEnumerable<global::Neatoo.IValidateBase>, global::System.Collections.IEnumerable, global::System.Collections.Specialized.INotifyCollectionChanged, global::System.ComponentModel.INotifyPropertyChanged, global::Neatoo.INotifyNeatooPropertyChanged, global::Neatoo.IValidateMetaProperties, global::KnockOff.IKnockOffStub
{
	...
	public sealed class IndexOfInterceptor
	{
		...
		public global::Neatoo.IValidateBase? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
	...
	public sealed class InsertInterceptor
	{
		...
		public (int? index, global::Neatoo.IValidateBase? item)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
	...
	public sealed class CopyToInterceptor
	{
		...
		/// <summary>The arguments from the last call (from most recently called registration).</summary>
		public (global::Neatoo.IValidateBase[]? array, int? arrayIndex)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
	...
	public sealed class GetEnumeratorInterceptor
	{
		...
		public int CallCount => _unconfiguredCallCount + _sequence_NoParams_Collections_Generic_IEnumerator_Neatoo_IValidateBase.Sum(s => s.Tracking.CallCount) + _sequence_NoParams_Collections_IEnumerator.Sum(s => s.Tracking.CallCount);
