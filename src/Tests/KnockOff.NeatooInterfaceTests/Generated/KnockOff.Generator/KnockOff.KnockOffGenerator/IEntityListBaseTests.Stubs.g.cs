...
partial class IEntityListBaseTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IEntityListBase_RootInterceptor
		{
			...
			public IEntityListBase_RootInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
			...
			public IEntityListBase_RootInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			{
				private readonly IEntityListBase_RootInterceptor _interceptor;

				public PropertyGetTrackingImpl(IEntityListBase_RootInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<global::Neatoo.IValidateBase?>
			{
				...
				public PropertyGetSequenceImpl(IEntityListBase_RootInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IEntityListBase_IsFixedSizeInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public IEntityListBase_IsFixedSizeInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public IEntityListBase_IsFixedSizeInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly IEntityListBase_IsFixedSizeInterceptor _interceptor;

				public PropertyGetTrackingImpl(IEntityListBase_IsFixedSizeInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<bool>
			{
				...
				public PropertyGetSequenceImpl(IEntityListBase_IsFixedSizeInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IEntityListBase_IsSynchronizedInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public IEntityListBase_IsSynchronizedInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public IEntityListBase_IsSynchronizedInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly IEntityListBase_IsSynchronizedInterceptor _interceptor;

				public PropertyGetTrackingImpl(IEntityListBase_IsSynchronizedInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<bool>
			{
				...
				public PropertyGetSequenceImpl(IEntityListBase_IsSynchronizedInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IEntityListBase_SyncRootInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public IEntityListBase_SyncRootInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public IEntityListBase_SyncRootInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly IEntityListBase_SyncRootInterceptor _interceptor;

				public PropertyGetTrackingImpl(IEntityListBase_SyncRootInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<object>
			{
				...
				public PropertyGetSequenceImpl(IEntityListBase_SyncRootInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IEntityListBase_IndexerInterceptor
		{
			...
			private global::System.Collections.Generic.List<(global::System.Action<int, object?> Callback, IndexerSetTrackingImpl Tracking)>? _setSequence;
			...
			private (int Key, object? Value)? _unconfiguredLastSetEntry;
			...
			public (int Key, object? Value)? LastSetEntry { get { if ((_onSetTracking?.CallCount ?? 0) > 0) return _onSetTracking!.LastEntry; if (_setSequence != null) for (int i = _setSequence.Count - 1; i >= 0; i--) if (_setSequence[i].Tracking.CallCount > 0) return _setSequence[i].Tracking.LastEntry; return _unconfiguredSetCount > 0 ? _unconfiguredLastSetEntry : default; } }
			...
			public global::KnockOff.IIndexerSetTracking<int, object?> OnSet(global::System.Action<int, object?> callback)
			{
				_setSequence = null;
				_setSequenceIndex = 0;
			...
			public global::KnockOff.IIndexerSetSequence<int, object?> OnSetSequence(global::System.Action<int, object?> callback)
			{
				_onSet = null;
				_onSetTracking = null;
				_isSetVerifiable = false;
				_setVerifiableTimes = null;
				_setSequence = new global::System.Collections.Generic.List<(global::System.Action<int, object?> Callback, IndexerSetTrackingImpl Tracking)>();
			...
			/// <summary>Invokes the configured getter callback. Called by explicit interface implementation.</summary>
			internal object? InvokeGet(bool strict, int index)
			{
				if (_getSequence != null && _getSequenceIndex < _getSequence.Count)
				{
					var (callback, tracking) = _getSequence[_getSequenceIndex];
			...
			internal void InvokeSet(bool strict, int index, object? value)
			{
			...
			private sealed class IndexerSetTrackingImpl : global::KnockOff.IIndexerSetTracking<int, object?>
			{
				private readonly IEntityListBase_IndexerInterceptor _interceptor;

				public IndexerSetTrackingImpl(IEntityListBase_IndexerInterceptor interceptor) => _interceptor = interceptor;

				private (int Key, object? Value)? _lastEntry;

				internal int CallCount { get; private set; }

				/// <summary>Last key and value passed to this setter callback. Null if never called.</summary>
				public (int Key, object? Value)? LastEntry => _lastEntry;

				/// <summary>Records a call to this callback.</summary>
				public void RecordCall(int key, object? value) { CallCount++; _lastEntry = (key, value); }
				...
				/// <summary>Marks for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
				public global::KnockOff.IIndexerSetTracking<int, object?> Verifiable()
				{
				...
				/// <summary>Marks for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
				public global::KnockOff.IIndexerSetTracking<int, object?> Verifiable(global::KnockOff.Times times)
				{
					_interceptor._isSetVerifiable = true;
			...
			private sealed class IndexerSetSequenceImpl : global::KnockOff.IIndexerSetSequence<int, object?>
			{
				private readonly IEntityListBase_IndexerInterceptor _interceptor;
				...
				/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
				public global::KnockOff.IIndexerSetSequence<int, object?> Verifiable()
				{
					_interceptor._isSetVerifiable = true;
					_interceptor._setVerifiableTimes = null;
					return this;
		...
		public sealed class IEntityListBase_ContainsInterceptor
		{
			...
			/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
			public global::KnockOff.IMethodTracking<object?> OnCall(bool value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
		...
		public class IEntityListBase : global::Neatoo.IEntityListBase, global::KnockOff.IKnockOffStub
		{
			...
			/// <summary>Sets the source object for global::Neatoo.IEntityListBase delegation.</summary>
