...
partial class EntityBaseStubForListT : global::Neatoo.IEntityBase, global::Neatoo.IValidateBase, global::System.ComponentModel.INotifyPropertyChanged, global::Neatoo.INotifyNeatooPropertyChanged, global::Neatoo.IValidateMetaProperties, global::Neatoo.IEntityMetaProperties, global::Neatoo.RemoteFactory.IFactorySaveMeta, global::KnockOff.IKnockOffStub
{
	...
	public sealed class WaitForTasks1Interceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(EntityBaseStubForListT ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
	...
	public sealed class WaitForTasks2Interceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(EntityBaseStubForListT ko, bool strict, global::System.Threading.CancellationToken token)
		{
			if (_sequence.Count == 0)
			{
				if (strict) throw global::KnockOff.StubException.NotConfigured("", "WaitForTasks");
	...
	public sealed class RunRules1Interceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(EntityBaseStubForListT ko, bool strict, string propertyName, global::System.Threading.CancellationToken? token)
		{
			if (_sequence.Count == 0)
			{
	...
	public sealed class RunRules2Interceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(EntityBaseStubForListT ko, bool strict, global::Neatoo.RunRulesFlag runRules, global::System.Threading.CancellationToken? token)
		{
			if (_sequence.Count == 0)
			{
				if (strict) throw global::KnockOff.StubException.NotConfigured("", "RunRules");
