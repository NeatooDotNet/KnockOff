...
partial class StringLengthRuleStub
{
	...
	/// <summary>Returns this instance as global::Neatoo.Rules.Rules.IStringLengthRule.</summary>
	public global::Neatoo.Rules.Rules.IStringLengthRule AsStringLengthRule() => this;
	...
	/// <summary>Backing storage for MinimumLength.</summary>
	protected int MinimumLengthBacking { get; set; } = default!;

	/// <summary>Backing storage for MaximumLength.</summary>
	protected int MaximumLengthBacking { get; set; } = default!;
	...
	{
		get { MinimumLength.RecordGet(); return MinimumLength.OnGet?.Invoke(this) ?? MinimumLengthBacking; }
	}

	int global::Neatoo.Rules.Rules.IStringLengthRule.MaximumLength
	{
		get { MaximumLength.RecordGet(); return MaximumLength.OnGet?.Invoke(this) ?? MaximumLengthBacking; }
	}
