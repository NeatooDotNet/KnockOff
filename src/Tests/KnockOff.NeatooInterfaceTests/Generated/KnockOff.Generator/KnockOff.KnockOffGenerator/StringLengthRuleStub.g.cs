...
partial class StringLengthRuleStub
{
	...
	{
		get { MinimumLength.RecordGet(); return MinimumLength.OnGet?.Invoke(this) ?? MinimumLength.Value; }
	}

	int global::Neatoo.Rules.Rules.IStringLengthRule.MaximumLength
	{
		get { MaximumLength.RecordGet(); return MaximumLength.OnGet?.Invoke(this) ?? MaximumLength.Value; }
	}
