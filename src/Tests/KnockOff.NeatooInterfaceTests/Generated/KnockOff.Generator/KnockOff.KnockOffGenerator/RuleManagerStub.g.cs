...
partial class RuleManagerStub : global::Neatoo.Rules.IRuleManager, global::KnockOff.IKnockOffStub
{
	...
	public sealed class RunRules1Interceptor
	{
		...
		internal global::System.Threading.Tasks.Task Invoke(RuleManagerStub ko, bool strict, string propertyName, global::System.Threading.CancellationToken? token)
		{
	...
	public sealed class RunRules2Interceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(RuleManagerStub ko, bool strict, global::Neatoo.RunRulesFlag runRules, global::System.Threading.CancellationToken? token)
		{
			if (_sequence.Count == 0)
			{
				if (strict) throw global::KnockOff.StubException.NotConfigured("", "RunRules");
