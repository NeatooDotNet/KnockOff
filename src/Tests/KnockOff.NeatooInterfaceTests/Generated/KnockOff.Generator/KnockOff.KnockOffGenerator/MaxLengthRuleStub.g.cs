...
partial class MaxLengthRuleStub
{
	...
	/// <summary>Returns this instance as global::Neatoo.Rules.Rules.IMaxLengthRule.</summary>
	public global::Neatoo.Rules.Rules.IMaxLengthRule AsMaxLengthRule() => this;
	...
	/// <summary>Backing storage for Length.</summary>
	protected int LengthBacking { get; set; } = default!;
	...
	{
		get { Length.RecordGet(); return Length.OnGet?.Invoke(this) ?? LengthBacking; }
	}
