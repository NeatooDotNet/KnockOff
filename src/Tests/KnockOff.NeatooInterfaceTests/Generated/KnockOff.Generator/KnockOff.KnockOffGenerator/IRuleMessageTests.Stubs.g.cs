...
partial class IRuleMessageTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IRuleMessage_RuleIndexInterceptor
		{
			...
			public IRuleMessage_RuleIndexInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
			...
			public IRuleMessage_RuleIndexInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			{
				private readonly IRuleMessage_RuleIndexInterceptor _interceptor;

				public PropertyGetTrackingImpl(IRuleMessage_RuleIndexInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<uint>
			{
				...
				public PropertyGetSequenceImpl(IRuleMessage_RuleIndexInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IRuleMessage_PropertyNameInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public IRuleMessage_PropertyNameInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public IRuleMessage_PropertyNameInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly IRuleMessage_PropertyNameInterceptor _interceptor;

				public PropertyGetTrackingImpl(IRuleMessage_PropertyNameInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<string>
			{
				...
				public PropertyGetSequenceImpl(IRuleMessage_PropertyNameInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IRuleMessage_MessageInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public IRuleMessage_MessageInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public IRuleMessage_MessageInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly IRuleMessage_MessageInterceptor _interceptor;

				public PropertyGetTrackingImpl(IRuleMessage_MessageInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<string?>
			{
				...
				public PropertyGetSequenceImpl(IRuleMessage_MessageInterceptor interceptor) => _interceptor = interceptor;
