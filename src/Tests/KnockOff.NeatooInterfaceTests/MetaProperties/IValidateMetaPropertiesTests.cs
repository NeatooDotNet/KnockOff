...
public partial class IValidateMetaPropertiesTests
{
    ...
    public async Task RunRules_CanExecuteCallback()
    {
        ...
        stub.RunRules.Returns((Stubs.IValidateMetaProperties_RunRulesInterceptor.RunRulesDelegate_String_Threading_CancellationToken_Threading_Tasks_Task)((propOrFlag, token) =>
        {
...
public class IValidateMetaPropertiesStandaloneTests
{
    ...
    public void PropertyMessages_CanBeConfigured()
    {
        ...
        propertyMessageStub.Message.Get("Required");
