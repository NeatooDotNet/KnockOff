...
partial class MigrationTimestampServiceStub : global::KnockOff.Documentation.Samples.PropertyValueRemovalMigration.IMigrationTimestampService, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for LastUpdated.</summary>
	public sealed class LastUpdatedInterceptor
	{
		/// <summary>Source object to delegate to when no OnGet/OnSet is configured.</summary>
		internal global::KnockOff.Documentation.Samples.PropertyValueRemovalMigration.IMigrationTimestampService? _source;
		...
		internal global::System.DateTime InvokeGet(bool strict)
		{
			...
			if (_getSequence != null && _getSequenceIndex >= _getSequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("LastUpdated (get)");
				return default!;
			}

			if (_source is { } src) return src.LastUpdated;

			if (strict) throw global::KnockOff.StubException.NotConfigured("", "LastUpdated");
			return default!;
		}
		...
		public void Verify(global::KnockOff.Times times)
		{
			...
			if (!times.Validate(totalCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("LastUpdated", times, totalCount));
		}
		...
		public void VerifyGet(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalGetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("LastUpdated (get)", times, TotalGetCount));
		}

		/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
		public LastUpdatedInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
		...
		public LastUpdatedInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			if (_isGetVerifiable)
			{
				...
				if (!times.Validate(TotalGetCount)) return new global::KnockOff.VerificationFailure("LastUpdated (get)", times, TotalGetCount);
			}
			return null;
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			var totalCount = TotalGetCount;
			return totalCount >= 1 ? null : new global::KnockOff.VerificationFailure("LastUpdated", global::KnockOff.Times.AtLeastOnce, totalCount);
		}
		...
		{
			private readonly LastUpdatedInterceptor _interceptor;

			public PropertyGetTrackingImpl(LastUpdatedInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<global::System.DateTime>
		{
			...
			public PropertyGetSequenceImpl(LastUpdatedInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>Interceptor for LastUpdated. Configure via .Value, track via .GetCount.</summary>
	public LastUpdatedInterceptor LastUpdated { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Documentation.Samples.PropertyValueRemovalMigration.IMigrationTimestampService instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.PropertyValueRemovalMigration.IMigrationTimestampService Object => this;

	// Source(T) methods for interface delegation

	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.PropertyValueRemovalMigration.IMigrationTimestampService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.PropertyValueRemovalMigration.IMigrationTimestampService? source)
	{
		LastUpdated._source = source;
	}

	global::System.DateTime global::KnockOff.Documentation.Samples.PropertyValueRemovalMigration.IMigrationTimestampService.LastUpdated
	{
		get => LastUpdated.InvokeGet(Strict);
	}
