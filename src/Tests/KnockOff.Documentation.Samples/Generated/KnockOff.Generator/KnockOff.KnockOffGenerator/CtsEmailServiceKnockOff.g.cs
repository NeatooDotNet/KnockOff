...
partial class CtsEmailServiceKnockOff : global::KnockOff.Documentation.Samples.WhyKnockOff.ICtsEmailService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SendEmailInterceptor
	{
		...
		public (string? to, string? subject, string? body)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
