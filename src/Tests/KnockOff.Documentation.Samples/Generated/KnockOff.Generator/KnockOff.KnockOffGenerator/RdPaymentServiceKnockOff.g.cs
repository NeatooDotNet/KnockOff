...
partial class RdPaymentServiceKnockOff : global::KnockOff.Documentation.Samples.WhyKnockOff.IRdPaymentService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ProcessInterceptor
	{
		...
		public (int? orderId, decimal? amount)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
