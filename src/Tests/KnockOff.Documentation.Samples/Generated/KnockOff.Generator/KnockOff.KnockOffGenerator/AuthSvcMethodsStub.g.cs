...
partial class AuthSvcMethodsStub : global::KnockOff.Documentation.Samples.Methods.IAuthSvcMethods, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ValidateCredentialsInterceptor
	{
		...
		private global::System.Collections.Generic.List<(ValidateCredentialsDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ValidateCredentials", times, TotalCallCount));
		}
		...
		public global::KnockOff.IMethodTrackingArgs<(string? username, string? password)> OnCall(bool value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<ValidateCredentialsDelegate> OnCallSequence(ValidateCredentialsDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(ValidateCredentialsDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal bool Invoke(bool strict, string username, string password)
		{
			...
			{
				_onCallValueTracking.RecordCall((username, password));
				return _onCallValue;
			}
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("ValidateCredentials");
				return default!;
			}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("ValidateCredentials", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("ValidateCredentials", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTrackingArgs<(string? username, string? password)>
		{
			...
			public MethodTrackingImpl(ValidateCredentialsInterceptor interceptor) => _interceptor = interceptor;
			...
			public global::KnockOff.IMethodTrackingArgs<(string? username, string? password)> Verifiable()
			{
			...
			public global::KnockOff.IMethodTrackingArgs<(string? username, string? password)> Verifiable(global::KnockOff.Times times)
			{
				_interceptor._isVerifiable = true;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<ValidateCredentialsDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<ValidateCredentialsDelegate> ThenCall(ValidateCredentialsDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<ValidateCredentialsDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public void Verify()
	{
		...
		if (ValidateCredentials.CheckVerification() is { } validatecredentialsFailure) failures.Add(validatecredentialsFailure);
	...
	public void VerifyAll()
	{
		...
		if (ValidateCredentials.CheckVerificationAll() is { } validatecredentialsFailure) failures.Add(validatecredentialsFailure);
