...
partial class GenOrderRepositoryKnockOff : global::KnockOff.Documentation.Samples.Guides.IGenRepository<global::KnockOff.Documentation.Samples.Guides.GenOrder>, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveInterceptor
	{
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Documentation.Samples.Guides.GenOrder? LastCallArg { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
