...
partial class SkVerificationIndexerKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkVerificationPropertyStore, global::KnockOff.IKnockOffStub
{
	...
	public sealed class IndexerInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Skills.ISkVerificationPropertyStore? _source;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.ISkVerificationPropertyStore).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skills.ISkVerificationPropertyStore? source)
	{
	...
	{
		get { Indexer.RecordGet(key); if (Indexer.OnGet is { } onGet) return onGet(this, key); if (Indexer._source is { } src) return src[key]; if (Strict) throw global::KnockOff.StubException.NotConfigured("ISkVerificationPropertyStore", "this[]"); return Indexer.Backing.TryGetValue(key, out var v) ? v : default; }
		set { Indexer.RecordSet(key, value); if (Indexer.OnSet is { } onSet) { onSet(this, key, value); return; } if (Indexer._source is { } src) { src[key] = value; return; } if (Strict) throw global::KnockOff.StubException.NotConfigured("ISkVerificationPropertyStore", "this[]"); Indexer.Backing[key] = value; }
	}
