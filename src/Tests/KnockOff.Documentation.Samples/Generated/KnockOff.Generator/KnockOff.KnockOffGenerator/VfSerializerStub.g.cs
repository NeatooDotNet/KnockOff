...
partial class VfSerializerStub : global::KnockOff.Documentation.Samples.Guides.IVfSerializer, global::KnockOff.IKnockOffStub
{
	...
	public sealed class DeserializeInterceptor
	{
		...
		public DeserializeTypedHandler<T> Of<T>() where T : class
		{
			var key = typeof(T);
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Guides.IVfSerializer instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Guides.IVfSerializer Object => this;
