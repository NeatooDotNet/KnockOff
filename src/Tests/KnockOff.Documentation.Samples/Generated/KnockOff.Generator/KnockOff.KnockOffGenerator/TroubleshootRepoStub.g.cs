...
partial class TroubleshootRepoStub : global::KnockOff.Documentation.Samples.Troubleshooting.ITroubleshootRepo, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetByIdInterceptor
	{
		...
		public delegate global::KnockOff.Documentation.Samples.User? GetByIdDelegate(TroubleshootRepoStub ko, int id);
		...
		internal global::KnockOff.Documentation.Samples.User? Invoke(TroubleshootRepoStub ko, bool strict, int id)
		{
	...
	public sealed class GetByIdAsyncInterceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.User?> GetByIdAsyncDelegate(TroubleshootRepoStub ko, int id);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.User?> Invoke(TroubleshootRepoStub ko, bool strict, int id)
		{
			if (_sequence != null && _sequenceIndex < _sequence.Count)
			{
				var (callback, tracking) = _sequence[_sequenceIndex];
	...
	public sealed class GetNameInterceptor
	{
		...
		public delegate string GetNameDelegate(TroubleshootRepoStub ko);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal string Invoke(TroubleshootRepoStub ko, bool strict)
		{
			if (_sequence != null && _sequenceIndex < _sequence.Count)
			{
				var (callback, tracking) = _sequence[_sequenceIndex];
