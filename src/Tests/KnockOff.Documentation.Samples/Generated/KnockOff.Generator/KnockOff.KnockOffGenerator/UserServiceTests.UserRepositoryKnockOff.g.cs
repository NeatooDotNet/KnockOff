...
partial class UserRepositoryKnockOff : global::KnockOff.Documentation.Samples.GettingStarted.IUserRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetUserInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.GettingStarted.IUserRepository? _source;
	...
	public sealed class SaveUserInterceptor
	{
		...
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		private global::KnockOff.Documentation.Samples.GettingStarted.User? _unconfiguredLastArg;
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Documentation.Samples.GettingStarted.User? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.GettingStarted.IUserRepository).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.GettingStarted.IUserRepository? source)
	{
