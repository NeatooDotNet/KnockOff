...
partial class SkCallbackMethodKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkCallbackService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class DoWorkInterceptor
	{
		...
		public global::KnockOff.IMethodTracking OnCall(global::System.Action<SkCallbackMethodKnockOff> callback)
		{
		...
		public global::KnockOff.IMethodSequence<global::System.Action<SkCallbackMethodKnockOff>> OnCall(global::System.Action<SkCallbackMethodKnockOff> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal void Invoke(SkCallbackMethodKnockOff ko, bool strict)
		{
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<SkCallbackMethodKnockOff>>
		{
			...
			public global::KnockOff.IMethodSequence<global::System.Action<SkCallbackMethodKnockOff>> ThenCall(global::System.Action<SkCallbackMethodKnockOff> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
	...
	public sealed class GetByIdInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::KnockOff.Documentation.Samples.Skills.SkUser Invoke(SkCallbackMethodKnockOff ko, bool strict, int id)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	public sealed class SearchInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Collections.Generic.List<global::KnockOff.Documentation.Samples.Skills.SkUser> Invoke(SkCallbackMethodKnockOff ko, bool strict, string query, int limit, int offset)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
