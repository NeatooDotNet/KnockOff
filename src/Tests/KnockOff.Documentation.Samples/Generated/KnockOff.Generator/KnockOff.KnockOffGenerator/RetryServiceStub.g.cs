...
partial class RetryServiceStub : global::KnockOff.Documentation.Samples.AdvancedCallbacks.IRetryService, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for Attempt.</summary>
	public sealed class AttemptInterceptor
	{
		...
		private global::System.Collections.Generic.List<(AttemptDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Attempt", times, TotalCallCount));
		}

		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking OnCall(AttemptDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<AttemptDelegate> OnCallSequence(AttemptDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(AttemptDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal bool Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("Attempt");
				return default!;
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) return src.Attempt();
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "Attempt");
			return default!;
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Attempt", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Attempt", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			private readonly AttemptInterceptor _interceptor;

			public MethodTrackingImpl(AttemptInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<AttemptDelegate>
		{
			private readonly AttemptInterceptor _interceptor;

			public MethodSequenceImpl(AttemptInterceptor interceptor) => _interceptor = interceptor;
			...
			public global::KnockOff.IMethodSequence<AttemptDelegate> ThenCall(AttemptDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<AttemptDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>Interceptor for Attempt.</summary>
	public AttemptInterceptor Attempt { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Documentation.Samples.AdvancedCallbacks.IRetryService instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.AdvancedCallbacks.IRetryService Object => this;
	...
	public void Verify()
	{
		...
		if (Attempt.CheckVerification() is { } attemptFailure) failures.Add(attemptFailure);
	...
	public void VerifyAll()
	{
		...
		if (Attempt.CheckVerificationAll() is { } attemptFailure) failures.Add(attemptFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.AdvancedCallbacks.IRetryService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.AdvancedCallbacks.IRetryService? source)
	{
		Attempt._source = source;
	}
