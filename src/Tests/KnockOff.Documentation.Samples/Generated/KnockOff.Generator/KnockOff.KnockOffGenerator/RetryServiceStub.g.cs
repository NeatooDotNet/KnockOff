...
partial class RetryServiceStub : global::KnockOff.Documentation.Samples.AdvancedCallbacks.IRetryService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class AttemptInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(AttemptDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public global::KnockOff.IMethodSequence<AttemptDelegate> OnCall(AttemptDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal bool Invoke(RetryServiceStub ko, bool strict)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("Attempt");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<AttemptDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<AttemptDelegate> ThenCall(AttemptDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
