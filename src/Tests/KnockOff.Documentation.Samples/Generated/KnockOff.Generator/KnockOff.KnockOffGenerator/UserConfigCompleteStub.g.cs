...
partial class UserConfigCompleteStub : global::KnockOff.Documentation.Samples.Properties.IUserConfigComplete, global::KnockOff.IKnockOffStub
{
	...
	public sealed class CurrentUserInterceptor
	{
		...
		public CurrentUserInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
		...
		public CurrentUserInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
	...
	public sealed class ConnectInterceptor
	{
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Connect", times, TotalCallCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Connect", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Connect", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Properties.IUserConfigComplete instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Properties.IUserConfigComplete Object => this;
	...
	public void Verify()
	{
		...
		if (CurrentUser.CheckVerification() is { } currentuserFailure) failures.Add(currentuserFailure);
	...
	public void VerifyAll()
	{
		...
		if (CurrentUser.CheckVerificationAll() is { } currentuserFailure) failures.Add(currentuserFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Properties.IUserConfigComplete).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Properties.IUserConfigComplete? source)
	{
