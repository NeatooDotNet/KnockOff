...
partial class ConfigSvcStub : global::KnockOff.Documentation.Samples.Troubleshooting.IConfigSvc, global::KnockOff.IKnockOffStub
{
	...
	public sealed class HostInterceptor
	{
		...
		public void VerifyGet(global::KnockOff.Times times)
		{
			if (!times.Validate(_getCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Host (get)", times, _getCount));
		}
		...
		public void VerifySet(global::KnockOff.Times times)
		{
			if (!times.Validate(_setCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Host (set)", times, _setCount));
		}
	...
	public sealed class PortInterceptor
	{
		...
		{
			if (!times.Validate(_getCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Port (get)", times, _getCount));
		}
		...
		{
			if (!times.Validate(_setCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Port (set)", times, _setCount));
		}
