...
partial class SkillDataSvcTests
{
	/// <summary>Contains stub implementations for inline stub pattern.</summary>
	public static class Stubs
	{
		/// <summary>Tracks and configures behavior for IsConnected.</summary>
		public sealed class SkillDataSvc_IsConnectedInterceptor
		{
			...
			public SkillDataSvc_IsConnectedInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; _isSetVerifiable = true; _setVerifiableTimes = null; return this; }
			...
			public SkillDataSvc_IsConnectedInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; _isSetVerifiable = true; _setVerifiableTimes = times; return this; }
			...
			{
				private readonly SkillDataSvc_IsConnectedInterceptor _interceptor;

				public PropertyGetTrackingImpl(SkillDataSvc_IsConnectedInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<bool>
			{
				...
				public PropertyGetSequenceImpl(SkillDataSvc_IsConnectedInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertySetTrackingImpl : global::KnockOff.IPropertySetTracking<bool>
			{
				...
				public PropertySetTrackingImpl(SkillDataSvc_IsConnectedInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertySetSequenceImpl : global::KnockOff.IPropertySetSequence<bool>
			{
				...
				public PropertySetSequenceImpl(SkillDataSvc_IsConnectedInterceptor interceptor) => _interceptor = interceptor;
				...
				/// <summary>Interceptor for SkillDataSvc.GetData.</summary>
				public sealed class SkillDataSvc_GetDataInterceptor : global::KnockOff.IMethodTracking
				{
					private global::System.Func<int, string?>? _onCall;
					...
					public global::KnockOff.IMethodTracking OnCall(global::System.Func<int, string?> callback) { _onCall = callback; return this; }

					/// <summary>Gets the configured callback (internal use).</summary>
					internal global::System.Func<int, string?>? Callback => _onCall;
			...
			public void Reset() { _callCount = 0; LastCallArg = default; 		}
					...
					internal global::KnockOff.VerificationFailure? CheckVerification()
					{
						...
						return times.Validate(_callCount) ? null : new global::KnockOff.VerificationFailure("GetData", times, _callCount);
					}
					...
					{
						if (!IsConfigured) return null;
						return _callCount >= 1 ? null : new global::KnockOff.VerificationFailure("GetData", global::KnockOff.Times.AtLeastOnce, _callCount);
					}
				}

				/// <summary>Stub for global::KnockOff.Documentation.Samples.Skill.SkillDataSvc via composition.</summary>
				public class SkillDataSvc : global::KnockOff.IKnockOffStub
				{
					...
					public SkillDataSvc_IsConnectedInterceptor IsConnected { get; } = new();
					/// <summary>Interceptor for GetData.</summary>
					public SkillDataSvc_GetDataInterceptor GetData { get; } = new();

					/// <summary>The global::KnockOff.Documentation.Samples.Skill.SkillDataSvc instance. Pass this to code expecting the target class.</summary>
					public global::KnockOff.Documentation.Samples.Skill.SkillDataSvc Object { get; }
					...
					/// <summary>Internal implementation that inherits from global::KnockOff.Documentation.Samples.Skill.SkillDataSvc.</summary>
					private sealed class Impl : global::KnockOff.Documentation.Samples.Skill.SkillDataSvc
					{
						private readonly SkillDataSvc _stub;

						public Impl(SkillDataSvc stub) : base()
						{
							_stub = stub;
						}
						...
						{
							_stub?.GetData.RecordCall(id);
							if (_stub?.GetData.Callback is { } onCall) return onCall(id);
