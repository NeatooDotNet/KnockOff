...
partial class SkSingleMethodServiceKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkSingleMethodService, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for SendEmail.</summary>
	public sealed class SendEmailInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Skills.ISkSingleMethodService? _source;

		private readonly global::System.Collections.Generic.List<(global::System.Action<SkSingleMethodServiceKnockOff, string, string> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public (string? to, string? subject)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }


		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTrackingArgs<(string? to, string? subject)> OnCall(global::System.Action<SkSingleMethodServiceKnockOff, string, string> callback)
		{
		...
		public global::KnockOff.IMethodSequence<global::System.Action<SkSingleMethodServiceKnockOff, string, string>> OnCall(global::System.Action<SkSingleMethodServiceKnockOff, string, string> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal void Invoke(SkSingleMethodServiceKnockOff ko, bool strict, string to, string subject)
		{
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<SkSingleMethodServiceKnockOff, string, string>>
		{
			...
			public global::KnockOff.IMethodSequence<global::System.Action<SkSingleMethodServiceKnockOff, string, string>> ThenCall(global::System.Action<SkSingleMethodServiceKnockOff, string, string> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.ISkSingleMethodService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skills.ISkSingleMethodService? source)
	{
	...
	{
		SendEmail.Invoke(this, Strict, to, subject);
	}
