...
partial class AsyncRepoStub : global::KnockOff.Documentation.Samples.Async.IAsyncRepo, global::KnockOff.IKnockOffStub
{
	...
	public sealed class FindAsyncInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(FindAsyncDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public global::KnockOff.IMethodSequence<FindAsyncDelegate> OnCall(FindAsyncDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.User?> Invoke(AsyncRepoStub ko, bool strict, int id)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("FindAsync");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<FindAsyncDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<FindAsyncDelegate> ThenCall(FindAsyncDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
