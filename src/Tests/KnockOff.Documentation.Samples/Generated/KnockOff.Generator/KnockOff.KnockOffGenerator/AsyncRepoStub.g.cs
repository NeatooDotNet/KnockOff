...
partial class AsyncRepoStub : global::KnockOff.Documentation.Samples.Async.IAsyncRepo, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for FindAsync.</summary>
	public sealed class FindAsyncInterceptor
	{
		...
		private global::System.Collections.Generic.List<(FindAsyncDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("FindAsync", times, TotalCallCount));
		}

		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking<int> OnCall(FindAsyncDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<FindAsyncDelegate> OnCallSequence(FindAsyncDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(FindAsyncDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.User?> Invoke(bool strict, int id)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("FindAsync");
				return global::System.Threading.Tasks.Task.FromResult<global::KnockOff.Documentation.Samples.User?>(default!);
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) return src.FindAsync(id);
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "FindAsync");
			return global::System.Threading.Tasks.Task.FromResult<global::KnockOff.Documentation.Samples.User?>(default!);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("FindAsync", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("FindAsync", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<int>
		{
			private readonly FindAsyncInterceptor _interceptor;

			public MethodTrackingImpl(FindAsyncInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<FindAsyncDelegate>
		{
			private readonly FindAsyncInterceptor _interceptor;

			public MethodSequenceImpl(FindAsyncInterceptor interceptor) => _interceptor = interceptor;
			...
			public global::KnockOff.IMethodSequence<FindAsyncDelegate> ThenCall(FindAsyncDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<FindAsyncDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>Interceptor for FindAsync.</summary>
	public FindAsyncInterceptor FindAsync { get; } = new();
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Async.IAsyncRepo instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Async.IAsyncRepo Object => this;
	...
	public void Verify()
	{
		...
		if (FindAsync.CheckVerification() is { } findasyncFailure) failures.Add(findasyncFailure);
	...
	public void VerifyAll()
	{
		...
		if (FindAsync.CheckVerificationAll() is { } findasyncFailure) failures.Add(findasyncFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Async.IAsyncRepo).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Async.IAsyncRepo? source)
	{
		FindAsync._source = source;
