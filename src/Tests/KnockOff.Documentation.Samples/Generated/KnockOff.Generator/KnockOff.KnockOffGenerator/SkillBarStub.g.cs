...
partial class SkillBarStub : global::KnockOff.Documentation.Samples.Skill.ISkillBar, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for Process.</summary>
	public sealed class ProcessInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Skill.ISkillBar? _source;
		...
		internal void Invoke(bool strict, int id, string name)
		{
			...
			if (_source is { } src) { src.Process(id, name); return; }
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Skill.ISkillBar instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Skill.ISkillBar Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skill.ISkillBar).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skill.ISkillBar? source)
	{
		Process._source = source;
	}

	void global::KnockOff.Documentation.Samples.Skill.ISkillBar.Process(int id, string name)
	{
		Process.Invoke(Strict, id, name);
	}
