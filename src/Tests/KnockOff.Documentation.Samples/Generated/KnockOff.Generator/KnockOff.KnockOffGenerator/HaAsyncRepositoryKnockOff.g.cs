...
partial class HaAsyncRepositoryKnockOff : global::KnockOff.Documentation.Samples.Skills.IHaAsyncRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetByIdAsyncInterceptor
	{
		...
		internal global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.Skills.HaUser?> Invoke(HaAsyncRepositoryKnockOff ko, bool strict, int id)
		{
	...
	public sealed class SaveAsyncInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task<int> Invoke(HaAsyncRepositoryKnockOff ko, bool strict, object entity)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
