...
partial class MultiServiceTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IInUserService_SaveUserInterceptor
		{
			...
			/// <summary>The argument from the last call (from most recently called registration).</summary>
			public global::KnockOff.Documentation.Samples.Guides.InlineStubs.InUser? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
		...
		public sealed class IInLogger_LogErrorInterceptor
		{
			...
			public (string message, global::System.Exception? ex)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
		...
		{
			/// <summary>Source object to delegate to when no OnCall is configured.</summary>
			internal global::KnockOff.Documentation.Samples.Guides.InlineStubs.IInRepository? _source;
		...
		public class IInRepository : global::KnockOff.Documentation.Samples.Guides.InlineStubs.IInRepository, global::KnockOff.IKnockOffStub
		{
			...
			/// <summary>Sets the source object for global::KnockOff.Documentation.Samples.Guides.InlineStubs.IInRepository delegation.</summary>
			public void Source(global::KnockOff.Documentation.Samples.Guides.InlineStubs.IInRepository? source)
			{
				Save._source = source;
