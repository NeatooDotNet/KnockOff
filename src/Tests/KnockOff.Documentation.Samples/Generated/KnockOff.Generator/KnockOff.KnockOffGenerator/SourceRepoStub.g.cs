...
partial class SourceRepoStub : global::KnockOff.Documentation.Samples.SourceDelegation.IRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<SourceRepoStub, global::KnockOff.Documentation.Samples.User> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<SourceRepoStub, global::KnockOff.Documentation.Samples.User>> OnCall(global::System.Action<SourceRepoStub, global::KnockOff.Documentation.Samples.User> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<SourceRepoStub, global::KnockOff.Documentation.Samples.User>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<SourceRepoStub, global::KnockOff.Documentation.Samples.User>> ThenCall(global::System.Action<SourceRepoStub, global::KnockOff.Documentation.Samples.User> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	public sealed class GetPriorityInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(GetPriorityDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		private global::KnockOff.Documentation.Samples.User? _unconfiguredLastArg;
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<GetPriorityDelegate> OnCall(GetPriorityDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		internal int Invoke(SourceRepoStub ko, bool strict, global::KnockOff.Documentation.Samples.User user)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("GetPriority");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetPriorityDelegate>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<GetPriorityDelegate> ThenCall(GetPriorityDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
