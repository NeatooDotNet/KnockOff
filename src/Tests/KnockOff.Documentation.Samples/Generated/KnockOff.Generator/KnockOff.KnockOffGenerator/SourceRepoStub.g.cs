...
partial class SourceRepoStub : global::KnockOff.Documentation.Samples.SourceDelegation.IRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetPriorityInterceptor
	{
		...
		{
			if (!times.Validate(CallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetPriority", times, CallCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("GetPriority", times, CallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("GetPriority", global::KnockOff.Times.AtLeastOnce, CallCount);
		}
