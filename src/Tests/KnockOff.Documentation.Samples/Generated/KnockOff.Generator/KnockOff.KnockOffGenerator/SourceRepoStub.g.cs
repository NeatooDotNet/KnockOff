...
partial class SourceRepoStub : global::KnockOff.Documentation.Samples.SourceDelegation.IRepository, global::KnockOff.IKnockOffStub
{
	...
	/// <summary>Tracks and configures behavior for GetPriority.</summary>
	public sealed class GetPriorityInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.SourceDelegation.IRepository? _source;
		...
		private global::System.Collections.Generic.List<(GetPriorityDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetPriority", times, TotalCallCount));
		}

		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.User> OnCall(GetPriorityDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.User> OnCall(int value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<GetPriorityDelegate> OnCallSequence(GetPriorityDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetPriorityDelegate Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		internal int Invoke(bool strict, global::KnockOff.Documentation.Samples.User user)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetPriority");
				return default!;
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) return src.GetPriority(user);
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "GetPriority");
			return default!;
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetPriority", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetPriority", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.User>
		{
			private readonly GetPriorityInterceptor _interceptor;

			public MethodTrackingImpl(GetPriorityInterceptor interceptor) => _interceptor = interceptor;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetPriorityDelegate>
		{
			private readonly GetPriorityInterceptor _interceptor;

			public MethodSequenceImpl(GetPriorityInterceptor interceptor) => _interceptor = interceptor;
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<GetPriorityDelegate> ThenCall(GetPriorityDelegate callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<GetPriorityDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>Interceptor for GetPriority.</summary>
	public GetPriorityInterceptor GetPriority { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Documentation.Samples.SourceDelegation.IRepository instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.SourceDelegation.IRepository Object => this;
	...
	public void Verify()
	{
		...
		if (GetPriority.CheckVerification() is { } getpriorityFailure) failures.Add(getpriorityFailure);
	...
	public void VerifyAll()
	{
		...
		if (GetPriority.CheckVerificationAll() is { } getpriorityFailure) failures.Add(getpriorityFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.SourceDelegation.IRepository).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.SourceDelegation.IRepository? source)
	{
		GetById._source = source;
		Save._source = source;
		GetPriority._source = source;
	}
