...
partial class GenericRepoStub<T> : global::KnockOff.Documentation.Samples.Guides.IGenericRepo<T>, global::KnockOff.IKnockOffStub where T : class
{
	...
	public sealed class GetByIdInterceptor
	{
		...
		internal T? Invoke(GenericRepoStub<T> ko, bool strict, int id)
		{
	...
	public sealed class SaveInterceptor
	{
		...
		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<T> OnCall(global::System.Action<GenericRepoStub<T>, T> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<GenericRepoStub<T>, T>> OnCall(global::System.Action<GenericRepoStub<T>, T> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(GenericRepoStub<T> ko, bool strict, T entity)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<GenericRepoStub<T>, T>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<GenericRepoStub<T>, T>> ThenCall(global::System.Action<GenericRepoStub<T>, T> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	public sealed class GetAllInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Collections.Generic.IEnumerable<T> Invoke(GenericRepoStub<T> ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
