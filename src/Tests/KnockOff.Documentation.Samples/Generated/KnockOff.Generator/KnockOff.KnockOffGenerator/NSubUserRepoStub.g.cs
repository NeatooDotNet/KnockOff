...
partial class NSubUserRepoStub : global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo, global::KnockOff.IKnockOffStub
{
	...
	public sealed class DeleteUserInterceptor
	{
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("DeleteUser", times, TotalCallCount));
		}
		...
		internal void Invoke(bool strict, int id)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("DeleteUser");
				return;
			}
			...
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "DeleteUser");
			return;
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("DeleteUser", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("DeleteUser", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<int>
		{
			private readonly DeleteUserInterceptor _interceptor;

			public MethodTrackingImpl(DeleteUserInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<int>>
		{
			...
			public MethodSequenceImpl(DeleteUserInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>Tracks and configures behavior for FindUsers.</summary>
	public sealed class FindUsersInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo? _source;

		/// <summary>Delegate for FindUsers.</summary>
		public delegate global::System.Collections.Generic.IEnumerable<global::KnockOff.Documentation.Samples.User> FindUsersDelegate(string name, int limit);
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("FindUsers", times, TotalCallCount));
		}

		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTrackingArgs<(string? name, int? limit)> OnCall(FindUsersDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<FindUsersDelegate> OnCallSequence(FindUsersDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Collections.Generic.IEnumerable<global::KnockOff.Documentation.Samples.User> Invoke(bool strict, string name, int limit)
		{
			if (_sequence != null && _sequenceIndex < _sequence.Count)
			{
				var (callback, tracking) = _sequence[_sequenceIndex];
			...
			if (_onCall != null && _onCallTracking != null)
			{
				_onCallTracking.RecordCall((name, limit));
				return _onCall(name, limit);
			}

			_unconfiguredCallCount++;
			_unconfiguredLastArgs = ((name, limit));
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("FindUsers");
				return new global::System.Collections.Generic.List<global::KnockOff.Documentation.Samples.User>();
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) return src.FindUsers(name, limit);
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "FindUsers");
			return new global::System.Collections.Generic.List<global::KnockOff.Documentation.Samples.User>();
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("FindUsers", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("FindUsers", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTrackingArgs<(string? name, int? limit)>
		{
			private readonly FindUsersInterceptor _interceptor;

			public MethodTrackingImpl(FindUsersInterceptor interceptor) => _interceptor = interceptor;

			private (string? name, int? limit) _lastArgs;

			internal int CallCount { get; private set; }

			/// <summary>Last arguments passed to this callback. Default if never called.</summary>
			public (string? name, int? limit) LastArgs => _lastArgs;

			/// <summary>Records a call to this callback.</summary>
			public void RecordCall((string? name, int? limit) args) { CallCount++; _lastArgs = args; }
			...
			/// <summary>Marks for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodTrackingArgs<(string? name, int? limit)> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
			...
			/// <summary>Marks for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodTrackingArgs<(string? name, int? limit)> Verifiable(global::KnockOff.Times times)
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = times;
				return this;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<FindUsersDelegate>
		{
			private readonly FindUsersInterceptor _interceptor;

			public MethodSequenceImpl(FindUsersInterceptor interceptor) => _interceptor = interceptor;
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<FindUsersDelegate> ThenCall(FindUsersDelegate callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<FindUsersDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>Interceptor for FindUsers.</summary>
	public FindUsersInterceptor FindUsers { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo Object => this;
	...
	public void Verify()
	{
		...
		if (DeleteUser.CheckVerification() is { } deleteuserFailure) failures.Add(deleteuserFailure);
		if (FindUsers.CheckVerification() is { } findusersFailure) failures.Add(findusersFailure);
	...
	public void VerifyAll()
	{
		...
		if (DeleteUser.CheckVerificationAll() is { } deleteuserFailure) failures.Add(deleteuserFailure);
		if (FindUsers.CheckVerificationAll() is { } findusersFailure) failures.Add(findusersFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo? source)
	{
		...
		FindUsers._source = source;
	}

	string global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo.ConnectionString
	{
		get => ConnectionString.InvokeGet(Strict);
		set => ConnectionString.InvokeSet(Strict, value);
	}

	bool global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo.IsConnected
	{
		get => IsConnected.InvokeGet(Strict);
	}

	global::KnockOff.Documentation.Samples.User? global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo.GetUser(int id)
	{
		return GetUser.Invoke(Strict, id);
	}

	global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.User?> global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo.GetUserAsync(int id)
	{
		return GetUserAsync.Invoke(Strict, id);
	}

	void global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo.SaveUser(global::KnockOff.Documentation.Samples.User user)
	{
		SaveUser.Invoke(Strict, user);
	}

	void global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo.DeleteUser(int id)
	{
		DeleteUser.Invoke(Strict, id);
	}

	global::System.Collections.Generic.IEnumerable<global::KnockOff.Documentation.Samples.User> global::KnockOff.Documentation.Samples.NSubstituteMigration.INSubUserRepo.FindUsers(string name, int limit)
	{
		return FindUsers.Invoke(Strict, name, limit);
	}
