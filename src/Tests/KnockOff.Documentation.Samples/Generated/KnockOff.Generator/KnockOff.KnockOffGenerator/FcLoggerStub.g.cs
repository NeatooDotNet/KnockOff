...
partial class FcLoggerStub : global::KnockOff.Documentation.Samples.Comparison.IFcLogger, global::KnockOff.IKnockOffStub
{
	...
	public sealed class LogInfoInterceptor
	{
		...
		public global::KnockOff.IMethodTracking<string> OnCall(global::System.Action<FcLoggerStub, string> callback)
		{
		...
		public global::KnockOff.IMethodSequence<global::System.Action<FcLoggerStub, string>> OnCall(global::System.Action<FcLoggerStub, string> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal void Invoke(FcLoggerStub ko, bool strict, string message)
		{
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<FcLoggerStub, string>>
		{
			...
			public global::KnockOff.IMethodSequence<global::System.Action<FcLoggerStub, string>> ThenCall(global::System.Action<FcLoggerStub, string> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
	...
	public sealed class LogErrorInterceptor
	{
		...
		public (string? message, global::System.Exception? exception)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }


		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTrackingArgs<(string? message, global::System.Exception? exception)> OnCall(global::System.Action<FcLoggerStub, string, global::System.Exception?> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<FcLoggerStub, string, global::System.Exception?>> OnCall(global::System.Action<FcLoggerStub, string, global::System.Exception?> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(FcLoggerStub ko, bool strict, string message, global::System.Exception? exception)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<FcLoggerStub, string, global::System.Exception?>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<FcLoggerStub, string, global::System.Exception?>> ThenCall(global::System.Action<FcLoggerStub, string, global::System.Exception?> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
