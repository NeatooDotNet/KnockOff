...
partial class IhAuditableEntityKnockOff : global::KnockOff.Documentation.Samples.Guides.IIhAuditableEntity, global::KnockOff.Documentation.Samples.Guides.IIhBaseEntity, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ModifiedAtInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Guides.IIhAuditableEntity? _source;
	...
	{
		/// <summary>Source object to delegate to when no OnGet/OnSet is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Guides.IIhBaseEntity? _source;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Guides.IIhAuditableEntity).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Guides.IIhAuditableEntity? source)
	{
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Guides.IIhBaseEntity).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Guides.IIhBaseEntity? source)
	{
	...
	{
		get { ModifiedAt.RecordGet(); if (ModifiedAt.OnGet is { } onGet) return onGet(this); if (ModifiedAt._source is { } src) return src.ModifiedAt; if (Strict) throw global::KnockOff.StubException.NotConfigured("IIhAuditableEntity", "ModifiedAt"); return ModifiedAt.Value; }
		set { ModifiedAt.RecordSet(value); if (ModifiedAt.OnSet is { } onSet) { onSet(this, value); return; } if (ModifiedAt._source is { } src) { src.ModifiedAt = value; return; } if (Strict) throw global::KnockOff.StubException.NotConfigured("IIhAuditableEntity", "ModifiedAt"); ModifiedAt.Value = value; }
	}

	string global::KnockOff.Documentation.Samples.Guides.IIhAuditableEntity.ModifiedBy
	{
		get { ModifiedBy.RecordGet(); if (ModifiedBy.OnGet is { } onGet) return onGet(this); if (ModifiedBy._source is { } src) return src.ModifiedBy; if (Strict) throw global::KnockOff.StubException.NotConfigured("IIhAuditableEntity", "ModifiedBy"); return ModifiedBy.Value; }
		set { ModifiedBy.RecordSet(value); if (ModifiedBy.OnSet is { } onSet) { onSet(this, value); return; } if (ModifiedBy._source is { } src) { src.ModifiedBy = value; return; } if (Strict) throw global::KnockOff.StubException.NotConfigured("IIhAuditableEntity", "ModifiedBy"); ModifiedBy.Value = value; }
	}

	int global::KnockOff.Documentation.Samples.Guides.IIhBaseEntity.Id
	{
		get { Id.RecordGet(); if (Id.OnGet is { } onGet) return onGet(this); if (Id._source is { } src) return src.Id; if (Strict) throw global::KnockOff.StubException.NotConfigured("IIhBaseEntity", "Id"); return Id.Value; }
	}

	global::System.DateTime global::KnockOff.Documentation.Samples.Guides.IIhBaseEntity.CreatedAt
	{
		get { CreatedAt.RecordGet(); if (CreatedAt.OnGet is { } onGet) return onGet(this); if (CreatedAt._source is { } src) return src.CreatedAt; if (Strict) throw global::KnockOff.StubException.NotConfigured("IIhBaseEntity", "CreatedAt"); return CreatedAt.Value; }
	}
