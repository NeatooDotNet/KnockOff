...
partial class GenLoggerKnockOff : global::KnockOff.Documentation.Samples.Reference.IGenLogger, global::KnockOff.IKnockOffStub
{
	...
	public sealed class LogInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Reference.IGenLogger? _source;
		...
		private (string? level, string? message, int? code)? _unconfiguredLastArgs;
		...
		public (string? level, string? message, int? code)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Reference.IGenLogger).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Reference.IGenLogger? source)
	{
		Log._source = source;
	}
