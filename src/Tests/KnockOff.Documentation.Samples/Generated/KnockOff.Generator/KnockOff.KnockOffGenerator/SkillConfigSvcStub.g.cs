...
partial class SkillConfigSvcStub : global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for GetValue.</summary>
	public sealed class GetValueInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc? _source;

		/// <summary>Delegate for GetValue.</summary>
		public delegate string GetValueDelegate(string key);
		...
		public global::KnockOff.IMethodTracking<string> OnCall(GetValueDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		internal string Invoke(bool strict, string key)
		{
			...
			if (_source is { } src) return src.GetValue(key);
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "GetValue");
			throw new global::System.InvalidOperationException("No implementation provided for GetValue. Configure via OnCall.");
		}
	...
	public sealed class SetValueInterceptor
	{
		...
		internal void Invoke(bool strict, string key, string @value)
		{
			...
			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) { src.SetValue(key, @value); return; }
			#pragma warning restore CS8601, SYSLIB0050
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc? source)
	{
		GetValue._source = source;
		SetValue._source = source;
	}

	string global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc.GetValue(string key)
	{
		return GetValue.Invoke(Strict, key);
	}

	void global::KnockOff.Documentation.Samples.Skill.ISkillConfigSvc.SetValue(string key, string @value)
	{
		SetValue.Invoke(Strict, key, @value);
	}
