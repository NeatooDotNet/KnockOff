...
partial class MmUserServiceKnockOff
{
	...
	public sealed class IMmUserService_SaveHandler
	{
		...
		private readonly global::System.Collections.Generic.List<global::KnockOff.Documentation.Samples.Skills.MmUser> _calls = new();
		...
		public global::KnockOff.Documentation.Samples.Skills.MmUser? LastCallArg => _calls.Count > 0 ? _calls[_calls.Count - 1] : null;

		/// <summary>All recorded calls with their arguments.</summary>
		public global::System.Collections.Generic.IReadOnlyList<global::KnockOff.Documentation.Samples.Skills.MmUser> AllCalls => _calls;

		/// <summary>Callback invoked when this method is called. If set, its return value is used.</summary>
		public SaveDelegate? OnCall { get; set; }

		/// <summary>Records a method call.</summary>
		public void RecordCall(global::KnockOff.Documentation.Samples.Skills.MmUser user) => _calls.Add(user);
