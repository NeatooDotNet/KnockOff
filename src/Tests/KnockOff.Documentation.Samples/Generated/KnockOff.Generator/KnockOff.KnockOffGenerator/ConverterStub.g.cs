...
partial class ConverterStub : global::KnockOff.Documentation.Samples.GenericMethods.IConverter, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ConvertInterceptor
	{
		...
		public ConvertTypedHandler<TSource, TTarget> Of<TSource, TTarget>()
		{
			var key = (typeof(TSource), typeof(TTarget));
			if (!_typedHandlers.TryGetValue(key, out var handler))
			{
				handler = new ConvertTypedHandler<TSource, TTarget>();
				_typedHandlers[key] = handler;
			}
			return (ConvertTypedHandler<TSource, TTarget>)handler;
		}
	...
	/// <summary>The global::KnockOff.Documentation.Samples.GenericMethods.IConverter instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.GenericMethods.IConverter Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.GenericMethods.IConverter).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.GenericMethods.IConverter? source)
	{
	}

	TTarget global::KnockOff.Documentation.Samples.GenericMethods.IConverter.Convert<TSource, TTarget>(TSource source)
	{
