...
partial class BpProcessorKnockOff : global::KnockOff.Documentation.Samples.Guides.IBpProcessor, global::KnockOff.IKnockOffStub
{
	...
	{
		private readonly global::System.Collections.Generic.List<(global::System.Action<BpProcessorKnockOff, string> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;

		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<string> OnCall(global::System.Action<BpProcessorKnockOff, string> callback)
		{
		...
		public global::KnockOff.IMethodSequence<global::System.Action<BpProcessorKnockOff, string>> OnCall(global::System.Action<BpProcessorKnockOff, string> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal void Invoke(BpProcessorKnockOff ko, bool strict, string data)
		{
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<BpProcessorKnockOff, string>>
		{
			...
			public global::KnockOff.IMethodSequence<global::System.Action<BpProcessorKnockOff, string>> ThenCall(global::System.Action<BpProcessorKnockOff, string> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
	...
	{
		private readonly global::System.Collections.Generic.List<(global::System.Action<BpProcessorKnockOff, string, int> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;

		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTrackingArgs<(string? data, int? priority)> OnCall(global::System.Action<BpProcessorKnockOff, string, int> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<BpProcessorKnockOff, string, int>> OnCall(global::System.Action<BpProcessorKnockOff, string, int> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(BpProcessorKnockOff ko, bool strict, string data, int priority)
		{
			if (_sequence.Count == 0)
			{
				if (strict) throw global::KnockOff.StubException.NotConfigured("", "Process");
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<BpProcessorKnockOff, string, int>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<BpProcessorKnockOff, string, int>> ThenCall(global::System.Action<BpProcessorKnockOff, string, int> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
