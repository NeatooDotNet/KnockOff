...
partial class ApiSerializerKnockOff : global::KnockOff.Documentation.Samples.Reference.IApiSerializer, global::KnockOff.IKnockOffStub
{
	...
	public sealed class DeserializeInterceptor
	{
		...
		public sealed class DeserializeTypedHandler<T> : IGenericMethodCallTracker, IResettable
		{
			...
			public delegate T DeserializeDelegate(ApiSerializerKnockOff ko, string json);
	...
	public sealed class ConvertInterceptor
	{
		...
		public sealed class ConvertTypedHandler<TIn, TOut> : IGenericMethodCallTracker, IResettable
		{
			...
			public delegate TOut ConvertDelegate(ApiSerializerKnockOff ko, TIn input);
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Reference.IApiSerializer instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Reference.IApiSerializer Object => this;
	...
	T global::KnockOff.Documentation.Samples.Reference.IApiSerializer.Deserialize<T>(string json)
	{
		...
		if (Strict) throw global::KnockOff.StubException.NotConfigured("IApiSerializer", "Deserialize");
		return SmartDefault<T>("Deserialize");
	}

	TOut global::KnockOff.Documentation.Samples.Reference.IApiSerializer.Convert<TIn, TOut>(TIn input)
	{
		Convert.Of<TIn, TOut>().RecordCall();
		if (Convert.Of<TIn, TOut>().OnCall is { } callback)
			return callback(this, input);
		if (Strict) throw global::KnockOff.StubException.NotConfigured("IApiSerializer", "Convert");
