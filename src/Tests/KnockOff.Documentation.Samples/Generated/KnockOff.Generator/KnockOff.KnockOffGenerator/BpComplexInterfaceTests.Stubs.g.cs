...
partial class BpComplexInterfaceTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IBpEditBase_AddRuleInterceptor
		{
			...
			public (string property, global::System.Func<bool> rule)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
