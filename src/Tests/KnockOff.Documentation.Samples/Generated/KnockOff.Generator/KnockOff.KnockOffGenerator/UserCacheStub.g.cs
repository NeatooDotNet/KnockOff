...
partial class UserCacheStub : global::KnockOff.Documentation.Samples.Indexers.IUserCache, global::KnockOff.IKnockOffStub
{
	...
	public sealed class IndexerInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Indexers.IUserCache? _source;
		...
		internal global::KnockOff.Documentation.Samples.User? InvokeGet(bool strict, int userId)
		{
			...
			{
				_onGetTracking.RecordCall(userId);
				return _onGet(userId);
			}

			_unconfiguredGetCount++;
			_unconfiguredLastGetKey = userId;
			...
			if (Backing.TryGetValue(userId, out var backingValue)) return backingValue;
		...
		internal void InvokeSet(bool strict, int userId, global::KnockOff.Documentation.Samples.User? value)
		{
			if (_setSequence != null && _setSequenceIndex < _setSequence.Count)
			{
				var (callback, tracking) = _setSequence[_setSequenceIndex];
				tracking.RecordCall(userId, value);
				_setSequenceIndex++;
			...
			{
				_onSetTracking.RecordCall(userId, value);
				_onSet(userId, value);
				return;
			}

			_unconfiguredSetCount++;
			_unconfiguredLastSetEntry = (userId, value);

			if (_setSequence != null && _setSequenceIndex >= _setSequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("Indexer (set)");
				Backing[userId] = value;
				return;
			}
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Indexers.IUserCache instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Indexers.IUserCache Object => this;

	// Source(T) methods for interface delegation

	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Indexers.IUserCache).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Indexers.IUserCache? source)
	{
		Indexer._source = source;
	}

	global::KnockOff.Documentation.Samples.User? global::KnockOff.Documentation.Samples.Indexers.IUserCache.this[int userId]
	{
		get => Indexer.InvokeGet(Strict, userId);
		set => Indexer.InvokeSet(Strict, userId, value);
	}
