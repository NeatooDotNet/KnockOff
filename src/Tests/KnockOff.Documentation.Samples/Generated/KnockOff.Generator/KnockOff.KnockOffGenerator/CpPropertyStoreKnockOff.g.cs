...
partial class CpPropertyStoreKnockOff : global::KnockOff.Documentation.Samples.Skills.ICpPropertyStore, global::KnockOff.IKnockOffStub
{
	...
	{
		get { Indexer.RecordGet(key); if (Indexer.OnGet is { } onGet) return onGet(this, key); if (Strict) throw global::KnockOff.StubException.NotConfigured("ICpPropertyStore", "this[]"); return Indexer.Backing.TryGetValue(key, out var v) ? v : default; }
		set { Indexer.RecordSet(key, value); if (Indexer.OnSet is { } onSet) { onSet(this, key, value); return; } if (Strict) throw global::KnockOff.StubException.NotConfigured("ICpPropertyStore", "this[]"); Indexer.Backing[key] = value; }
	}
