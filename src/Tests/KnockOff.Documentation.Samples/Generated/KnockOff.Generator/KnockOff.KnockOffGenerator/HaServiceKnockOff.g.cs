...
partial class HaServiceKnockOff : global::KnockOff.Documentation.Samples.Skills.IHaService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class CreateInterceptor
	{
		...
		public (string? name, int? @value)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
