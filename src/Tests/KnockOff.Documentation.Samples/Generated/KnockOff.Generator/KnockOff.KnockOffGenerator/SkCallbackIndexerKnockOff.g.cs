...
partial class SkCallbackIndexerKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkCallbackPropertyStore, global::KnockOff.IKnockOffStub
{
	...
	{
		get { Indexer.RecordGet(key); if (Indexer.OnGet is { } onGet) return onGet(this, key); if (Strict) throw global::KnockOff.StubException.NotConfigured("ISkCallbackPropertyStore", "this[]"); return Indexer.Backing.TryGetValue(key, out var v) ? v : default; }
		set { Indexer.RecordSet(key, value); if (Indexer.OnSet is { } onSet) { onSet(this, key, value); return; } if (Strict) throw global::KnockOff.StubException.NotConfigured("ISkCallbackPropertyStore", "this[]"); Indexer.Backing[key] = value; }
	}
