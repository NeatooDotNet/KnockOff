...
partial class GenStringCacheKnockOff : global::KnockOff.Documentation.Samples.Guides.IGenCache<string, global::KnockOff.Documentation.Samples.Guides.GenUser>, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SetInterceptor
	{
		...
		public (string? key, global::KnockOff.Documentation.Samples.Guides.GenUser? @value)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
