...
partial class ReadWriteConfigStub : global::KnockOff.Documentation.Samples.Troubleshooting.IReadWriteConfig, global::KnockOff.IKnockOffStub
{
	...
	public sealed class VersionInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Troubleshooting.IReadWriteConfig? _source;
		...
		internal void InvokeSet(bool strict, string value)
		{
			...
			if (_source is { } src) { src.Version = value; return; }
		...
		public VersionInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; _isSetVerifiable = true; _setVerifiableTimes = null; return this; }
		...
		public VersionInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; _isSetVerifiable = true; _setVerifiableTimes = times; return this; }
		...
		private sealed class PropertySetTrackingImpl : global::KnockOff.IPropertySetTracking<string>
		{
			...
			public PropertySetTrackingImpl(VersionInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertySetSequenceImpl : global::KnockOff.IPropertySetSequence<string>
		{
			...
			public PropertySetSequenceImpl(VersionInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Troubleshooting.IReadWriteConfig instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Troubleshooting.IReadWriteConfig Object => this;

	// Source(T) methods for interface delegation

	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Troubleshooting.IReadWriteConfig).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Troubleshooting.IReadWriteConfig? source)
	{
		Version._source = source;
	}

	string global::KnockOff.Documentation.Samples.Troubleshooting.IReadWriteConfig.Version
	{
		get => Version.InvokeGet(Strict);
		set => Version.InvokeSet(Strict, value);
	}
