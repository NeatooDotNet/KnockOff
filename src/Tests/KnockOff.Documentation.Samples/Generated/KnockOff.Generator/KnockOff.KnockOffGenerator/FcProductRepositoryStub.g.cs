...
partial class FcProductRepositoryStub : global::KnockOff.Documentation.Samples.Comparison.IFcProductRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveAsyncInterceptor
	{
		...
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		private global::KnockOff.Documentation.Samples.Comparison.FcProduct? _unconfiguredLastArg;
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Documentation.Samples.Comparison.FcProduct? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
