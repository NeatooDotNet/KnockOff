...
partial class DataServiceStub : global::KnockOff.Documentation.Samples.ReadMe.IDataService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class NameInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.ReadMe.IDataService? _source;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.ReadMe.IDataService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.ReadMe.IDataService? source)
	{
		Name._source = source;
	...
	{
		get { Name.RecordGet(); if (Name.OnGet is { } onGet) return onGet(this); if (Name._source is { } src) return src.Name; if (Strict) throw global::KnockOff.StubException.NotConfigured("IDataService", "Name"); return Name.Value; }
		set { Name.RecordSet(value); if (Name.OnSet is { } onSet) { onSet(this, value); return; } if (Name._source is { } src) { src.Name = value; return; } if (Strict) throw global::KnockOff.StubException.NotConfigured("IDataService", "Name"); Name.Value = value; }
	}
