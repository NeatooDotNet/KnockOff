...
partial class VfRepositoryStub : global::KnockOff.Documentation.Samples.Guides.IVfRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetByIdInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Guides.IVfRepository? _source;
		...
		internal global::KnockOff.Documentation.Samples.Guides.VfUser? Invoke(VfRepositoryStub ko, bool strict, int id)
		{
	...
	public sealed class SaveInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<VfRepositoryStub, global::KnockOff.Documentation.Samples.Guides.VfUser> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		private global::KnockOff.Documentation.Samples.Guides.VfUser? _unconfiguredLastArg;
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Documentation.Samples.Guides.VfUser? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }


		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.Guides.VfUser> OnCall(global::System.Action<VfRepositoryStub, global::KnockOff.Documentation.Samples.Guides.VfUser> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<VfRepositoryStub, global::KnockOff.Documentation.Samples.Guides.VfUser>> OnCall(global::System.Action<VfRepositoryStub, global::KnockOff.Documentation.Samples.Guides.VfUser> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(VfRepositoryStub ko, bool strict, global::KnockOff.Documentation.Samples.Guides.VfUser user)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
		...
		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.Guides.VfUser>
		{
			private global::KnockOff.Documentation.Samples.Guides.VfUser _lastArg = default!;
			...
			/// <summary>Last argument passed to this callback. Default if never called.</summary>
			public global::KnockOff.Documentation.Samples.Guides.VfUser LastArg => _lastArg;

			/// <summary>Records a call to this callback.</summary>
			public void RecordCall(global::KnockOff.Documentation.Samples.Guides.VfUser user) { CallCount++; _lastArg = user; }
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<VfRepositoryStub, global::KnockOff.Documentation.Samples.Guides.VfUser>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<VfRepositoryStub, global::KnockOff.Documentation.Samples.Guides.VfUser>> ThenCall(global::System.Action<VfRepositoryStub, global::KnockOff.Documentation.Samples.Guides.VfUser> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Guides.IVfRepository).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Guides.IVfRepository? source)
	{
