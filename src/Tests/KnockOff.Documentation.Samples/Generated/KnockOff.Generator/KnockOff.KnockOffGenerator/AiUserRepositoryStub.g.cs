...
partial class AiUserRepositoryStub : global::KnockOff.Documentation.Samples.IAiUserRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetByIdInterceptor
	{
		...
		public delegate global::KnockOff.Documentation.Samples.AiUser? GetByIdDelegate(AiUserRepositoryStub ko, int id);
		...
		internal global::KnockOff.Documentation.Samples.AiUser? Invoke(AiUserRepositoryStub ko, bool strict, int id)
		{
	...
	public sealed class SaveInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<AiUserRepositoryStub, global::KnockOff.Documentation.Samples.AiUser> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.AiUser> OnCall(global::System.Action<AiUserRepositoryStub, global::KnockOff.Documentation.Samples.AiUser> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<AiUserRepositoryStub, global::KnockOff.Documentation.Samples.AiUser>> OnCall(global::System.Action<AiUserRepositoryStub, global::KnockOff.Documentation.Samples.AiUser> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(AiUserRepositoryStub ko, bool strict, global::KnockOff.Documentation.Samples.AiUser user)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<AiUserRepositoryStub, global::KnockOff.Documentation.Samples.AiUser>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<AiUserRepositoryStub, global::KnockOff.Documentation.Samples.AiUser>> ThenCall(global::System.Action<AiUserRepositoryStub, global::KnockOff.Documentation.Samples.AiUser> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.IAiUserRepository).</summary>
