...
partial class SkDataServiceKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkDataService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetDescriptionInterceptor
	{
		...
		internal string? Invoke(SkDataServiceKnockOff ko, bool strict, int id)
		{
	...
	/// <summary>Tracks calls to GetCount (user-defined implementation).</summary>
	public sealed class GetCount2Interceptor : global::KnockOff.IMethodTracking
	{
