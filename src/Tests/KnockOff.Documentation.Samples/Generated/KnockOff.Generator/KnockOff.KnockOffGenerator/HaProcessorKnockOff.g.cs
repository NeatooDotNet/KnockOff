...
partial class HaProcessorKnockOff : global::KnockOff.Documentation.Samples.Skills.IHaProcessor, global::KnockOff.IKnockOffStub
{
	...
	public sealed class IncrementInterceptor
	{
		...
		internal void Invoke(HaProcessorKnockOff ko, bool strict, ref int @value)
		{
	...
	public sealed class TryUpdateInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal bool Invoke(HaProcessorKnockOff ko, bool strict, string key, ref string @value)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
