...
partial class OrderServiceStub : global::KnockOff.Documentation.Samples.AdvancedCallbacks.IOrderService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class PlaceOrderInterceptor
	{
		...
		private global::System.Collections.Generic.List<(PlaceOrderDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("PlaceOrder", times, TotalCallCount));
		}
		...
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.Order> OnCall(int value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<PlaceOrderDelegate> OnCallSequence(PlaceOrderDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(PlaceOrderDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal int Invoke(bool strict, global::KnockOff.Documentation.Samples.Order order)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("PlaceOrder");
				return default!;
			}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("PlaceOrder", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("PlaceOrder", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.Order>
		{
			...
			public MethodTrackingImpl(PlaceOrderInterceptor interceptor) => _interceptor = interceptor;
			...
			public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.Order> Verifiable()
			{
			...
			public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.Order> Verifiable(global::KnockOff.Times times)
			{
				_interceptor._isVerifiable = true;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<PlaceOrderDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<PlaceOrderDelegate> ThenCall(PlaceOrderDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<PlaceOrderDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public void Verify()
	{
		...
		if (PlaceOrder.CheckVerification() is { } placeorderFailure) failures.Add(placeorderFailure);
	...
	public void VerifyAll()
	{
		...
		if (PlaceOrder.CheckVerificationAll() is { } placeorderFailure) failures.Add(placeorderFailure);
