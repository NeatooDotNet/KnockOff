...
partial class SkillLoggerStub : global::KnockOff.Documentation.Samples.Skill.ISkillLogger, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for Log.</summary>
	public sealed class LogInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Skill.ISkillLogger? _source;
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<string>
		{
			...
			public MethodTrackingImpl(LogInterceptor interceptor) => _interceptor = interceptor;
	...
	public sealed class LogErrorInterceptor
	{
		...
		internal void Invoke(bool strict, string message)
		{
			...
			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) { src.LogError(message); return; }
			#pragma warning restore CS8601, SYSLIB0050
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Skill.ISkillLogger instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Skill.ISkillLogger Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skill.ISkillLogger).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skill.ISkillLogger? source)
	{
		Log._source = source;
		LogError._source = source;
	}

	void global::KnockOff.Documentation.Samples.Skill.ISkillLogger.Log(string message)
	{
		Log.Invoke(Strict, message);
	}

	void global::KnockOff.Documentation.Samples.Skill.ISkillLogger.LogError(string message)
	{
		LogError.Invoke(Strict, message);
	}
