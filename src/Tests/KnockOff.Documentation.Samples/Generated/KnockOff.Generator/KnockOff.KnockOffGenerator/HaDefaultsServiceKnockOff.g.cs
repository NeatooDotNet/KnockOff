...
partial class HaDefaultsServiceKnockOff : global::KnockOff.Documentation.Samples.Skills.IHaDefaultsService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetCountInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Skills.IHaDefaultsService? _source;
		...
		internal int Invoke(HaDefaultsServiceKnockOff ko, bool strict)
		{
	...
	public sealed class GetItemsInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Collections.Generic.List<string> Invoke(HaDefaultsServiceKnockOff ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	public sealed class GetIListInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Collections.Generic.IList<string> Invoke(HaDefaultsServiceKnockOff ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	public sealed class GetOptionalInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal string? Invoke(HaDefaultsServiceKnockOff ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	public sealed class GetDisposableInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.IDisposable Invoke(HaDefaultsServiceKnockOff ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.IHaDefaultsService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skills.IHaDefaultsService? source)
	{
