...
partial class ProductInventoryStub : global::KnockOff.Documentation.Samples.Indexers.IProductInventory, global::KnockOff.IKnockOffStub
{
	...
	public sealed class IndexerInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Indexers.IProductInventory? _source;
		...
		internal int InvokeGet(bool strict, string sku)
		{
			...
			{
				_onGetTracking.RecordCall(sku);
				return _onGet(sku);
			}

			_unconfiguredGetCount++;
			_unconfiguredLastGetKey = sku;
			...
			if (Backing.TryGetValue(sku, out var backingValue)) return backingValue;

			if (_source is { } src) return src[sku];
		...
		internal void InvokeSet(bool strict, string sku, int value)
		{
			...
			{
				_onSetTracking.RecordCall(sku, value);
				_onSet(sku, value);
				return;
			}

			_unconfiguredSetCount++;
			_unconfiguredLastSetEntry = (sku, value);
			...
			if (_source is { } src) { src[sku] = value; return; }
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Indexers.IProductInventory instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Indexers.IProductInventory Object => this;

	// Source(T) methods for interface delegation

	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Indexers.IProductInventory).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Indexers.IProductInventory? source)
	{
		Indexer._source = source;
	}

	int global::KnockOff.Documentation.Samples.Indexers.IProductInventory.this[string sku]
	{
		get => Indexer.InvokeGet(Strict, sku);
		set => Indexer.InvokeSet(Strict, sku, value);
	}
