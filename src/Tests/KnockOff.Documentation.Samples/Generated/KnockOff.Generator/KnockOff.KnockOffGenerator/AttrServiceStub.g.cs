...
partial class AttrServiceStub : global::KnockOff.Documentation.Samples.Reference.IAttrService, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for DoWork.</summary>
	public sealed class DoWorkInterceptor
	{
		private readonly global::System.Collections.Generic.List<(global::System.Action<AttrServiceStub> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;

		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking OnCall(global::System.Action<AttrServiceStub> callback)
		{
		...
		public global::KnockOff.IMethodSequence<global::System.Action<AttrServiceStub>> OnCall(global::System.Action<AttrServiceStub> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal void Invoke(AttrServiceStub ko, bool strict)
		{
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<AttrServiceStub>>
		{
			...
			public global::KnockOff.IMethodSequence<global::System.Action<AttrServiceStub>> ThenCall(global::System.Action<AttrServiceStub> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
