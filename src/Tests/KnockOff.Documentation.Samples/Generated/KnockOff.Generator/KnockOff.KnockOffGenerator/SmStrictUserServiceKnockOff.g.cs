...
partial class SmStrictUserServiceKnockOff : global::KnockOff.Documentation.Samples.Skills.ISmUserService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetUserInterceptor
	{
		...
		public delegate global::KnockOff.Documentation.Samples.SampleDomain.User GetUserDelegate(SmStrictUserServiceKnockOff ko, int id);
		...
		internal global::KnockOff.Documentation.Samples.SampleDomain.User Invoke(SmStrictUserServiceKnockOff ko, bool strict, int id)
		{
	...
	public sealed class DeleteUserInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<SmStrictUserServiceKnockOff, int> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		private int? _unconfiguredLastArg;
		...
		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<int> OnCall(global::System.Action<SmStrictUserServiceKnockOff, int> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<SmStrictUserServiceKnockOff, int>> OnCall(global::System.Action<SmStrictUserServiceKnockOff, int> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(SmStrictUserServiceKnockOff ko, bool strict, int id)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<SmStrictUserServiceKnockOff, int>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<SmStrictUserServiceKnockOff, int>> ThenCall(global::System.Action<SmStrictUserServiceKnockOff, int> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.ISmUserService).</summary>
	...
	{
		DeleteUser.Invoke(this, Strict, id);
	}
