...
partial class FcPaymentServiceStub : global::KnockOff.Documentation.Samples.Comparison.IFcPaymentService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ProcessPaymentInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Comparison.IFcPaymentService? _source;
		...
		private (int? customerId, decimal? amount)? _unconfiguredLastArgs;
		...
		public (int? customerId, decimal? amount)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Comparison.IFcPaymentService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Comparison.IFcPaymentService? source)
	{
		ProcessPayment._source = source;
	}
