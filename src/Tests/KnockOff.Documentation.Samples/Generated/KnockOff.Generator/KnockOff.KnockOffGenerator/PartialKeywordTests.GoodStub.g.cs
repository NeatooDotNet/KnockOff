...
public partial class PartialKeywordTests
{
partial class GoodStub : global::KnockOff.Documentation.Samples.Troubleshooting.ITroubleshootRepo, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetByIdInterceptor
	{
		...
		public delegate global::KnockOff.Documentation.Samples.User? GetByIdDelegate(GoodStub ko, int id);
		...
		internal global::KnockOff.Documentation.Samples.User? Invoke(GoodStub ko, bool strict, int id)
		{
	...
	public sealed class GetByIdAsyncInterceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.User?> GetByIdAsyncDelegate(GoodStub ko, int id);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.User?> Invoke(GoodStub ko, bool strict, int id)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	public sealed class GetNameInterceptor
	{
		...
		public delegate string GetNameDelegate(GoodStub ko);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal string Invoke(GoodStub ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
