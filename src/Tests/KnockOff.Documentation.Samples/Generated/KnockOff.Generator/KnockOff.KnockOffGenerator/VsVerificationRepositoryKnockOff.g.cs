...
partial class VsVerificationRepositoryKnockOff : global::KnockOff.Documentation.Samples.Comparison.IVsVerificationRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Comparison.IVsVerificationRepository? _source;
		...
		private global::KnockOff.Documentation.Samples.Comparison.VsEntity? _unconfiguredLastArg;
		...
		public global::KnockOff.Documentation.Samples.Comparison.VsEntity? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
	...
	public sealed class UpdateInterceptor
	{
		...
		internal void Invoke(VsVerificationRepositoryKnockOff ko, bool strict, global::KnockOff.Documentation.Samples.Comparison.VsEntity entity)
		{
			if (_sequence.Count == 0)
			{
				...
				_unconfiguredLastArg = entity;
				#pragma warning disable CS8601, SYSLIB0050
				if (_source is { } src) { src.Update(entity); return; }
				#pragma warning restore CS8601, SYSLIB0050
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Comparison.IVsVerificationRepository).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Comparison.IVsVerificationRepository? source)
	{
		Save._source = source;
