...
partial class LogSvcMethodsStub : global::KnockOff.Documentation.Samples.Methods.ILogSvcMethods, global::KnockOff.IKnockOffStub
{
	...
	public sealed class LogMessageInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<LogSvcMethodsStub, string> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public global::KnockOff.IMethodSequence<global::System.Action<LogSvcMethodsStub, string>> OnCall(global::System.Action<LogSvcMethodsStub, string> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal void Invoke(LogSvcMethodsStub ko, bool strict, string message)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("LogMessage");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<LogSvcMethodsStub, string>>
		{
			...
			public global::KnockOff.IMethodSequence<global::System.Action<LogSvcMethodsStub, string>> ThenCall(global::System.Action<LogSvcMethodsStub, string> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
	...
	public sealed class GetUserNameInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(GetUserNameDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<GetUserNameDelegate> OnCall(GetUserNameDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		internal string Invoke(LogSvcMethodsStub ko, bool strict, int userId)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("GetUserName");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetUserNameDelegate>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<GetUserNameDelegate> ThenCall(GetUserNameDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	{
		var result = true;
		result &= LogMessage.Verify();
		result &= GetUserName.Verify();
		return result;
	}
