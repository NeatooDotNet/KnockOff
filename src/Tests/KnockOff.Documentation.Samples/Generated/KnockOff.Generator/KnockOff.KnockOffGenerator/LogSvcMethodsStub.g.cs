...
partial class LogSvcMethodsStub : global::KnockOff.Documentation.Samples.Methods.ILogSvcMethods, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for LogMessage.</summary>
	public sealed class LogMessageInterceptor
	{
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("LogMessage", times, TotalCallCount));
		}
		...
		internal void Invoke(bool strict, string message)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("LogMessage");
				return;
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) { src.LogMessage(message); return; }
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "LogMessage");
			return;
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("LogMessage", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("LogMessage", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<string>
		{
			...
			public MethodTrackingImpl(LogMessageInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<string>>
		{
			...
			public MethodSequenceImpl(LogMessageInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>Tracks and configures behavior for GetUserName.</summary>
	public sealed class GetUserNameInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Methods.ILogSvcMethods? _source;
		...
		private global::System.Collections.Generic.List<(GetUserNameDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetUserName", times, TotalCallCount));
		}

		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking<int> OnCall(GetUserNameDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<GetUserNameDelegate> OnCallSequence(GetUserNameDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetUserNameDelegate Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		internal string Invoke(bool strict, int userId)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetUserName");
				return default!;
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) return src.GetUserName(userId);
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "GetUserName");
			throw new global::System.InvalidOperationException("No implementation provided for GetUserName. Configure via OnCall.");
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetUserName", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetUserName", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<int>
		{
			private readonly GetUserNameInterceptor _interceptor;

			public MethodTrackingImpl(GetUserNameInterceptor interceptor) => _interceptor = interceptor;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetUserNameDelegate>
		{
			private readonly GetUserNameInterceptor _interceptor;

			public MethodSequenceImpl(GetUserNameInterceptor interceptor) => _interceptor = interceptor;
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<GetUserNameDelegate> ThenCall(GetUserNameDelegate callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<GetUserNameDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>Interceptor for LogMessage.</summary>
	public LogMessageInterceptor LogMessage { get; } = new();

	/// <summary>Interceptor for GetUserName.</summary>
	public GetUserNameInterceptor GetUserName { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Documentation.Samples.Methods.ILogSvcMethods instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Methods.ILogSvcMethods Object => this;
	...
	public void Verify()
	{
		...
		if (LogMessage.CheckVerification() is { } logmessageFailure) failures.Add(logmessageFailure);
		if (GetUserName.CheckVerification() is { } getusernameFailure) failures.Add(getusernameFailure);
	...
	public void VerifyAll()
	{
		...
		if (LogMessage.CheckVerificationAll() is { } logmessageFailure) failures.Add(logmessageFailure);
		if (GetUserName.CheckVerificationAll() is { } getusernameFailure) failures.Add(getusernameFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Methods.ILogSvcMethods).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Methods.ILogSvcMethods? source)
	{
		LogMessage._source = source;
		GetUserName._source = source;
	}
