...
partial class ApiAsyncRepositoryKnockOff : global::KnockOff.Documentation.Samples.Reference.IApiAsyncRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveAsyncInterceptor
	{
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Documentation.Samples.Reference.ApiEntity? LastCallArg { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
