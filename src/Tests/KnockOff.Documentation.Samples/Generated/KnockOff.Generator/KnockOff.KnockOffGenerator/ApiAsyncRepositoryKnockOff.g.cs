...
partial class ApiAsyncRepositoryKnockOff : global::KnockOff.Documentation.Samples.Reference.IApiAsyncRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveAsyncInterceptor
	{
		...
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		private global::KnockOff.Documentation.Samples.Reference.ApiEntity? _unconfiguredLastArg;
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Documentation.Samples.Reference.ApiEntity? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
