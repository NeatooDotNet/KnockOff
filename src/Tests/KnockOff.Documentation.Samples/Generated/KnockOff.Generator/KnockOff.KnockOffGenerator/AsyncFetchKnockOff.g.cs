...
partial class AsyncFetchKnockOff : global::KnockOff.Documentation.Samples.Guides.IAsyncFetch, global::KnockOff.IKnockOffStub
{
	...
	public sealed class FetchAsyncInterceptor
	{
		...
		public (int? id, global::System.Threading.CancellationToken? ct)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
