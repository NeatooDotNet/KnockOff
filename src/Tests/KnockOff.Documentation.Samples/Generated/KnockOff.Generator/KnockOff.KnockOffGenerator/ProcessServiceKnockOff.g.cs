...
partial class ProcessServiceKnockOff : global::KnockOff.Documentation.Samples.GettingStarted.IProcessService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ProcessInterceptor
	{
		...
		public delegate void ProcessDelegate_String_void(ProcessServiceKnockOff ko, string data);
		...
		public delegate void ProcessDelegate_String_Int32_void(ProcessServiceKnockOff ko, string data, int priority);
		...
		public delegate void ProcessDelegate_String_Int32_Boolean_void(ProcessServiceKnockOff ko, string data, int priority, bool async);
		...
		internal void Invoke_String_void(ProcessServiceKnockOff ko, bool strict, string data)
		{
		...
		internal void Invoke_String_Int32_void(ProcessServiceKnockOff ko, bool strict, string data, int priority)
		{
		...
		internal void Invoke_String_Int32_Boolean_void(ProcessServiceKnockOff ko, bool strict, string data, int priority, bool async)
		{
