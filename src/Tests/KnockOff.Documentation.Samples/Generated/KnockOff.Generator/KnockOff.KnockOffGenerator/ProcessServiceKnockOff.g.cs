...
partial class ProcessServiceKnockOff
{
	...
	/// <summary>Returns this instance as KnockOff.Documentation.Samples.GettingStarted.IProcessService.</summary>
	public KnockOff.Documentation.Samples.GettingStarted.IProcessService AsProcessService() => this;

	void KnockOff.Documentation.Samples.GettingStarted.IProcessService.Process(string data)
	{
		Process1.RecordCall(data);
		Process1.OnCall?.Invoke(this, data);
	}

	void KnockOff.Documentation.Samples.GettingStarted.IProcessService.Process(string data, int priority)
	{
		Process2.RecordCall(data, priority);
		Process2.OnCall?.Invoke(this, data, priority);
	}

	void KnockOff.Documentation.Samples.GettingStarted.IProcessService.Process(string data, int priority, bool async)
	{
