...
partial class ApiMethodRepoStub : global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for GetById.</summary>
	public sealed class GetByIdInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo? _source;

		/// <summary>Delegate for GetById.</summary>
		public delegate global::KnockOff.Documentation.Samples.User? GetByIdDelegate(ApiMethodRepoStub ko, int id);
		...
		internal global::KnockOff.Documentation.Samples.User? Invoke(ApiMethodRepoStub ko, bool strict, int id)
		{
	...
	public sealed class SaveInterceptor
	{
		...
		private global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User>? _onCall;
		private MethodTrackingImpl? _onCallTracking;

		private global::System.Collections.Generic.List<(global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User> Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.User> OnCall(global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User> callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User>> OnCallSequence(global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User> callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User> Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(ApiMethodRepoStub ko, bool strict, global::KnockOff.Documentation.Samples.User user)
		{
			if (_sequence != null && _sequenceIndex < _sequence.Count)
			{
				var (callback, tracking) = _sequence[_sequenceIndex];
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User>>
		{
			private readonly SaveInterceptor _interceptor;
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User>> ThenCall(global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User> callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, global::KnockOff.Documentation.Samples.User>> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public sealed class UpdateInterceptor
	{
		...
		private global::System.Action<ApiMethodRepoStub, int, string>? _onCall;
		private MethodTrackingImpl? _onCallTracking;

		private global::System.Collections.Generic.List<(global::System.Action<ApiMethodRepoStub, int, string> Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTrackingArgs<(int? id, string? name)> OnCall(global::System.Action<ApiMethodRepoStub, int, string> callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, int, string>> OnCallSequence(global::System.Action<ApiMethodRepoStub, int, string> callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(global::System.Action<ApiMethodRepoStub, int, string> Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(ApiMethodRepoStub ko, bool strict, int id, string name)
		{
			if (_sequence != null && _sequenceIndex < _sequence.Count)
			{
				var (callback, tracking) = _sequence[_sequenceIndex];
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, int, string>>
		{
			private readonly UpdateInterceptor _interceptor;
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, int, string>> ThenCall(global::System.Action<ApiMethodRepoStub, int, string> callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<ApiMethodRepoStub, int, string>> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>The global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo? source)
	{
	...
	global::KnockOff.Documentation.Samples.User? global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo.GetById(int id)
	{
		return GetById.Invoke(this, Strict, id);
	}

	void global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo.Save(global::KnockOff.Documentation.Samples.User user)
	{
		Save.Invoke(this, Strict, user);
	}

	void global::KnockOff.Documentation.Samples.InterceptorApi.IApiMethodRepo.Update(int id, string name)
	{
