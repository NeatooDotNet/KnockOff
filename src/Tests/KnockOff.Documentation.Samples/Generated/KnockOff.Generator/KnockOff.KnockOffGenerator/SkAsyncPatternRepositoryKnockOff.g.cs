...
partial class SkAsyncPatternRepositoryKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkAsyncPatternRepository, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetUserAsyncInterceptor
	{
		...
		internal global::System.Threading.Tasks.Task<global::KnockOff.Documentation.Samples.Skills.SkUser?> Invoke(SkAsyncPatternRepositoryKnockOff ko, bool strict, int id)
		{
	...
	public sealed class SaveAsyncInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task<int> Invoke(SkAsyncPatternRepositoryKnockOff ko, bool strict, object entity)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
