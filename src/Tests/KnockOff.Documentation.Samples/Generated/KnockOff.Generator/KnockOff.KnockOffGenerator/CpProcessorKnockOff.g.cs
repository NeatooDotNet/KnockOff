...
partial class CpProcessorKnockOff : global::KnockOff.Documentation.Samples.Skills.ICpProcessor, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for Increment.</summary>
	public sealed class IncrementInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Skills.ICpProcessor? _source;
		...
		internal void Invoke(CpProcessorKnockOff ko, bool strict, ref int @value)
		{
	...
	public sealed class TryUpdateInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal bool Invoke(CpProcessorKnockOff ko, bool strict, string key, ref string @value)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.ICpProcessor).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skills.ICpProcessor? source)
	{
