...
partial class UserRepositoryStub : global::KnockOff.Documentation.Samples.ReadMe.IUserRepository, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for GetById.</summary>
	public sealed class GetByIdInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.ReadMe.IUserRepository? _source;

		/// <summary>Delegate for GetById.</summary>
		public delegate global::KnockOff.Documentation.Samples.ReadMe.RmUser? GetByIdDelegate(UserRepositoryStub ko, int id);
		...
		internal global::KnockOff.Documentation.Samples.ReadMe.RmUser? Invoke(UserRepositoryStub ko, bool strict, int id)
		{
	...
	public sealed class SaveInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<UserRepositoryStub, global::KnockOff.Documentation.Samples.ReadMe.RmUser> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		private global::KnockOff.Documentation.Samples.ReadMe.RmUser? _unconfiguredLastArg;
		...
		/// <summary>The argument from the last call (from most recently called registration).</summary>
		public global::KnockOff.Documentation.Samples.ReadMe.RmUser? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }


		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.ReadMe.RmUser> OnCall(global::System.Action<UserRepositoryStub, global::KnockOff.Documentation.Samples.ReadMe.RmUser> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<UserRepositoryStub, global::KnockOff.Documentation.Samples.ReadMe.RmUser>> OnCall(global::System.Action<UserRepositoryStub, global::KnockOff.Documentation.Samples.ReadMe.RmUser> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(UserRepositoryStub ko, bool strict, global::KnockOff.Documentation.Samples.ReadMe.RmUser user)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
		...
		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.ReadMe.RmUser>
		{
			private global::KnockOff.Documentation.Samples.ReadMe.RmUser _lastArg = default!;
			...
			/// <summary>Last argument passed to this callback. Default if never called.</summary>
			public global::KnockOff.Documentation.Samples.ReadMe.RmUser LastArg => _lastArg;

			/// <summary>Records a call to this callback.</summary>
			public void RecordCall(global::KnockOff.Documentation.Samples.ReadMe.RmUser user) { CallCount++; _lastArg = user; }
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<UserRepositoryStub, global::KnockOff.Documentation.Samples.ReadMe.RmUser>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<UserRepositoryStub, global::KnockOff.Documentation.Samples.ReadMe.RmUser>> ThenCall(global::System.Action<UserRepositoryStub, global::KnockOff.Documentation.Samples.ReadMe.RmUser> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	/// <summary>The global::KnockOff.Documentation.Samples.ReadMe.IUserRepository instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.ReadMe.IUserRepository Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.ReadMe.IUserRepository).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.ReadMe.IUserRepository? source)
	{
		GetById._source = source;
		Save._source = source;
	}

	global::KnockOff.Documentation.Samples.ReadMe.RmUser? global::KnockOff.Documentation.Samples.ReadMe.IUserRepository.GetById(int id)
	{
		return GetById.Invoke(this, Strict, id);
	}

	void global::KnockOff.Documentation.Samples.ReadMe.IUserRepository.Save(global::KnockOff.Documentation.Samples.ReadMe.RmUser user)
	{
