...
partial class CpCallbackServiceKnockOff : global::KnockOff.Documentation.Samples.Skills.ICpCallbackService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class InitializeInterceptor
	{
		...
		internal global::KnockOff.Documentation.Samples.Skills.ICpCallbackService? _source;
	...
	public sealed class SearchInterceptor
	{
		...
		public (string? query, int? limit, int? offset)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.ICpCallbackService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skills.ICpCallbackService? source)
	{
