...
partial class VsEmployeeRepoKnockOff : global::KnockOff.Documentation.Samples.Comparison.IVsEmployeeRepository, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for GetEmployee.</summary>
	public sealed class GetEmployeeInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Comparison.IVsEmployeeRepository? _source;
		...
		private readonly global::System.Collections.Generic.List<(GetEmployeeDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public global::KnockOff.IMethodTracking<int> OnCall(GetEmployeeDelegate callback)
		{
		...
		public global::KnockOff.IMethodSequence<GetEmployeeDelegate> OnCall(GetEmployeeDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal global::KnockOff.Documentation.Samples.Comparison.VsUser? Invoke(VsEmployeeRepoKnockOff ko, bool strict, int id)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("GetEmployee");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetEmployeeDelegate>
		{
			private readonly GetEmployeeInterceptor _interceptor;

			public MethodSequenceImpl(GetEmployeeInterceptor interceptor) => _interceptor = interceptor;
			...
			public global::KnockOff.IMethodSequence<GetEmployeeDelegate> ThenCall(GetEmployeeDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Comparison.IVsEmployeeRepository).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Comparison.IVsEmployeeRepository? source)
	{
		GetEmployee._source = source;
	}
	...
	{
		return GetEmployee.Invoke(this, Strict, id);
	}
