...
partial class EmailServiceStub : global::KnockOff.Documentation.Samples.AdvancedCallbacks.IEmailService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SendInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(SendDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public (string? to, string? message)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
		...
		public global::KnockOff.IMethodSequence<SendDelegate> OnCall(SendDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<SendDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<SendDelegate> ThenCall(SendDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
