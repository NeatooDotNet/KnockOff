...
partial class InlineStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IEmailSvc_IsConfiguredInterceptor
		{
			...
			public IEmailSvc_IsConfiguredInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
			...
			public IEmailSvc_IsConfiguredInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			{
				private readonly IEmailSvc_IsConfiguredInterceptor _interceptor;

				public PropertyGetTrackingImpl(IEmailSvc_IsConfiguredInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<bool>
			{
				...
				public PropertyGetSequenceImpl(IEmailSvc_IsConfiguredInterceptor interceptor) => _interceptor = interceptor;
