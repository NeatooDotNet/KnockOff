...
partial class SkRefProcessorKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkRefProcessor, global::KnockOff.IKnockOffStub
{
	...
	void global::KnockOff.Documentation.Samples.Skills.ISkRefProcessor.Increment(ref int @value)
	{
		...
		if (Strict) throw global::KnockOff.StubException.NotConfigured("ISkRefProcessor", "Increment");
	}
	...
	bool global::KnockOff.Documentation.Samples.Skills.ISkRefProcessor.TryUpdate(string key, ref string @value)
	{
		...
		if (Strict) throw global::KnockOff.StubException.NotConfigured("ISkRefProcessor", "TryUpdate");
		return default!;
	}
