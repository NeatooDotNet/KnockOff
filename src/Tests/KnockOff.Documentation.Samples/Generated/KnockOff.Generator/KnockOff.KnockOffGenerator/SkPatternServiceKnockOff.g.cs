...
partial class SkPatternServiceKnockOff : global::KnockOff.Documentation.Samples.Skills.ISkPatternService, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for GetUser.</summary>
	public sealed class GetUserInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Skills.ISkPatternService? _source;
		...
		internal global::KnockOff.Documentation.Samples.Skills.SkUser? Invoke(SkPatternServiceKnockOff ko, bool strict, int id)
		{
	...
	public sealed class ConnectInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<SkPatternServiceKnockOff> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking OnCall(global::System.Action<SkPatternServiceKnockOff> callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<SkPatternServiceKnockOff>> OnCall(global::System.Action<SkPatternServiceKnockOff> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(SkPatternServiceKnockOff ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<SkPatternServiceKnockOff>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<SkPatternServiceKnockOff>> ThenCall(global::System.Action<SkPatternServiceKnockOff> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	public sealed class SaveAsyncInterceptor
	{
		...
		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking<object> OnCall(SaveAsyncDelegate callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task<int> Invoke(SkPatternServiceKnockOff ko, bool strict, object entity)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
	...
	public sealed class GetNextInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(GetNextDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
		public global::KnockOff.IMethodTracking OnCall(GetNextDelegate callback)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<GetNextDelegate> OnCall(GetNextDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal int Invoke(SkPatternServiceKnockOff ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("GetNext");
			}
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetNextDelegate>
		{
			private readonly GetNextInterceptor _interceptor;

			public MethodSequenceImpl(GetNextInterceptor interceptor) => _interceptor = interceptor;
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<GetNextDelegate> ThenCall(GetNextDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.ISkPatternService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skills.ISkPatternService? source)
	{
	...
	{
		return GetNext.Invoke(this, Strict);
	}
