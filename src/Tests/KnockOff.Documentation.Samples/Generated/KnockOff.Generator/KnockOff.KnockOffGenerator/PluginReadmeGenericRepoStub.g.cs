...
partial class PluginReadmeGenericRepoStub : global::KnockOff.Documentation.Samples.Readme.IPluginReadmeGenericRepo, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetByIdInterceptor
	{
		...
		public GetByIdTypedHandler<T> Of<T>() where T : class, new()
		{
			var key = typeof(T);
	...
	/// <summary>The global::KnockOff.Documentation.Samples.Readme.IPluginReadmeGenericRepo instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Readme.IPluginReadmeGenericRepo Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Readme.IPluginReadmeGenericRepo).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Readme.IPluginReadmeGenericRepo? source)
	{
	}

	T? global::KnockOff.Documentation.Samples.Readme.IPluginReadmeGenericRepo.GetById<T>(int id) where T : class
	{
		GetById.Of<T>().RecordCall(id);
		if (GetById.Of<T>().Callback is { } callback)
			return callback(id);
		if (Strict) throw global::KnockOff.StubException.NotConfigured("IPluginReadmeGenericRepo", "GetById");
		return default!;
	}
