...
partial class HaParserKnockOff : global::KnockOff.Documentation.Samples.Skills.IHaParser, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for TryParse.</summary>
	public sealed class TryParseInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Skills.IHaParser? _source;
		...
		internal bool Invoke(HaParserKnockOff ko, bool strict, string input, out int result)
		{
			result = default!;
	...
	public sealed class GetDataInterceptor
	{
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal void Invoke(HaParserKnockOff ko, bool strict, out string name, out int count)
		{
			name = default!;
			count = default!;
			if (_sequence.Count == 0)
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Skills.IHaParser).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Skills.IHaParser? source)
	{
