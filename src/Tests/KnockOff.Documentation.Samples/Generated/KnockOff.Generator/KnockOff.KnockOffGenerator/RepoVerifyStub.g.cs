...
partial class RepoVerifyStub : global::KnockOff.Documentation.Samples.Verification.IRepoVerify, global::KnockOff.IKnockOffStub
{
	...
	public sealed class RefreshInterceptor
	{
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Refresh", times, TotalCallCount));
		}
		...
		internal void Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("Refresh");
				return;
			}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Refresh", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Refresh", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(RefreshInterceptor interceptor) => _interceptor = interceptor;
	...
	public void Verify()
	{
		...
		if (Refresh.CheckVerification() is { } refreshFailure) failures.Add(refreshFailure);
	...
	public void VerifyAll()
	{
		...
		if (Refresh.CheckVerificationAll() is { } refreshFailure) failures.Add(refreshFailure);
