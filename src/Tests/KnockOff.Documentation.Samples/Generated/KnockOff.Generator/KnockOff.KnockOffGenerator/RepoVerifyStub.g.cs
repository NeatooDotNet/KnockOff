...
partial class RepoVerifyStub : global::KnockOff.Documentation.Samples.Verification.IRepoVerify, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<RepoVerifyStub, global::KnockOff.Documentation.Samples.User> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<RepoVerifyStub, global::KnockOff.Documentation.Samples.User>> OnCall(global::System.Action<RepoVerifyStub, global::KnockOff.Documentation.Samples.User> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<RepoVerifyStub, global::KnockOff.Documentation.Samples.User>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<RepoVerifyStub, global::KnockOff.Documentation.Samples.User>> ThenCall(global::System.Action<RepoVerifyStub, global::KnockOff.Documentation.Samples.User> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	/// <summary>Tracks and configures behavior for Refresh.</summary>
	public sealed class RefreshInterceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Documentation.Samples.Verification.IRepoVerify? _source;

		private readonly global::System.Collections.Generic.List<(global::System.Action<RepoVerifyStub> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<RepoVerifyStub>> OnCall(global::System.Action<RepoVerifyStub> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		internal void Invoke(RepoVerifyStub ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				_unconfiguredCallCount++;
				#pragma warning disable CS8601, SYSLIB0050
				if (_source is { } src) { src.Refresh(); return; }
				#pragma warning restore CS8601, SYSLIB0050
				if (strict) throw global::KnockOff.StubException.NotConfigured("", "Refresh");
				return;
			}
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("Refresh");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<RepoVerifyStub>>
		{
			...
			public MethodSequenceImpl(RefreshInterceptor interceptor) => _interceptor = interceptor;
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<RepoVerifyStub>> ThenCall(global::System.Action<RepoVerifyStub> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
	...
	/// <summary>Interceptor for Refresh.</summary>
	public RefreshInterceptor Refresh { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Documentation.Samples.Verification.IRepoVerify instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Verification.IRepoVerify Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Verification.IRepoVerify).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Verification.IRepoVerify? source)
	{
		GetById._source = source;
		Save._source = source;
		Refresh._source = source;
	}
