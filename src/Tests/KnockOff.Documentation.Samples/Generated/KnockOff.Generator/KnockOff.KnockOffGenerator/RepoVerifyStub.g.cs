...
partial class RepoVerifyStub : global::KnockOff.Documentation.Samples.Verification.IRepoVerify, global::KnockOff.IKnockOffStub
{
	...
	public sealed class RefreshInterceptor
	{
		...
		{
			if (!times.Validate(CallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Refresh", times, CallCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("Refresh", times, CallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("Refresh", global::KnockOff.Times.AtLeastOnce, CallCount);
		}
