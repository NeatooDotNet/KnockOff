...
partial class SmInlineTests
{
	...
	public static class Stubs
	{
		...
		public sealed class ISmUserService_GetUserInterceptor
		{
			...
			internal global::KnockOff.Documentation.Samples.SampleDomain.User Invoke(Stubs.ISmUserService ko, int id)
			{
			...
			{
				private readonly ISmUserService_GetUserInterceptor _interceptor;

				public MethodSequenceImpl(ISmUserService_GetUserInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class ISmUserService_DeleteUserInterceptor
		{
			...
			/// <summary>Configures callback that repeats forever. Returns tracking interface.</summary>
			public global::KnockOff.IMethodTracking<int> OnCall(global::System.Action<Stubs.ISmUserService, int> callback)
			{
				var tracking = new MethodTrackingImpl();
				_sequence.Clear();
				_sequence.Add((callback, global::KnockOff.Times.Forever, tracking));
			...
			/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<Stubs.ISmUserService, int>> OnCall(global::System.Action<Stubs.ISmUserService, int> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_sequence.Clear();
				_sequence.Add((callback, times, tracking));
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal void Invoke(Stubs.ISmUserService ko, int id)
			{
				if (_sequence.Count == 0)
				{
					_unconfiguredCallCount++;
				...
				if (!times.IsForever && tracking.CallCount >= times.Count)
				{
					if (_sequenceIndex < _sequence.Count - 1)
						...
						throw global::KnockOff.StubException.SequenceExhausted("DeleteUser");
				}
			...
			/// <summary>Sequence implementation for ThenCall chaining.</summary>
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<Stubs.ISmUserService, int>>
			{
				private readonly ISmUserService_DeleteUserInterceptor _interceptor;

				public MethodSequenceImpl(ISmUserService_DeleteUserInterceptor interceptor) => _interceptor = interceptor;
				...
				/// <summary>Add another callback to the sequence.</summary>
				public global::KnockOff.IMethodSequence<global::System.Action<Stubs.ISmUserService, int>> ThenCall(global::System.Action<Stubs.ISmUserService, int> callback, global::KnockOff.Times times)
				{
					var tracking = new MethodTrackingImpl();
					_interceptor._sequence.Add((callback, times, tracking));
					return this;
		...
		public sealed class ISmStrictByDefault_GetDataInterceptor
		{
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal int Invoke(Stubs.ISmStrictByDefault ko)
			{
				if (_sequence.Count == 0)
				{
					_unconfiguredCallCount++;
			...
			{
				private readonly ISmStrictByDefault_GetDataInterceptor _interceptor;

				public MethodSequenceImpl(ISmStrictByDefault_GetDataInterceptor interceptor) => _interceptor = interceptor;
