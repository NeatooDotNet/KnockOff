...
partial class ProcessorMethodsStub : global::KnockOff.Documentation.Samples.Methods.IProcessorMethods, global::KnockOff.IKnockOffStub
{
	/// <summary>Tracks and configures behavior for ProcessData.</summary>
	public sealed class ProcessDataInterceptor
	{
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ProcessData", times, TotalCallCount));
		}
		...
		internal void Invoke(bool strict, string data)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("ProcessData");
				return;
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) { src.ProcessData(data); return; }
			#pragma warning restore CS8601, SYSLIB0050
			if (strict) throw global::KnockOff.StubException.NotConfigured("", "ProcessData");
			return;
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("ProcessData", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("ProcessData", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<string>
		{
			...
			public MethodTrackingImpl(ProcessDataInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<string>>
		{
			...
			public MethodSequenceImpl(ProcessDataInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>Interceptor for ProcessData.</summary>
	public ProcessDataInterceptor ProcessData { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Documentation.Samples.Methods.IProcessorMethods instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.Methods.IProcessorMethods Object => this;
	...
	public void Verify()
	{
		...
		if (ProcessData.CheckVerification() is { } processdataFailure) failures.Add(processdataFailure);
	...
	public void VerifyAll()
	{
		...
		if (ProcessData.CheckVerificationAll() is { } processdataFailure) failures.Add(processdataFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.Methods.IProcessorMethods).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.Methods.IProcessorMethods? source)
	{
		ProcessData._source = source;
	}
