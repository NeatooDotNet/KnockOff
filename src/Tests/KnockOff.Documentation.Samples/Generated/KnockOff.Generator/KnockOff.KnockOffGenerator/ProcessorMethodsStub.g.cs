...
partial class ProcessorMethodsStub : global::KnockOff.Documentation.Samples.Methods.IProcessorMethods, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ProcessDataInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(global::System.Action<ProcessorMethodsStub, string> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public global::KnockOff.IMethodSequence<global::System.Action<ProcessorMethodsStub, string>> OnCall(global::System.Action<ProcessorMethodsStub, string> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal void Invoke(ProcessorMethodsStub ko, bool strict, string data)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("ProcessData");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<ProcessorMethodsStub, string>>
		{
			...
			public global::KnockOff.IMethodSequence<global::System.Action<ProcessorMethodsStub, string>> ThenCall(global::System.Action<ProcessorMethodsStub, string> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
