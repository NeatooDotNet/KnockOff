...
partial class UserRepoStub : global::KnockOff.Documentation.Samples.GettingStarted.IUserRepo, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveUserInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(SaveUserDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		private int _sequenceIndex;
		private int _unconfiguredCallCount;
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<SaveUserDelegate> OnCall(SaveUserDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<SaveUserDelegate>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<SaveUserDelegate> ThenCall(SaveUserDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
