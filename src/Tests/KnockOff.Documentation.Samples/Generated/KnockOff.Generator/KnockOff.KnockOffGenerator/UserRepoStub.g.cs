...
partial class UserRepoStub : global::KnockOff.Documentation.Samples.GettingStarted.IUserRepo, global::KnockOff.IKnockOffStub
{
	...
	public sealed class SaveUserInterceptor
	{
		...
		private global::System.Collections.Generic.List<(SaveUserDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		private int _sequenceIndex;
		...
		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking<global::KnockOff.Documentation.Samples.User> OnCall(SaveUserDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
		public global::KnockOff.IMethodSequence<SaveUserDelegate> OnCallSequence(SaveUserDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(SaveUserDelegate Callback, MethodTrackingImpl Tracking)>();
			var tracking = new MethodTrackingImpl(this);
			_sequence.Add((callback, tracking));
			_sequenceIndex = 0;
			return new MethodSequenceImpl(this);
		...
		internal bool Invoke(bool strict, global::KnockOff.Documentation.Samples.User user)
		{
			...
			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) return src.SaveUser(user);
			#pragma warning restore CS8601, SYSLIB0050
		...
		/// <summary>Sequence implementation for ThenCall chaining.</summary>
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<SaveUserDelegate>
		{
			private readonly SaveUserInterceptor _interceptor;
			...
			/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<SaveUserDelegate> ThenCall(SaveUserDelegate callback)
			{
				var tracking = new MethodTrackingImpl(_interceptor);
				_interceptor._sequence!.Add((callback, tracking));
				return this;
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<SaveUserDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>The global::KnockOff.Documentation.Samples.GettingStarted.IUserRepo instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Documentation.Samples.GettingStarted.IUserRepo Object => this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Documentation.Samples.GettingStarted.IUserRepo).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Documentation.Samples.GettingStarted.IUserRepo? source)
	{
