...
public partial class ClosedGenericHost
{
    ...
    public void ClosedGenericNames()
    {
        ...
        stub.GetById.Returns(new User { Id = 1 });
    }
}
...
// =============================================================================
// Gotcha #7: Returns() vs OnCall() Mutual Exclusivity
// =============================================================================

public class ReturnsVsOnCallTests
{
    [Fact]
...
{
    [Fact]
    public void UserMethodOnCallOverride()
    {
...
public class SourceDelegationTests
{
    ...
    public void SourceDelegation()
    {
        ...
        // but preserves callbacks (OnCall, Returns, Get, Set)
        // stub.GetById.Reset();
        #endregion
