...
public class ArrayParamOverloadTests
{
	...
	public void Standalone_ArrayParam_OnCall_ParameterlessOverload()
	{
		...
		knockOff.GetItems.OnCall(() => new List<string> { "all" });
	...
	public void Standalone_ArrayParam_OnCall_SingleArrayParam()
	{
		...
		knockOff.GetItems.OnCall((filters) => new List<string>(filters));
	...
	public void Standalone_ArrayParam_OnCall_ArrayAndIntParams()
	{
		...
		knockOff.GetItems.OnCall((filters, maxCount) => new List<string>(filters.Take(maxCount)));
	...
	public void Standalone_ArrayParam_Verify_EachOverloadTrackedSeparately()
	{
		...
		var tracking1 = knockOff.GetItems.OnCall(() => new List<string>());
		var tracking2 = knockOff.GetItems.OnCall((filters) => new List<string>(filters));
		var tracking3 = knockOff.GetItems.OnCall((filters, maxCount) => new List<string>());
	...
	public void Standalone_ArrayParam_Verify_InterceptorCountsAllOverloads()
	{
		...
		knockOff.GetItems.OnCall(() => new List<string>());
		knockOff.GetItems.OnCall((filters) => new List<string>());
		knockOff.GetItems.OnCall((filters, maxCount) => new List<string>());
	...
	public void Inline_ArrayParam_OnCall_ParameterlessOverload()
	{
		...
		stub.GetItems.OnCall(() => new List<string> { "all" });
	...
	public void Inline_ArrayParam_Verify_EachOverloadTrackedSeparately()
	{
		...
		var tracking1 = stub.GetItems.OnCall(() => new List<string>());
		var tracking2 = stub.GetItems.OnCall((filters) => new List<string>());
		var tracking3 = stub.GetItems.OnCall((filters, maxCount) => new List<string>());
	...
	public void Inline_ArrayParam_Verify_InterceptorCountsAllOverloads()
	{
		...
		stub.GetItems.OnCall(() => new List<string>());
		stub.GetItems.OnCall((filters) => new List<string>());
		stub.GetItems.OnCall((filters, maxCount) => new List<string>());
