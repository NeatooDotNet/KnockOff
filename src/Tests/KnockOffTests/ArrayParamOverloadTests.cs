...
public class ArrayParamOverloadTests
{
	...
	public void Standalone_ArrayParam_OnCall_ParameterlessOverload()
	{
		...
		knockOff.GetItems.Returns(() => new List<string> { "all" });
	...
	public void Standalone_ArrayParam_OnCall_SingleArrayParam()
	{
		...
		knockOff.GetItems.Returns((filters) => new List<string>(filters));
	...
	public void Standalone_ArrayParam_OnCall_ArrayAndIntParams()
	{
		...
		knockOff.GetItems.Returns((filters, maxCount) => new List<string>(filters.Take(maxCount)));
	...
	public void Standalone_ArrayParam_Verify_EachOverloadTrackedSeparately()
	{
		...
		var tracking1 = knockOff.GetItems.Returns(() => new List<string>());
		var tracking2 = knockOff.GetItems.Returns((filters) => new List<string>(filters));
		var tracking3 = knockOff.GetItems.Returns((filters, maxCount) => new List<string>());
	...
	public void Standalone_ArrayParam_Verify_InterceptorCountsAllOverloads()
	{
		...
		knockOff.GetItems.Returns(() => new List<string>());
		knockOff.GetItems.Returns((filters) => new List<string>());
		knockOff.GetItems.Returns((filters, maxCount) => new List<string>());
	...
	public void Inline_ArrayParam_OnCall_ParameterlessOverload()
	{
		...
		stub.GetItems.Returns(() => new List<string> { "all" });
	...
	public void Inline_ArrayParam_OnCall_SingleArrayParam()
	{
		...
		stub.GetItems.Returns((filters) => new List<string>(filters));
	...
	public void Inline_ArrayParam_OnCall_ArrayAndIntParams()
	{
		...
		stub.GetItems.Returns((filters, maxCount) => new List<string>(filters.Take(maxCount)));
	...
	public void Inline_ArrayParam_Verify_EachOverloadTrackedSeparately()
	{
		...
		var tracking1 = stub.GetItems.Returns(() => new List<string>());
		var tracking2 = stub.GetItems.Returns((filters) => new List<string>());
		var tracking3 = stub.GetItems.Returns((filters, maxCount) => new List<string>());
	...
	public void Inline_ArrayParam_Verify_InterceptorCountsAllOverloads()
	{
		...
		stub.GetItems.Returns(() => new List<string>());
		stub.GetItems.Returns((filters) => new List<string>());
		stub.GetItems.Returns((filters, maxCount) => new List<string>());
