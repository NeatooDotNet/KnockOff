...
public class OutParameterTests
{
	...
	public void OutParameter_TracksOnlyInputParams()
	{
		...
		var tracking = knockOff.TryGetValue.Returns((string key, out string? value) =>
		{
			value = "found";
			return true;
		});
	...
	public void OutParameter_CallbackCanSetOutValue()
	{
		...
		knockOff.TryGetValue.Returns((string key, out string? value) =>
		{
			if (key == "exists")
			{
				value = "theValue";
	...
	public void OutParameter_ValueTypeOutParam_CallbackSetsValue()
	{
		...
		var tracking = knockOff.TryParse.Returns((string input, out int result) =>
		{
	...
	public void OutParameter_VoidMethodWithOnlyOutParams_TracksCallCount()
	{
		...
		var tracking = knockOff.GetData.Execute((out string name, out int count) =>
		{
			name = "TestName";
			count = 100;
		});
	...
	public void OutParameter_MultipleOutParams_AllSetByCallback()
	{
		...
		knockOff.GetData.Execute((out string name, out int count) =>
		{
			name = "Product";
			count = 42;
		});
	...
	public void OutParameter_Reset_ClearsTrackingState()
	{
		...
		var tracking = knockOff.TryGetValue.Returns((string key, out string? value) => { value = "x"; return true; });
	...
	public void OutParameter_LastArg_TracksInputParamsOnly()
	{
		...
		var tracking = knockOff.TryParse.Returns((string input, out int result) => { result = 0; return false; });
