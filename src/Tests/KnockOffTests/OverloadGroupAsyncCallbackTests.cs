...
public partial class OverloadGroupAsyncCallbackTests
{
	...
	public async Task TaskT_Overload_SimplifiedCallback_TwoParams()
	{
		...
		stub.GetByIdAsync.Call((int id, CancellationToken ct) => new User { Id = id, Name = "FromCT" });
	...
	public async Task TaskT_Overload_SimplifiedCallback_EachOverloadConfiguredSeparately()
	{
		...
		stub.GetByIdAsync.Call((int id, CancellationToken ct) => new User { Id = id * 2, Name = "WithToken" });
		stub.GetByIdAsync.Call((int id, string includeFields) => new User { Id = id * 3, Name = includeFields });
	...
	public async Task ValueTaskT_Overload_SimplifiedCallback_TwoParams()
	{
		...
		stub.GetCachedAsync.Call((string key, bool refresh) =>
	...
	public async Task ValueTaskT_Overload_SimplifiedCallback_BothOverloadsConfigured()
	{
		...
		stub.GetCachedAsync.Call((string key, bool refresh) => "two-params");
	...
	public async Task Overload_SimplifiedCallback_TracksCallsPerSignature()
	{
		...
		var tracking2 = stub.GetByIdAsync.Call((int id, CancellationToken ct) => new User { Id = id });
	...
	public async Task Overload_SimplifiedCallback_TracksLastArgs()
	{
		...
		var tracking = stub.GetByIdAsync.Call((int id, string includeFields) =>
	...
	public async Task Overload_MutualExclusivity_PerSignature()
	{
		...
		stub.GetByIdAsync.Call((int id, CancellationToken ct) => Task.FromResult<User?>(new User { Id = 200 }));
	...
	public async Task InlineInterface_SimplifiedCallback_MultipleOverloads()
	{
		...
		stub.GetByIdAsync.Call((int id) => new User { Id = id, Name = "Single" });
		stub.GetByIdAsync.Call((int id, CancellationToken ct) => new User { Id = id, Name = "WithToken" });
