...
public partial class OverloadGroupAsyncCallbackTests
{
	...
	public async Task TaskT_Overload_SimplifiedCallback_TwoParams()
	{
		...
		stub.GetByIdAsync.OnCall((int id, CancellationToken ct) => new User { Id = id, Name = "FromCT" });
	...
	public async Task TaskT_Overload_SimplifiedCallback_ReturnsNull()
	{
		...
		stub.GetByIdAsync.OnCall((int id) => (User?)null);
	...
	public async Task TaskT_Overload_SimplifiedCallback_EachOverloadConfiguredSeparately()
	{
		...
		stub.GetByIdAsync.OnCall((int id) => new User { Id = id, Name = "Single" });
		stub.GetByIdAsync.OnCall((int id, CancellationToken ct) => new User { Id = id * 2, Name = "WithToken" });
		stub.GetByIdAsync.OnCall((int id, string includeFields) => new User { Id = id * 3, Name = includeFields });
	...
	public async Task ValueTaskT_Overload_SimplifiedCallback_SingleParam()
	{
		...
		stub.GetCachedAsync.OnCall((string key) => $"cached-{key}");
	...
	public async Task ValueTaskT_Overload_SimplifiedCallback_TwoParams()
	{
		...
		stub.GetCachedAsync.OnCall((string key, bool refresh) =>
	...
	public async Task ValueTaskT_Overload_SimplifiedCallback_BothOverloadsConfigured()
	{
		...
		stub.GetCachedAsync.OnCall((string key) => "single-param");
		stub.GetCachedAsync.OnCall((string key, bool refresh) => "two-params");
	...
	public async Task Task_Overload_SimplifiedVoidCallback_SingleParam()
	{
		...
		User? savedUser = null;
		stub.SaveAsync.OnCall((User user) => { savedUser = user; });
	...
	public async Task Task_Overload_SimplifiedVoidCallback_TwoParams()
	{
		...
		stub.SaveAsync.OnCall((User user, CancellationToken ct) =>
		{
			savedUser = user;
	...
	public async Task Task_Overload_SimplifiedVoidCallback_BothConfigured()
	{
		...
		stub.SaveAsync.OnCall((User user) => calls.Add("single"));
		stub.SaveAsync.OnCall((User user, CancellationToken ct) => calls.Add("withToken"));
	...
	public async Task ValueTask_Overload_SimplifiedVoidCallback_SingleParam()
	{
		...
		stub.LogAsync.OnCall((string message) => { loggedMessage = message; });
	...
	public async Task ValueTask_Overload_SimplifiedVoidCallback_TwoParams()
	{
		...
		stub.LogAsync.OnCall((string message, int level) =>
		{
	...
	public async Task Overload_SimplifiedCallback_TracksCallsPerSignature()
	{
		...
		var tracking1 = stub.GetByIdAsync.OnCall((int id) => new User { Id = id });
		var tracking2 = stub.GetByIdAsync.OnCall((int id, CancellationToken ct) => new User { Id = id });
	...
	public async Task Overload_SimplifiedCallback_TracksLastArg()
	{
		...
		var tracking = stub.GetByIdAsync.OnCall((int id) => new User { Id = id });
	...
	public async Task Overload_SimplifiedCallback_TracksLastArgs()
	{
		...
		var tracking = stub.GetByIdAsync.OnCall((int id, string includeFields) =>
	...
	public async Task Overload_SimplifiedCallback_VerifyTimesWorks()
	{
		...
		var tracking = stub.GetCachedAsync.OnCall((string key) => "value");
	...
	public async Task Overload_SimplifiedCallback_ClearsAsyncCallback()
	{
		...
		stub.GetByIdAsync.OnCall((int id) => Task.FromResult<User?>(new User { Id = 100 }));

		// Then configure with simplified callback - should clear async callback
		stub.GetByIdAsync.OnCall((int id) => new User { Id = 200 });
	...
	public async Task Overload_AsyncCallback_ClearsSimplifiedCallback()
	{
		...
		stub.GetByIdAsync.OnCall((int id) => new User { Id = 100 });

		// Then configure with async delegate callback - should clear simplified
		stub.GetByIdAsync.OnCall((int id) => Task.FromResult<User?>(new User { Id = 200 }));
	...
	public async Task Overload_MutualExclusivity_PerSignature()
	{
		...
		stub.GetByIdAsync.OnCall((int id, CancellationToken ct) => Task.FromResult<User?>(new User { Id = 200 }));
	...
	public async Task InlineInterface_SimplifiedCallback_TaskT_Works()
	{
		...
		stub.GetByIdAsync.OnCall((int id) => new User { Id = id, Name = "Inline" });
	...
	public async Task InlineInterface_SimplifiedCallback_ValueTaskT_Works()
	{
		...
		stub.GetCachedAsync.OnCall((string key) => $"inline-{key}");
	...
	public async Task InlineInterface_SimplifiedCallback_MultipleOverloads()
	{
		...
		stub.GetByIdAsync.OnCall((int id) => new User { Id = id, Name = "Single" });
		stub.GetByIdAsync.OnCall((int id, CancellationToken ct) => new User { Id = id, Name = "WithToken" });
