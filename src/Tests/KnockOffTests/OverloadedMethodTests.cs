...
public class OverloadedMethodTests
{
	...
	public void OverloadedMethod_EachOverload_HasOwnTracking()
	{
		...
		var tracking1 = knockOff.Process.Execute((data) => { });
		var tracking2 = knockOff.Process.Execute((data, priority) => { });
		var tracking3 = knockOff.Process.Execute((data, priority, async) => { });
	...
	public void OverloadedMethod_SingleParam_TracksLastArg()
	{
		...
		var tracking = knockOff.Process.Execute((data) => { });
	...
	public void OverloadedMethod_TwoParams_TracksLastArgs_WithProperTypes()
	{
		...
		var tracking = knockOff.Process.Execute((data, priority) => { });
	...
	public void OverloadedMethod_ThreeParams_TracksLastArgs_AllParams()
	{
		...
		var tracking = knockOff.Process.Execute((data, priority, async) => { });
	...
	public void OverloadedMethod_WithReturn_OnCallReturnsValue()
	{
		...
		knockOff.Calculate.Returns((value) => value * 2);

		// Set callback for Calculate(int a, int b) - two param overload
		knockOff.Calculate.Returns((a, b) => a + b);
...
#pragma warning restore xUnit1051
	...
	public void OverloadedMethod_DifferentParamNames_CompilerResolvesCorrectly()
	{
		...
		var tracking1 = knockOff.Calculate.Returns((value) => value);
		var tracking2 = knockOff.Calculate.Returns((a, b) => a);
