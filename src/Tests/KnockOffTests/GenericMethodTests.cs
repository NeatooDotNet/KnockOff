...
public class GenericMethodTests
{
	...
	public void GenericMethod_NoParams_TracksCallCount()
	{
		...
		knockOff.Create.Of<TestEntity>().Verify(Called.Exactly(2));
	...
	public void GenericMethod_DifferentTypeArgs_TrackedSeparately()
	{
		...
		knockOff.Create.Of<TestEntity>().Verify(Called.Once);
		knockOff.Create.Of<List<int>>().Verify(Called.Exactly(2));
	}
	...
	public void GenericMethod_VoidWithParam_TracksCallCount()
	{
		...
		knockOff.Process.Of<string>().Verify(Called.Once);
		knockOff.Process.Of<int>().Verify(Called.Exactly(2));
	}
	...
	public void GenericMethod_TotalCallCount_AcrossAllTypeArgs()
	{
		...
		knockOff.Create.Verify(Called.Exactly(3));
	}
	...
	public void GenericMethod_Verify_ConfirmsAnyTypeArgCalled()
	{
		...
		knockOff.Create.Verify(Called.Never);
	...
	public void GenericMethod_OnCallVoid_InvokesCallback()
	{
		...
		knockOff.Process.Of<string>().Call((value) => captured = value);
	...
	public void GenericMethod_WithNonGenericParam_TracksAllCalls()
	{
		...
		knockOff.Find.Of<User>().Verify(Called.Exactly(3));
	...
	public void GenericMethod_MultipleTypeParams_TracksCorrectly()
	{
		...
		knockOff.Convert.Of<string, int>().Verify(Called.Once);
		knockOff.Convert.Of<int, string>().Verify(Called.Once);
	}
	...
	public void GenericMethod_MultipleTypeParams_TotalCallCount()
	{
		...
		knockOff.Convert.Verify(Called.Exactly(3));
	}
	...
	public void GenericMethod_VoidMultipleTypeParams_OnCallWorks()
	{
		...
		int capturedDest = 0;
		knockOff.Transfer.Of<string, int>().Call((source, dest) =>
		{
	...
	public void ConstrainedGeneric_ClassAndInterfaceAndNew_Works()
	{
		...
		knockOff.CreateEntity.Of<TestEntityWithInterface>().Verify(Called.Once);
	}
	...
	public void ConstrainedGeneric_VoidMethod_TracksCorrectly()
	{
		...
		knockOff.SaveEntity.Of<TestEntityWithInterface>().Verify(Called.Once);
	}
	...
	public void ConstrainedGeneric_VoidMethod_OnCallCaptures()
	{
		...
		knockOff.SaveEntity.Of<TestEntityWithInterface>().Call((e) => captured = e);
	...
	public void GenericMethod_Reset_ClearsTypedHandler()
	{
		...
		knockOff.Create.Of<TestEntity>().Verify(Called.Never);
		knockOff.Create.Of<TestEntity>().Verify(Called.Never);
	...
	public void GenericMethod_ResetWithParams_ClearsAllCalls()
	{
		...
		knockOff.Deserialize.Of<TestEntity>().Verify(Called.Never);
