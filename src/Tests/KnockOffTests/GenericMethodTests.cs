...
public class GenericMethodTests
{
	...
	public void GenericMethod_NoParams_TracksCallCount()
	{
		...
		knockOff.Create.Of<TestEntity>().Verify(Times.Exactly(2));
	...
	public void GenericMethod_DifferentTypeArgs_TrackedSeparately()
	{
		...
		knockOff.Create.Of<TestEntity>().Verify(Times.Once);
		knockOff.Create.Of<List<int>>().Verify(Times.Exactly(2));
	}
	...
	public void GenericMethod_VoidWithParam_TracksCallCount()
	{
		...
		knockOff.Process.Of<string>().Verify(Times.Once);
		knockOff.Process.Of<int>().Verify(Times.Exactly(2));
	}
	...
	public void GenericMethod_TotalCallCount_AcrossAllTypeArgs()
	{
		...
		knockOff.Create.Verify(Times.Exactly(3));
	}
	...
	public void GenericMethod_OnCall_ReturnsConfiguredValue()
	{
		...
		knockOff.Create.Of<TestEntity>().OnCall(() => expected);
	...
	public void GenericMethod_OnCall_DifferentCallbacksPerTypeArg()
	{
		...
		knockOff.Create.Of<TestEntity>().OnCall(() => new TestEntity { Id = 1 });
		knockOff.Create.Of<List<int>>().OnCall(() => new List<int> { 100 });
	...
	public void GenericMethod_OnCallVoid_InvokesCallback()
	{
		...
		knockOff.Process.Of<string>().OnCall((value) => captured = value);
	...
	public void GenericMethod_OnCallWithParam_ReturnsValue()
	{
		...
		knockOff.Deserialize.Of<TestEntity>().OnCall((json) =>
	...
	public void GenericMethod_MultipleTypeParams_TracksCorrectly()
	{
		...
		knockOff.Convert.Of<int, string>().OnCall((i) => i.ToString());

		service.Convert<string, int>("hello");
		service.Convert<int, string>(42);

		knockOff.Convert.Of<string, int>().Verify(Times.Once);
		knockOff.Convert.Of<int, string>().Verify(Times.Once);
	}
	...
	public void GenericMethod_MultipleTypeParams_OnCallWorks()
	{
		...
		knockOff.Convert.Of<string, int>().OnCall((input) => input.Length);
	...
	public void GenericMethod_MultipleTypeParams_TotalCallCount()
	{
		...
		knockOff.Convert.Verify(Times.Exactly(3));
	}
	...
	public void GenericMethod_VoidMultipleTypeParams_OnCallWorks()
	{
		...
		int capturedDest = 0;
		knockOff.Transfer.Of<string, int>().OnCall((source, dest) =>
		{
	...
	public void ConstrainedGeneric_ClassAndInterfaceAndNew_Works()
	{
		...
		knockOff.CreateEntity.Of<TestEntityWithInterface>().Verify(Times.Once);
	}
	...
	public void ConstrainedGeneric_OnCallWithConstraints_Works()
	{
		...
		knockOff.CreateEntity.Of<TestEntityWithInterface>().OnCall(() => expected);
	...
	public void ConstrainedGeneric_VoidMethod_TracksCorrectly()
	{
		...
		knockOff.SaveEntity.Of<TestEntityWithInterface>().Verify(Times.Once);
	}
	...
	public void ConstrainedGeneric_VoidMethod_OnCallCaptures()
	{
		...
		knockOff.SaveEntity.Of<TestEntityWithInterface>().OnCall((e) => captured = e);
