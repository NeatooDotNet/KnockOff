	...
	public static class Stubs
	{
		...
		public sealed class IClassRepository_FindInterceptor<T> where T : class
		{
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				if (!_isVerifiable) return null;
				var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
				return times.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("Find", times, CallCount);
			}
			...
			{
				if (!IsConfigured) return null;
				return global::KnockOff.Times.AtLeastOnce.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("Find", global::KnockOff.Times.AtLeastOnce, CallCount);
			}
