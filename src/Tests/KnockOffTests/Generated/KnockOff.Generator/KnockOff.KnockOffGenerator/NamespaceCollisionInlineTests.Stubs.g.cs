...
partial class NamespaceCollisionInlineTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IPersonDbContext_SavePersonInterceptor
		{
			...
			public global::DomainModel.Person? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
