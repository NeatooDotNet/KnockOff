...
partial class CollectionStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class ICollection_IsSynchronizedInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public ICollection_IsSynchronizedInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public ICollection_IsSynchronizedInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly ICollection_IsSynchronizedInterceptor _interceptor;

				public PropertyGetTrackingImpl(ICollection_IsSynchronizedInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<bool>
			{
				...
				public PropertyGetSequenceImpl(ICollection_IsSynchronizedInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class ICollection_SyncRootInterceptor
		{
			...
			/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public ICollection_SyncRootInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }

			/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public ICollection_SyncRootInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			private sealed class PropertyGetTrackingImpl : global::KnockOff.IPropertyGetTracking
			{
				private readonly ICollection_SyncRootInterceptor _interceptor;

				public PropertyGetTrackingImpl(ICollection_SyncRootInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<object>
			{
				...
				public PropertyGetSequenceImpl(ICollection_SyncRootInterceptor interceptor) => _interceptor = interceptor;
