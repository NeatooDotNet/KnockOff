...
partial class ListIntStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IList_IndexerInterceptor
		{
			...
			private global::System.Func<Stubs.IList, int, int>? _onGet;
			/// <summary>Callback for getter. Setting this marks the indexer as configured.</summary>
			public global::System.Func<Stubs.IList, int, int>? OnGet
			{
				get => _onGet;
			...
			private global::System.Action<Stubs.IList, int, int>? _onSet;
			/// <summary>Callback for setter. Setting this marks the indexer as configured.</summary>
			public global::System.Action<Stubs.IList, int, int>? OnSet
			{
				get => _onSet;
		...
		public sealed class IList_IndexOfInterceptor
		{
			...
			public delegate int IndexOfDelegate(Stubs.IList ko, int item);
			...
			internal int Invoke(Stubs.IList ko, int item)
			{
		...
		public sealed class IList_InsertInterceptor
		{
			...
			private global::System.Action<Stubs.IList, int, int>? _onCall;
			private MethodTrackingImpl? _onCallTracking;

			private global::System.Collections.Generic.List<(global::System.Action<Stubs.IList, int, int> Callback, MethodTrackingImpl Tracking)>? _sequence;
			private int _sequenceIndex;
			...
			/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
			public global::KnockOff.IMethodTrackingArgs<(int index, int item)> OnCall(global::System.Action<Stubs.IList, int, int> callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			/// <summary>Starts a callback sequence. Returns sequence for ThenCall chaining. Each callback runs exactly once.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<Stubs.IList, int, int>> OnCallSequence(global::System.Action<Stubs.IList, int, int> callback)
			{
				_onCall = null;
				_onCallTracking = null;
				_isVerifiable = false;
				_verifiableTimes = null;
				_sequence = new global::System.Collections.Generic.List<(global::System.Action<Stubs.IList, int, int> Callback, MethodTrackingImpl Tracking)>();
				var tracking = new MethodTrackingImpl(this);
				_sequence.Add((callback, tracking));
				_sequenceIndex = 0;
				return new MethodSequenceImpl(this);
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal void Invoke(Stubs.IList ko, int index, int item)
			{
				if (_sequence != null && _sequenceIndex < _sequence.Count)
				{
					var (callback, tracking) = _sequence[_sequenceIndex];
			...
			/// <summary>Sequence implementation for ThenCall chaining.</summary>
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<Stubs.IList, int, int>>
			{
				private readonly IList_InsertInterceptor _interceptor;
				...
				/// <summary>Adds another callback to the sequence. Each callback runs exactly once.</summary>
				public global::KnockOff.IMethodSequence<global::System.Action<Stubs.IList, int, int>> ThenCall(global::System.Action<Stubs.IList, int, int> callback)
				{
					var tracking = new MethodTrackingImpl(_interceptor);
					_interceptor._sequence!.Add((callback, tracking));
					return this;
				...
				/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
				public global::KnockOff.IMethodSequence<global::System.Action<Stubs.IList, int, int>> Verifiable()
				{
					_interceptor._isVerifiable = true;
					_interceptor._verifiableTimes = null;
					return this;
		...
		public sealed class IList_AddInterceptor
		{
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal void Invoke(Stubs.IList ko, int item)
			{
				if (_sequence != null && _sequenceIndex < _sequence.Count)
				{
					var (callback, tracking) = _sequence[_sequenceIndex];
		...
		public sealed class IList_ContainsInterceptor
		{
			...
			public delegate bool ContainsDelegate(Stubs.IList ko, int item);
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal bool Invoke(Stubs.IList ko, int item)
			{
				if (_sequence != null && _sequenceIndex < _sequence.Count)
				{
					var (callback, tracking) = _sequence[_sequenceIndex];
		...
		public sealed class IList_CopyToInterceptor
		{
			...
			/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
			public global::KnockOff.IMethodTrackingArgs<(int[] array, int arrayIndex)> OnCall(global::System.Action<Stubs.IList, int[], int> callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal void Invoke(Stubs.IList ko, int[] array, int arrayIndex)
			{
				if (_sequence != null && _sequenceIndex < _sequence.Count)
				{
					var (callback, tracking) = _sequence[_sequenceIndex];
		...
		public sealed class IList_RemoveInterceptor
		{
			...
			public delegate bool RemoveDelegate(Stubs.IList ko, int item);
		...
		public sealed class IList_GetEnumeratorInterceptor
		{
			...
			public delegate global::System.Collections.Generic.IEnumerator<int> GetEnumeratorDelegate(Stubs.IList ko);
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal global::System.Collections.Generic.IEnumerator<int> Invoke(Stubs.IList ko)
			{
				if (_sequence != null && _sequenceIndex < _sequence.Count)
				{
					var (callback, tracking) = _sequence[_sequenceIndex];
