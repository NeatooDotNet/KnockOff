...
partial class ComparerStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IComparer_CompareInterceptor
		{
			...
			private global::System.Collections.Generic.List<(CompareDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Compare", times, TotalCallCount));
			}

			/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
			public global::KnockOff.IMethodTrackingArgs<(object? x, object? y)> OnCall(CompareDelegate callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			public global::KnockOff.IMethodSequence<CompareDelegate> OnCallSequence(CompareDelegate callback)
			{
				_onCall = null;
				_onCallTracking = null;
				_isVerifiable = false;
				_verifiableTimes = null;
				_sequence = new global::System.Collections.Generic.List<(CompareDelegate Callback, MethodTrackingImpl Tracking)>();
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				...
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Compare", times, TotalCallCount);
			}
			...
			internal global::KnockOff.VerificationFailure? CheckVerificationAll()
			{
				...
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Compare", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}
			...
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTrackingArgs<(object? x, object? y)>
			{
				...
				public MethodTrackingImpl(IComparer_CompareInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<CompareDelegate>
			{
				...
				public global::KnockOff.IMethodSequence<CompareDelegate> ThenCall(CompareDelegate callback)
				{
				...
				public global::KnockOff.IMethodSequence<CompareDelegate> Verifiable()
				{
					_interceptor._isVerifiable = true;
					_interceptor._verifiableTimes = null;
					return this;
		...
		public class IComparer : global::System.Collections.IComparer, global::KnockOff.IKnockOffStub
		{
			...
			/// <summary>Sets the source object for global::System.Collections.IComparer delegation.</summary>
			public void Source(global::System.Collections.IComparer? source)
			{
			...
			public void Verify()
			{
				...
				if (Compare.CheckVerification() is { } compareFailure) failures.Add(compareFailure);
			...
			public void VerifyAll()
			{
				...
				if (Compare.CheckVerificationAll() is { } compareFailure) failures.Add(compareFailure);
