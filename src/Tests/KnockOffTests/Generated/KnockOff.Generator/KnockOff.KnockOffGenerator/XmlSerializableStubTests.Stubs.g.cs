...
partial class XmlSerializableStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IXmlSerializable_GetSchemaInterceptor
		{
			...
			private global::System.Xml.Schema.XmlSchema? _onCallValue = default!;
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetSchema", times, TotalCallCount));
			}
			...
			public global::KnockOff.IMethodTracking OnCall(global::System.Xml.Schema.XmlSchema? value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				...
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetSchema", times, TotalCallCount);
			}
			...
			internal global::KnockOff.VerificationFailure? CheckVerificationAll()
			{
				...
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetSchema", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}
		...
		public sealed class IXmlSerializable_ReadXmlInterceptor
		{
			...
			public global::System.Xml.XmlReader? LastCallArg { get { if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArg; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
			...
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ReadXml", times, TotalCallCount));
			}
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				if (!_isVerifiable) return null;
				var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("ReadXml", times, TotalCallCount);
			}
			...
			{
				if (!IsConfigured) return null;
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("ReadXml", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}
		...
		public sealed class IXmlSerializable_WriteXmlInterceptor
		{
			...
			/// <summary>The argument from the last call (from most recently called registration).</summary>
			public global::System.Xml.XmlWriter? LastCallArg { get { if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArg; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
			...
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("WriteXml", times, TotalCallCount));
			}
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				if (!_isVerifiable) return null;
				var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("WriteXml", times, TotalCallCount);
			}
			...
			{
				if (!IsConfigured) return null;
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("WriteXml", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}
