...
partial class XmlSerializableStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IXmlSerializable_GetSchemaInterceptor
		{
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(CallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetSchema", times, CallCount));
			}
		...
		public sealed class IXmlSerializable_ReadXmlInterceptor
		{
			...
			{
				if (!times.Validate(CallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ReadXml", times, CallCount));
			}
		...
		public sealed class IXmlSerializable_WriteXmlInterceptor
		{
			...
			{
				if (!times.Validate(CallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("WriteXml", times, CallCount));
			}
