...
partial class ComparableStringKnockOff : global::System.IComparable<string>, global::KnockOff.IKnockOffStub
{
	...
	public sealed class CompareToInterceptor
	{
		...
		{
			private readonly CompareToInterceptor _interceptor;

			public MethodTrackingImpl(CompareToInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<CompareToDelegate>
		{
			...
			public MethodSequenceImpl(CompareToInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::System.IComparable<string>).</summary>
