...
partial class NewConstraintStub<T> : global::KnockOff.Tests.INewConstraintService<T>, global::KnockOff.IKnockOffStub where T : new()
{
	...
	public sealed class CreateInterceptor
	{
		...
		private global::System.Collections.Generic.List<(CreateDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(CallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Create", times, CallCount));
		}
		...
		public global::KnockOff.IMethodSequence<CreateDelegate> OnCallSequence(CreateDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(CreateDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal T Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("Create");
				return default!;
			}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("Create", times, CallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("Create", global::KnockOff.Times.AtLeastOnce, CallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(CreateInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<CreateDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<CreateDelegate> ThenCall(CreateDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<CreateDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Tests.INewConstraintService<T>).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Tests.INewConstraintService<T>? source)
	{
