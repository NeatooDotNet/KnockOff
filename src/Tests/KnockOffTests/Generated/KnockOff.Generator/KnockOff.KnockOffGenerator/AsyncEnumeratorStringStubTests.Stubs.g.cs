...
partial class AsyncEnumeratorStringStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IAsyncEnumerator_MoveNextAsyncInterceptor
		{
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(CallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("MoveNextAsync", times, CallCount));
			}
		...
		public sealed class IAsyncEnumerator_DisposeAsyncInterceptor
		{
			...
			{
				if (!times.Validate(CallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("DisposeAsync", times, CallCount));
			}
