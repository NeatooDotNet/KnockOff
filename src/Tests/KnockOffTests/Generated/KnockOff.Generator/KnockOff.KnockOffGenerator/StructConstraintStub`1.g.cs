...
partial class StructConstraintStub<T> : global::KnockOff.Tests.IStructConstraintService<T>, global::KnockOff.IKnockOffStub where T : struct
{
	...
	public sealed class GetDefaultInterceptor
	{
		...
		private global::System.Collections.Generic.List<(GetDefaultDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetDefault", times, TotalCallCount));
		}
		...
		public global::KnockOff.IMethodTracking OnCall(T value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<GetDefaultDelegate> OnCallSequence(GetDefaultDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetDefaultDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal T Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetDefault");
				return default!;
			}

			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) return src.GetDefault();
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetDefault", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetDefault", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(GetDefaultInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetDefaultDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<GetDefaultDelegate> ThenCall(GetDefaultDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<GetDefaultDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public sealed class SetInterceptor
	{
		...
		internal void Invoke(bool strict, T @value)
		{
			...
			#pragma warning disable CS8601, SYSLIB0050
			if (_source is { } src) { src.Set(@value); return; }
			#pragma warning restore CS8601, SYSLIB0050
	...
	public void Verify()
	{
		...
		if (GetDefault.CheckVerification() is { } getdefaultFailure) failures.Add(getdefaultFailure);
	...
	public void VerifyAll()
	{
		...
		if (GetDefault.CheckVerificationAll() is { } getdefaultFailure) failures.Add(getdefaultFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Tests.IStructConstraintService<T>).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Tests.IStructConstraintService<T>? source)
	{
		GetDefault._source = source;
		Set._source = source;
	}
