...
partial class AuditableEntityKnockOff : global::KnockOff.Tests.IAuditableEntity, global::KnockOff.Tests.IBaseEntity, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ModifiedAtInterceptor
	{
		...
		public void RecordSet(global::System.DateTime? value) { _setCount++; LastSetValue = value; }
		...
		public void VerifyGet(global::KnockOff.Times times)
		{
			if (!times.Validate(_getCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ModifiedAt (get)", times, _getCount));
		}
		...
		public void VerifySet(global::KnockOff.Times times)
		{
			if (!times.Validate(_setCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ModifiedAt (set)", times, _setCount));
		}
	...
	public sealed class ModifiedByInterceptor
	{
		...
		{
			if (!times.Validate(_getCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ModifiedBy (get)", times, _getCount));
		}
		...
		{
			if (!times.Validate(_setCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ModifiedBy (set)", times, _setCount));
		}
