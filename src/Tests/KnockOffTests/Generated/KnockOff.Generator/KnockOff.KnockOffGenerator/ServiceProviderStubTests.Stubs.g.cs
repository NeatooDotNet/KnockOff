...
partial class ServiceProviderStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IServiceProvider_GetServiceInterceptor
		{
			...
			public global::System.Type? LastCallArg { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
