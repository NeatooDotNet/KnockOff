...
partial class ObservableStringStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IObservable_SubscribeInterceptor
		{
			...
			public global::System.IObserver<string>? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
