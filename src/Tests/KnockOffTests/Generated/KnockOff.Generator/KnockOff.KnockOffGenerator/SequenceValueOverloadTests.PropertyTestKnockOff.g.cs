...
{
partial class PropertyTestKnockOff : global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest, global::KnockOff.IKnockOffStub
{
	...
	public sealed class NameInterceptor
	{
		...
		internal global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest? _source;
	...
	public sealed class IsEnabledInterceptor
	{
		...
		internal void InvokeSet(bool strict, bool value)
		{
			...
			if (_setSequence != null && _setSequenceIndex >= _setSequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("IsEnabled (set)");
				return;
			}

			if (_source is { } src) { src.IsEnabled = value; return; }
		...
		{
			if (!times.Validate(TotalSetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("IsEnabled (set)", times, TotalSetCount));
		}

		/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
		public IsEnabledInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; _isSetVerifiable = true; _setVerifiableTimes = null; return this; }

		/// <summary>Marks this property for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
		public IsEnabledInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; _isSetVerifiable = true; _setVerifiableTimes = times; return this; }
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			if (_isGetVerifiable && _isSetVerifiable)
			{
				...
				var times = _getVerifiableTimes ?? _setVerifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
				var totalCount = TotalGetCount + TotalSetCount;
				return times.Validate(totalCount) ? null : new global::KnockOff.VerificationFailure("IsEnabled", times, totalCount);
			}
			if (_isGetVerifiable && !_isSetVerifiable)
			{
				var times = _getVerifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			...
			{
				var times = _setVerifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
				if (!times.Validate(TotalSetCount)) return new global::KnockOff.VerificationFailure("IsEnabled (set)", times, TotalSetCount);
			}
			return null;
		}
		...
		private sealed class PropertySetTrackingImpl : global::KnockOff.IPropertySetTracking<bool>
		{
			...
			public PropertySetTrackingImpl(IsEnabledInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertySetSequenceImpl : global::KnockOff.IPropertySetSequence<bool>
		{
			...
			public PropertySetSequenceImpl(IsEnabledInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>The global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest Object => this;

	// Source(T) methods for interface delegation

	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest? source)
	{
		Name._source = source;
	...
	string? global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest.Name
	{
		get => Name.InvokeGet(Strict);
		set => Name.InvokeSet(Strict, value);
	}

	int global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest.Count
	{
		get => Count.InvokeGet(Strict);
		set => Count.InvokeSet(Strict, value);
	}

	bool global::KnockOff.Tests.SequenceValueOverloadTests.IPropertyTest.IsEnabled
	{
		get => IsEnabled.InvokeGet(Strict);
		set => IsEnabled.InvokeSet(Strict, value);
	}
