...
partial class AuditorKnockOff : global::KnockOff.Tests.IAuditor, global::KnockOff.IKnockOffStub
{
	...
	public sealed class AuditInterceptor
	{
		...
		{
			if (!times.Validate(CallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Audit", times, CallCount));
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(CallCount) ? null : new global::KnockOff.VerificationFailure("Audit", global::KnockOff.Times.AtLeastOnce, CallCount);
		}
