...
partial class AuditorKnockOff : global::KnockOff.Tests.IAuditor, global::KnockOff.IKnockOffStub
{
	...
	public sealed class AuditInterceptor
	{
		...
		public (string? action, int? userId)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
