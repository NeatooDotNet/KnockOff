...
partial class AuditorKnockOff : global::KnockOff.Tests.IAuditor, global::KnockOff.IKnockOffStub
{
	...
	public sealed class AuditInterceptor
	{
		...
		public (string? action, int? userId)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
