...
partial class IndexerTestKnockOff : global::KnockOff.Tests.IIndexerTestService, global::KnockOff.IKnockOffStub
{
	...
	{
		get { IndexerString.RecordGet(key); if (IndexerString.OnGet is { } onGet) return onGet(this, key); if (Strict) throw global::KnockOff.StubException.NotConfigured("IIndexerTestService", "this[]"); return IndexerString.Backing.TryGetValue(key, out var v) ? v : default!; }
		set { IndexerString.RecordSet(key, value); if (IndexerString.OnSet is { } onSet) { onSet(this, key, value); return; } if (Strict) throw global::KnockOff.StubException.NotConfigured("IIndexerTestService", "this[]"); IndexerString.Backing[key] = value; }
	}

	int global::KnockOff.Tests.IIndexerTestService.this[int index]
	{
		get { IndexerInt32.RecordGet(index); if (IndexerInt32.OnGet is { } onGet) return onGet(this, index); if (Strict) throw global::KnockOff.StubException.NotConfigured("IIndexerTestService", "this[]"); return IndexerInt32.Backing.TryGetValue(index, out var v) ? v : default!; }
	}
