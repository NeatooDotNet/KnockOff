...
partial class SetIntStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class ISet_ExceptWithInterceptor
		{
			...
			/// <summary>The argument from the last call (from most recently called registration).</summary>
			public global::System.Collections.Generic.IEnumerable<int>? LastCallArg { get { if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArg; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
		...
		public sealed class ISet_IsProperSubsetOfInterceptor
		{
			...
			/// <summary>The argument from the last call (from most recently called registration).</summary>
			public global::System.Collections.Generic.IEnumerable<int>? LastCallArg { get { if ((_onCallValueTracking?.CallCount ?? 0) > 0) return _onCallValueTracking!.LastArg; if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArg; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
			...
			/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
			public global::KnockOff.IMethodTracking<global::System.Collections.Generic.IEnumerable<int>> OnCall(bool value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
