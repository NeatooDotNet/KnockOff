...
partial class ObservableIntStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IObservable_SubscribeInterceptor
		{
			...
			public global::System.IObserver<int>? LastCallArg { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
