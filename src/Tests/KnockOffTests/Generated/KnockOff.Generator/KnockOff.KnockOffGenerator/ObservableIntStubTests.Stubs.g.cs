...
partial class ObservableIntStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IObservable_SubscribeInterceptor
		{
			...
			public delegate global::System.IDisposable SubscribeDelegate(global::System.IObserver<int> observer);

			private SubscribeDelegate? _onCall;
			private MethodTrackingImpl? _onCallTracking;

			private global::System.Collections.Generic.List<(SubscribeDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
			...
			public global::System.IObserver<int>? LastCallArg { get { if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArg; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Subscribe", times, TotalCallCount));
			}
			...
			public global::KnockOff.IMethodSequence<SubscribeDelegate> OnCallSequence(SubscribeDelegate callback)
			{
				_onCall = null;
				_onCallTracking = null;
				_isVerifiable = false;
				_verifiableTimes = null;
				_sequence = new global::System.Collections.Generic.List<(SubscribeDelegate Callback, MethodTrackingImpl Tracking)>();
			...
			internal global::System.IDisposable Invoke(bool strict, global::System.IObserver<int> observer)
			{
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				...
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Subscribe", times, TotalCallCount);
			}
			...
			internal global::KnockOff.VerificationFailure? CheckVerificationAll()
			{
				...
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Subscribe", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}
			...
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::System.IObserver<int>>
			{
				...
				public MethodTrackingImpl(IObservable_SubscribeInterceptor interceptor) => _interceptor = interceptor;
				...
				public global::KnockOff.IMethodTracking<global::System.IObserver<int>> Verifiable()
				{
				...
				public global::KnockOff.IMethodTracking<global::System.IObserver<int>> Verifiable(global::KnockOff.Times times)
				{
					_interceptor._isVerifiable = true;
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<SubscribeDelegate>
			{
				...
				public global::KnockOff.IMethodSequence<SubscribeDelegate> ThenCall(SubscribeDelegate callback)
				{
				...
				public global::KnockOff.IMethodSequence<SubscribeDelegate> Verifiable()
				{
					_interceptor._isVerifiable = true;
					_interceptor._verifiableTimes = null;
					return this;
