...
partial class EqualityComparerStringStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IEqualityComparer_EqualsInterceptor
		{
			...
			internal global::System.Collections.Generic.IEqualityComparer<string>? _source;

			/// <summary>Delegate for Equals.</summary>
			public delegate bool EqualsDelegate(string? x, string? y);
			...
			public (string? x, string? y)? LastCallArgs { get { if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArgs; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
			...
			public global::KnockOff.IMethodTrackingArgs<(string? x, string? y)> OnCall(EqualsDelegate callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal bool Invoke(bool strict, string? x, string? y)
			{
			...
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTrackingArgs<(string? x, string? y)>
			{
				...
				public MethodTrackingImpl(IEqualityComparer_EqualsInterceptor interceptor) => _interceptor = interceptor;
				...
				public global::KnockOff.IMethodTrackingArgs<(string? x, string? y)> Verifiable()
				{
				...
				public global::KnockOff.IMethodTrackingArgs<(string? x, string? y)> Verifiable(global::KnockOff.Times times)
				{
					_interceptor._isVerifiable = true;
		...
		public sealed class IEqualityComparer_GetHashCodeInterceptor
		{
			...
			public delegate int GetHashCodeDelegate(string obj);
			...
			/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
			public global::KnockOff.IMethodTracking<string> OnCall(GetHashCodeDelegate callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal int Invoke(bool strict, string obj)
			{
				if (_sequence != null && _sequenceIndex < _sequence.Count)
				{
					var (callback, tracking) = _sequence[_sequenceIndex];
			...
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<string>
			{
				...
				public MethodTrackingImpl(IEqualityComparer_GetHashCodeInterceptor interceptor) => _interceptor = interceptor;
				...
				/// <summary>Records a call to this callback.</summary>
				public void RecordCall(string obj) { CallCount++; _lastArg = obj; }
		...
		public class IEqualityComparer : global::System.Collections.Generic.IEqualityComparer<string>, global::KnockOff.IKnockOffStub
		{
			...
			/// <summary>Sets the source object for global::System.Collections.Generic.IEqualityComparer<string> delegation.</summary>
			public void Source(global::System.Collections.Generic.IEqualityComparer<string>? source)
			{
