...
partial class EqualityComparerStringStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IEqualityComparer_EqualsInterceptor
		{
			...
			public global::KnockOff.IMethodTrackingArgs<(string? x, string? y)> OnCall(bool value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal bool Invoke(bool strict, string? x, string? y)
			{
				...
				{
					_onCallValueTracking.RecordCall((x, y));
					return _onCallValue;
				}
		...
		public sealed class IEqualityComparer_GetHashCodeInterceptor
		{
			...
			internal int Invoke(bool strict, string obj)
			{
				...
				if (_hasOnCallValue && _onCallValueTracking != null)
				{
					_onCallValueTracking.RecordCall(obj);
					return _onCallValue;
				}
