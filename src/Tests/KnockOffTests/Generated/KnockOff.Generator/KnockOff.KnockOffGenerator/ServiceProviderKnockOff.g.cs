...
partial class ServiceProviderKnockOff : global::System.IServiceProvider, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetServiceInterceptor
	{
		...
		public global::System.Type? LastCallArg { get { if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArg; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetService", times, TotalCallCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetService", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetService", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::System.Type>
		{
			private readonly GetServiceInterceptor _interceptor;

			public MethodTrackingImpl(GetServiceInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetServiceDelegate>
		{
			...
			public MethodSequenceImpl(GetServiceInterceptor interceptor) => _interceptor = interceptor;
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::System.IServiceProvider).</summary>
