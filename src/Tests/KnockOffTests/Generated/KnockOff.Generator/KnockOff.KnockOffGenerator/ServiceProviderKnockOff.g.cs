...
partial class ServiceProviderKnockOff : global::System.IServiceProvider, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetServiceInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(GetServiceDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public global::System.Type? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
		...
		public global::KnockOff.IMethodSequence<GetServiceDelegate> OnCall(GetServiceDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal object? Invoke(ServiceProviderKnockOff ko, bool strict, global::System.Type serviceType)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("GetService");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetServiceDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<GetServiceDelegate> ThenCall(GetServiceDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
