...
{
partial class NameCollisionKnockOff : global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class StatusInterceptor
	{
		...
		internal global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService? _source;
		...
		public StatusInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
		...
		public StatusInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
	...
	/// <summary>Tracks and configures behavior for Status.</summary>
	public sealed class Status2Interceptor
	{
		/// <summary>Source object to delegate to when no OnCall is configured.</summary>
		internal global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService? _source;

		/// <summary>Delegate for Status.</summary>
		public delegate string? StatusDelegate();

		private StatusDelegate? _onCall;
		...
		private global::System.Collections.Generic.List<(StatusDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Status", times, TotalCallCount));
		}

		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking OnCall(StatusDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<StatusDelegate> OnCallSequence(StatusDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(StatusDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal string? Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("Status");
				return default!;
			}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Status", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Status", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			private readonly Status2Interceptor _interceptor;

			public MethodTrackingImpl(Status2Interceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<StatusDelegate>
		{
			private readonly Status2Interceptor _interceptor;

			public MethodSequenceImpl(Status2Interceptor interceptor) => _interceptor = interceptor;
			...
			public global::KnockOff.IMethodSequence<StatusDelegate> ThenCall(StatusDelegate callback)
			{
			...
			/// <summary>Marks this sequence for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodSequence<StatusDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public Status2Interceptor Status2 { get; } = new();

	/// <summary>When true, throws StubException for unconfigured member access.</summary>
	public bool Strict { get; set; } = false;

	/// <summary>The global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService instance. Use for passing to code expecting the interface.</summary>
	public global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService Object => this;
	...
	public void Verify()
	{
		...
		if (Status2.CheckVerification() is { } status2Failure) failures.Add(status2Failure);
	...
	public void VerifyAll()
	{
		...
		if (Status2.CheckVerificationAll() is { } status2Failure) failures.Add(status2Failure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService).</summary>
	/// <param name="source">The source to delegate to, or null to clear.</param>
	public void Source(global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService? source)
	{
		Status._source = source;
		Status2._source = source;
	}

	string? global::KnockOff.Tests.EdgeCaseValueOverloadTests.INameCollisionService.Status
	{
