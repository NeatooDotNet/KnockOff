...
partial class EqualityComparerStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IEqualityComparer_EqualsInterceptor
		{
			...
			public (object? x, object? y)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
