...
partial class EqualityComparerStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IEqualityComparer_EqualsInterceptor
		{
			...
			internal global::System.Collections.IEqualityComparer? _source;

			/// <summary>Delegate for Equals.</summary>
			public delegate bool EqualsDelegate(Stubs.IEqualityComparer ko, object? x, object? y);
			...
			private (object? x, object? y)? _unconfiguredLastArgs;
			...
			public (object? x, object? y)? LastCallArgs { get { if (_onCallTracking?.WasCalled == true) return _onCallTracking.LastArgs; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }


			/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
			public global::KnockOff.IMethodTrackingArgs<(object? x, object? y)> OnCall(EqualsDelegate callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal bool Invoke(Stubs.IEqualityComparer ko, object? x, object? y)
			{
			...
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTrackingArgs<(object? x, object? y)>
			{
				...
				private (object? x, object? y) _lastArgs;
				...
				public (object? x, object? y) LastArgs => _lastArgs;

				/// <summary>Records a call to this callback.</summary>
				public void RecordCall((object? x, object? y) args) { CallCount++; _lastArgs = args; }
				...
				public global::KnockOff.IMethodTrackingArgs<(object? x, object? y)> Verifiable()
				{
				...
				public global::KnockOff.IMethodTrackingArgs<(object? x, object? y)> Verifiable(global::KnockOff.Times times)
				{
					_interceptor._isVerifiable = true;
		...
		public sealed class IEqualityComparer_GetHashCodeInterceptor
		{
			...
			public delegate int GetHashCodeDelegate(Stubs.IEqualityComparer ko, object obj);
			...
			/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
			public global::KnockOff.IMethodTracking<object> OnCall(GetHashCodeDelegate callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
			internal int Invoke(Stubs.IEqualityComparer ko, object obj)
			{
				if (_sequence != null && _sequenceIndex < _sequence.Count)
				{
					var (callback, tracking) = _sequence[_sequenceIndex];
			...
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<object>
			{
				...
				/// <summary>Records a call to this callback.</summary>
				public void RecordCall(object obj) { CallCount++; _lastArg = obj; }
		...
		public class IEqualityComparer : global::System.Collections.IEqualityComparer, global::KnockOff.IKnockOffStub
		{
			...
			/// <summary>Sets the source object for global::System.Collections.IEqualityComparer delegation.</summary>
			public void Source(global::System.Collections.IEqualityComparer? source)
			{
