...
partial class EqualityComparerStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IEqualityComparer_EqualsInterceptor
		{
			...
			public delegate bool EqualsDelegate(object? x, object? y);
			...
			public global::KnockOff.IMethodTrackingArgs<(object? x, object? y)> OnCall(bool value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal bool Invoke(bool strict, object? x, object? y)
			{
		...
		public sealed class IEqualityComparer_GetHashCodeInterceptor
		{
			...
			public delegate int GetHashCodeDelegate(object obj);
