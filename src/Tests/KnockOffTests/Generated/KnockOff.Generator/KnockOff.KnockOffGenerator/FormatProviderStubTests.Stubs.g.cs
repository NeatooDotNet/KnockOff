...
partial class FormatProviderStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IFormatProvider_GetFormatInterceptor
		{
			...
			private global::System.Collections.Generic.List<(GetFormatDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetFormat", times, TotalCallCount));
			}

			/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
			public global::KnockOff.IMethodTracking<global::System.Type?> OnCall(GetFormatDelegate callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			public global::KnockOff.IMethodSequence<GetFormatDelegate> OnCallSequence(GetFormatDelegate callback)
			{
				_onCall = null;
				_onCallTracking = null;
				_isVerifiable = false;
				_verifiableTimes = null;
				_sequence = new global::System.Collections.Generic.List<(GetFormatDelegate Callback, MethodTrackingImpl Tracking)>();
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				...
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetFormat", times, TotalCallCount);
			}
			...
			internal global::KnockOff.VerificationFailure? CheckVerificationAll()
			{
				...
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetFormat", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}

			/// <summary>Tracks invocations for this callback registration.</summary>
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::System.Type?>
			{
				private readonly IFormatProvider_GetFormatInterceptor _interceptor;

				public MethodTrackingImpl(IFormatProvider_GetFormatInterceptor interceptor) => _interceptor = interceptor;
				...
				public void RecordCall(global::System.Type? formatType) { CallCount++; _lastArg = formatType; }
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetFormatDelegate>
			{
				private readonly IFormatProvider_GetFormatInterceptor _interceptor;

				public MethodSequenceImpl(IFormatProvider_GetFormatInterceptor interceptor) => _interceptor = interceptor;
				...
				public global::KnockOff.IMethodSequence<GetFormatDelegate> ThenCall(GetFormatDelegate callback)
				{
				...
				public global::KnockOff.IMethodSequence<GetFormatDelegate> Verifiable()
				{
					_interceptor._isVerifiable = true;
					_interceptor._verifiableTimes = null;
					return this;
		...
		public class IFormatProvider : global::System.IFormatProvider, global::KnockOff.IKnockOffStub
		{
			...
			public void Verify()
			{
				...
				if (GetFormat.CheckVerification() is { } getformatFailure) failures.Add(getformatFailure);
			...
			public void VerifyAll()
			{
				...
				if (GetFormat.CheckVerificationAll() is { } getformatFailure) failures.Add(getformatFailure);
