...
partial class FormatProviderStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IFormatProvider_GetFormatInterceptor
		{
			...
			private readonly global::System.Collections.Generic.List<(GetFormatDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
			...
			public global::KnockOff.IMethodSequence<GetFormatDelegate> OnCall(GetFormatDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_sequence.Clear();
			...
			internal object? Invoke(Stubs.IFormatProvider ko, global::System.Type? formatType)
			{
				...
				if (!times.IsForever && tracking.CallCount >= times.Count)
				{
					if (_sequenceIndex < _sequence.Count - 1)
						...
						throw global::KnockOff.StubException.SequenceExhausted("GetFormat");
				}
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetFormatDelegate>
			{
				...
				public global::KnockOff.IMethodSequence<GetFormatDelegate> ThenCall(GetFormatDelegate callback, global::KnockOff.Times times)
				{
					var tracking = new MethodTrackingImpl();
