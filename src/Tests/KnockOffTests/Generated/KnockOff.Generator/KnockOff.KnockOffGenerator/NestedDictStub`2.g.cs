...
partial class NestedDictStub<TKey, TValue> : global::KnockOff.Tests.INestedDictService<TKey, TValue>, global::KnockOff.IKnockOffStub where TKey : notnull
{
	...
	public sealed class GetMappingInterceptor
	{
		...
		private global::System.Collections.Generic.Dictionary<TKey, TValue> _onCallValue = default!;
		private bool _hasOnCallValue;
		private MethodTrackingImpl? _onCallValueTracking;

		private global::System.Collections.Generic.List<(GetMappingDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetMapping", times, TotalCallCount));
		}
		...
		public global::KnockOff.IMethodTracking OnCall(global::System.Collections.Generic.Dictionary<TKey, TValue> value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<GetMappingDelegate> OnCallSequence(GetMappingDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetMappingDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal global::System.Collections.Generic.Dictionary<TKey, TValue> Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetMapping");
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetMapping", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetMapping", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(GetMappingInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetMappingDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<GetMappingDelegate> ThenCall(GetMappingDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<GetMappingDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public void Verify()
	{
		...
		if (GetMapping.CheckVerification() is { } getmappingFailure) failures.Add(getmappingFailure);
	...
	public void VerifyAll()
	{
		...
		if (GetMapping.CheckVerificationAll() is { } getmappingFailure) failures.Add(getmappingFailure);
