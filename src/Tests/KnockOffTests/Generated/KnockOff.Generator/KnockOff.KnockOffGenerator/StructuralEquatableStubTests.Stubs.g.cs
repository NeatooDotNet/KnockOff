...
partial class StructuralEquatableStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IStructuralEquatable_EqualsInterceptor
		{
			...
			public (object? other, global::System.Collections.IEqualityComparer comparer)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
		...
		public sealed class IStructuralEquatable_GetHashCodeInterceptor
		{
			...
			public global::System.Collections.IEqualityComparer? LastCallArg { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
