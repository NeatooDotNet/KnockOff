...
partial class InlineMixedReturnTypesStub
{
	...
	public static class Stubs
	{
		...
		public sealed class IFactoryWithMixedReturnTypes_Fetch1Interceptor
		{
			...
			private global::KnockOff.Tests.ISampleArea? _onCallValue = default!;
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Fetch1", times, TotalCallCount));
			}
			...
			public global::KnockOff.IMethodTracking<long> OnCall(global::KnockOff.Tests.ISampleArea? value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				...
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Fetch1", times, TotalCallCount);
			}
			...
			internal global::KnockOff.VerificationFailure? CheckVerificationAll()
			{
				...
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Fetch1", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}
		...
		public sealed class IFactoryWithMixedReturnTypes_Fetch2Interceptor
		{
			...
			/// <summary>The argument from the last call (from most recently called registration).</summary>
			public global::KnockOff.Tests.SampleEntity? LastCallArg { get { if ((_onCallValueTracking?.CallCount ?? 0) > 0) return _onCallValueTracking!.LastArg; if ((_onCallTracking?.CallCount ?? 0) > 0) return _onCallTracking!.LastArg; if (_sequence != null) for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
			...
			{
				if (!times.Validate(TotalCallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Fetch2", times, TotalCallCount));
			}
			...
			/// <summary>Configures return value that repeats indefinitely. Returns tracking interface.</summary>
			public global::KnockOff.IMethodTracking<global::KnockOff.Tests.SampleEntity> OnCall(global::KnockOff.Tests.ISampleArea value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal global::KnockOff.Tests.ISampleArea Invoke(bool strict, global::KnockOff.Tests.SampleEntity entity)
			{
				...
				if (_hasOnCallValue && _onCallValueTracking != null)
				{
					_onCallValueTracking.RecordCall(entity);
					return _onCallValue;
				}
			...
			internal global::KnockOff.VerificationFailure? CheckVerification()
			{
				if (!_isVerifiable) return null;
				var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
				return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Fetch2", times, TotalCallCount);
			}
			...
			{
				if (!IsConfigured) return null;
				return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Fetch2", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
			}
