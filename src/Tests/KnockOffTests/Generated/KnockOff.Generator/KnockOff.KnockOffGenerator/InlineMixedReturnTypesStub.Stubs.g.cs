...
partial class InlineMixedReturnTypesStub
{
	...
	public static class Stubs
	{
		...
		public sealed class IFactoryWithMixedReturnTypes_Fetch1Interceptor
		{
			...
			public void Verify(global::KnockOff.Times times)
			{
				if (!times.Validate(CallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Fetch1", times, CallCount));
			}
		...
		public sealed class IFactoryWithMixedReturnTypes_Fetch2Interceptor
		{
			...
			{
				if (!times.Validate(CallCount))
					throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Fetch2", times, CallCount));
			}
