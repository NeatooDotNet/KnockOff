...
partial class CloneableStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class ICloneable_CloneInterceptor
		{
			...
			{
				private readonly ICloneable_CloneInterceptor _interceptor;

				public MethodTrackingImpl(ICloneable_CloneInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<CloneDelegate>
			{
				...
				public MethodSequenceImpl(ICloneable_CloneInterceptor interceptor) => _interceptor = interceptor;
