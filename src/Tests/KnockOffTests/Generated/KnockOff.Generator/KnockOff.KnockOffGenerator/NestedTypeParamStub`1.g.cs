...
partial class NestedTypeParamStub<T> : global::KnockOff.Tests.INestedTypeParamService<T>, global::KnockOff.IKnockOffStub
{
	...
	public sealed class AddItemsInterceptor
	{
		...
		public global::System.Collections.Generic.IEnumerable<T>? LastCallArg { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArg; return _unconfiguredCallCount > 0 ? _unconfiguredLastArg : default; } }
