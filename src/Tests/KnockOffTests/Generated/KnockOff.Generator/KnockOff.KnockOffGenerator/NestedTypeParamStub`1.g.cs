...
partial class NestedTypeParamStub<T> : global::KnockOff.Tests.INestedTypeParamService<T>, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetItemsInterceptor
	{
		...
		private global::System.Collections.Generic.List<T> _onCallValue = default!;
		private bool _hasOnCallValue;
		private MethodTrackingImpl? _onCallValueTracking;

		private global::System.Collections.Generic.List<(GetItemsDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetItems", times, TotalCallCount));
		}
		...
		public global::KnockOff.IMethodTracking OnCall(global::System.Collections.Generic.List<T> value)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<GetItemsDelegate> OnCallSequence(GetItemsDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetItemsDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal global::System.Collections.Generic.List<T> Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetItems");
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetItems", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetItems", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(GetItemsInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetItemsDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<GetItemsDelegate> ThenCall(GetItemsDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<GetItemsDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public sealed class AddItemsInterceptor
	{
		...
		private int _unconfiguredCallCount;
		private global::System.Collections.Generic.IEnumerable<T>? _unconfiguredLastArg;
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("AddItems", times, TotalCallCount));
		}
		...
		internal void Invoke(bool strict, global::System.Collections.Generic.IEnumerable<T> items)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("AddItems");
				return;
			}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("AddItems", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("AddItems", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking<global::System.Collections.Generic.IEnumerable<T>>
		{
			...
			public MethodTrackingImpl(AddItemsInterceptor interceptor) => _interceptor = interceptor;
			...
			/// <summary>Marks for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodTracking<global::System.Collections.Generic.IEnumerable<T>> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
			...
			/// <summary>Marks for verification by Stub.Verify() with Times constraint. Returns this for fluent chaining.</summary>
			public global::KnockOff.IMethodTracking<global::System.Collections.Generic.IEnumerable<T>> Verifiable(global::KnockOff.Times times)
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = times;
				return this;
	...
	public void Verify()
	{
		...
		if (GetItems.CheckVerification() is { } getitemsFailure) failures.Add(getitemsFailure);
		if (AddItems.CheckVerification() is { } additemsFailure) failures.Add(additemsFailure);
	...
	public void VerifyAll()
	{
		...
		if (GetItems.CheckVerificationAll() is { } getitemsFailure) failures.Add(getitemsFailure);
		if (AddItems.CheckVerificationAll() is { } additemsFailure) failures.Add(additemsFailure);
