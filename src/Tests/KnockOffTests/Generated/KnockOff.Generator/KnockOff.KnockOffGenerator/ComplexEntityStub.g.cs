...
partial class ComplexEntityStub
{
	/// <summary>Tracks and configures behavior for IComplexEntity.Name.</summary>
	public sealed class IComplexEntity_NameInterceptor
	{
		/// <summary>Number of times the getter was accessed.</summary>
		public int GetCount { get; private set; }

		/// <summary>Callback invoked when the getter is accessed. If set, its return value is used.</summary>
		public global::System.Func<ComplexEntityStub, string?>? OnGet { get; set; }
		...
		public global::System.Action<ComplexEntityStub, string?>? OnSet { get; set; }
	...
	/// <summary>Tracks and configures behavior for IComplexEntity.ComputeHash.</summary>
	public sealed class IComplexEntity_ComputeHashInterceptor
	{
		/// <summary>Delegate for ComputeHash(global::System.Threading.CancellationToken token).</summary>
		public delegate global::System.Threading.Tasks.Task<string> ComputeHashDelegate(ComplexEntityStub ko, global::System.Threading.CancellationToken token);
		...
		public ComputeHashDelegate? OnCall { get; set; }
	...
	/// <summary>Tracks invocations and configures behavior for KnockOff.Tests.IComplexEntity.</summary>
	public sealed class IComplexEntityInterceptorors
	{
		/// <summary>Interceptor for Name.</summary>
		public IComplexEntity_NameInterceptor Name { get; } = new();
		/// <summary>Interceptor for ComputeHash.</summary>
		public IComplexEntity_ComputeHashInterceptor ComputeHash { get; } = new();
	}
	...
	public sealed class IEntityBase_ModifiedPropertiesInterceptor
	{
		...
		/// <summary>Callback invoked when the getter is accessed. If set, its return value is used.</summary>
		public global::System.Func<ComplexEntityStub, global::System.Collections.Generic.IEnumerable<string>>? OnGet { get; set; }
	...
	public sealed class IEntityBase_StringIndexerInterceptor
	{
		...
		/// <summary>Callback invoked when the getter is accessed. If set, its return value is used.</summary>
		public global::System.Func<ComplexEntityStub, string, global::Neatoo.IEntityProperty>? OnGet { get; set; }
	...
	public sealed class IEntityBase_DeleteInterceptor
	{
		...
		public delegate void DeleteDelegate(ComplexEntityStub ko);
	...
	public sealed class IEntityBase_UnDeleteInterceptor
	{
		...
		public delegate void UnDeleteDelegate(ComplexEntityStub ko);
	...
	public sealed class IEntityBase_SaveInterceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task<global::Neatoo.IEntityBase> SaveDelegate(ComplexEntityStub ko);
	...
	public sealed class IValidateBase_IsPausedInterceptor
	{
		...
		/// <summary>Callback invoked when the getter is accessed. If set, its return value is used.</summary>
		public global::System.Func<ComplexEntityStub, bool>? OnGet { get; set; }
	...
	public sealed class IValidateBase_StringIndexerInterceptor
	{
		...
		/// <summary>Callback invoked when the getter is accessed. If set, its return value is used.</summary>
		public global::System.Func<ComplexEntityStub, string, global::Neatoo.IValidateProperty>? OnGet { get; set; }
	...
	public sealed class IValidateBase_GetPropertyInterceptor
	{
		...
		public delegate global::Neatoo.IValidateProperty GetPropertyDelegate(ComplexEntityStub ko, string propertyName);
	...
	public sealed class IValidateBase_TryGetPropertyInterceptor
	{
		...
		public delegate bool TryGetPropertyDelegate(ComplexEntityStub ko, string propertyName, out global::Neatoo.IValidateProperty validateProperty);
	...
	public sealed class IBase_ParentInterceptor
	{
		...
		/// <summary>Callback invoked when the getter is accessed. If set, its return value is used.</summary>
		public global::System.Func<ComplexEntityStub, global::Neatoo.IBase?>? OnGet { get; set; }
	...
	public sealed class IValidateMetaProperties_PropertyMessagesInterceptor
	{
		...
		/// <summary>Callback invoked when the getter is accessed. If set, its return value is used.</summary>
		public global::System.Func<ComplexEntityStub, global::System.Collections.Generic.IReadOnlyCollection<global::Neatoo.IPropertyMessage>>? OnGet { get; set; }
	...
	public sealed class IValidateMetaProperties_RunRules1Interceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task RunRulesDelegate(ComplexEntityStub ko, string propertyName, global::System.Threading.CancellationToken? token);
	...
	public sealed class IValidateMetaProperties_RunRules2Interceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task RunRulesDelegate(ComplexEntityStub ko, global::Neatoo.RunRulesFlag runRules, global::System.Threading.CancellationToken? token);
	...
	public sealed class IValidateMetaProperties_ClearAllMessagesInterceptor
	{
		...
		public delegate void ClearAllMessagesDelegate(ComplexEntityStub ko);
	...
	public sealed class IValidateMetaProperties_ClearSelfMessagesInterceptor
	{
		...
		public delegate void ClearSelfMessagesDelegate(ComplexEntityStub ko);
	...
	public sealed class IBaseMetaProperties_WaitForTasksInterceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task WaitForTasksDelegate(ComplexEntityStub ko);
	...
	/// <summary>Tracks invocations and configures behavior for KnockOff.Tests.IComplexEntity.</summary>
	public IComplexEntityInterceptorors IComplexEntity { get; } = new();
	...
	/// <summary>Returns this instance as KnockOff.Tests.IComplexEntity.</summary>
	public KnockOff.Tests.IComplexEntity AsComplexEntity() => this;
	...
	/// <summary>Backing field for IComplexEntity.Name.</summary>
	protected string? IComplexEntity_NameBacking { get; set; }
	...
	string? KnockOff.Tests.IComplexEntity.Name
	{
		get
		{
			IComplexEntity.Name.RecordGet();
			if (IComplexEntity.Name.OnGet is { } onGetCallback)
				return onGetCallback(this);
			return IComplexEntity_NameBacking;
		}
		set
		{
			IComplexEntity.Name.RecordSet(value);
			if (IComplexEntity.Name.OnSet is { } onSetCallback)
				onSetCallback(this, value);
			else
				IComplexEntity_NameBacking = value;
		}
	}

	global::System.Threading.Tasks.Task<string> KnockOff.Tests.IComplexEntity.ComputeHash(global::System.Threading.CancellationToken token)
	{
		IComplexEntity.ComputeHash.RecordCall(token);
		if (IComplexEntity.ComputeHash.OnCall is { } onCallCallback)
			return onCallCallback(this, token);
		throw new global::System.InvalidOperationException("No implementation provided for non-nullable return type. Define a protected method 'ComputeHash' in your partial class, or set IComplexEntity.ComputeHash.OnCall.");
	}
