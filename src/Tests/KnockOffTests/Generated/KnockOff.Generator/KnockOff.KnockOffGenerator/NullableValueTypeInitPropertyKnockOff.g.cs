	...
	public sealed class RevisionInterceptor
	{
		...
		public void VerifyGet(global::KnockOff.Times times)
		{
			if (!times.Validate(GetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Revision (get)", times, GetCount));
		}
		...
		public void VerifySet(global::KnockOff.Times times)
		{
			if (!times.Validate(SetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Revision (set)", times, SetCount));
		}
