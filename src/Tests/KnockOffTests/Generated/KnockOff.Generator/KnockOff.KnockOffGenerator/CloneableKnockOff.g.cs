...
partial class CloneableKnockOff : global::System.ICloneable, global::KnockOff.IKnockOffStub
{
	...
	public sealed class CloneInterceptor
	{
		...
		private readonly global::System.Collections.Generic.List<(CloneDelegate Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
		...
		public global::KnockOff.IMethodSequence<CloneDelegate> OnCall(CloneDelegate callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
		...
		internal object Invoke(CloneableKnockOff ko, bool strict)
		{
			...
			if (!times.IsForever && tracking.CallCount >= times.Count)
			{
				if (_sequenceIndex < _sequence.Count - 1)
					...
					throw global::KnockOff.StubException.SequenceExhausted("Clone");
			}
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<CloneDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<CloneDelegate> ThenCall(CloneDelegate callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
