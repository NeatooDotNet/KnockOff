...
partial class CloneableKnockOff : global::System.ICloneable, global::KnockOff.IKnockOffStub
{
	...
	public sealed class CloneInterceptor
	{
		...
		private global::System.Collections.Generic.List<(CloneDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("Clone", times, TotalCallCount));
		}

		/// <summary>Configures callback that repeats indefinitely. Returns tracking interface for LastArg access.</summary>
		public global::KnockOff.IMethodTracking OnCall(CloneDelegate callback)
		{
			_sequence = null;
			_sequenceIndex = 0;
			_isVerifiable = false;
		...
		public global::KnockOff.IMethodSequence<CloneDelegate> OnCallSequence(CloneDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(CloneDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Clone", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("Clone", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}

		/// <summary>Tracks invocations for this callback registration.</summary>
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			private readonly CloneInterceptor _interceptor;

			public MethodTrackingImpl(CloneInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<CloneDelegate>
		{
			private readonly CloneInterceptor _interceptor;

			public MethodSequenceImpl(CloneInterceptor interceptor) => _interceptor = interceptor;
			...
			public global::KnockOff.IMethodSequence<CloneDelegate> ThenCall(CloneDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<CloneDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public void Verify()
	{
		...
		if (Clone.CheckVerification() is { } cloneFailure) failures.Add(cloneFailure);
	...
	public void VerifyAll()
	{
		...
		if (Clone.CheckVerificationAll() is { } cloneFailure) failures.Add(cloneFailure);
	...
	/// <summary>Delegates unconfigured member access to the provided source object (global::System.ICloneable).</summary>
