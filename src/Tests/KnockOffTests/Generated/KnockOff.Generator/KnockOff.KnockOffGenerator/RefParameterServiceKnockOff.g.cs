...
partial class RefParameterServiceKnockOff : global::KnockOff.Tests.IRefParameterService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class TryUpdateInterceptor
	{
		...
		public (string? key, string? @value)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
