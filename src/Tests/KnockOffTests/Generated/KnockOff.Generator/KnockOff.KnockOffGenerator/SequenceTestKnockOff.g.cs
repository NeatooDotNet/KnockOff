...
partial class SequenceTestKnockOff : global::KnockOff.Tests.ISequenceTestService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetMessageInterceptor
	{
		...
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetMessage", times, TotalCallCount));
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			if (!_isVerifiable) return null;
			var times = _verifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetMessage", times, TotalCallCount);
		}
		...
		{
			if (!IsConfigured) return null;
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetMessage", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
