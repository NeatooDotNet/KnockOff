...
partial class FormattableStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IFormattable_ToStringInterceptor
		{
			...
			private (string? format, global::System.IFormatProvider? formatProvider)? _unconfiguredLastArgs;
			...
			public global::KnockOff.IMethodTrackingArgs<(string? format, global::System.IFormatProvider? formatProvider)> OnCall(ToStringDelegate callback)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			public global::KnockOff.IMethodTrackingArgs<(string? format, global::System.IFormatProvider? formatProvider)> OnCall(string value)
			{
				_sequence = null;
				_sequenceIndex = 0;
				_isVerifiable = false;
			...
			internal string Invoke(bool strict, string? format, global::System.IFormatProvider? formatProvider)
			{
				...
				{
					_onCallValueTracking.RecordCall((format, formatProvider));
					return _onCallValue;
				}
			...
			private sealed class MethodTrackingImpl : global::KnockOff.IMethodTrackingArgs<(string? format, global::System.IFormatProvider? formatProvider)>
			{
				private readonly IFormattable_ToStringInterceptor _interceptor;

				public MethodTrackingImpl(IFormattable_ToStringInterceptor interceptor) => _interceptor = interceptor;

				private (string? format, global::System.IFormatProvider? formatProvider) _lastArgs;

				internal int CallCount { get; private set; }

				/// <summary>Last arguments passed to this callback. Default if never called.</summary>
				public (string? format, global::System.IFormatProvider? formatProvider) LastArgs => _lastArgs;

				/// <summary>Records a call to this callback.</summary>
				public void RecordCall((string? format, global::System.IFormatProvider? formatProvider) args) { CallCount++; _lastArgs = args; }
				...
				public global::KnockOff.IMethodTrackingArgs<(string? format, global::System.IFormatProvider? formatProvider)> Verifiable()
				{
				...
				public global::KnockOff.IMethodTrackingArgs<(string? format, global::System.IFormatProvider? formatProvider)> Verifiable(global::KnockOff.Times times)
				{
					_interceptor._isVerifiable = true;
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<ToStringDelegate>
			{
				...
				public MethodSequenceImpl(IFormattable_ToStringInterceptor interceptor) => _interceptor = interceptor;
