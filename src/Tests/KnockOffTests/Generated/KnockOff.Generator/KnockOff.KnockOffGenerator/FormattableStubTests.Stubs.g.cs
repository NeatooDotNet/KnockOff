...
partial class FormattableStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IFormattable_ToStringInterceptor
		{
			...
			public (string? format, global::System.IFormatProvider? formatProvider)? LastCallArgs { get { for (int i = _sequence.Count - 1; i >= 0; i--) if (_sequence[i].Tracking.CallCount > 0) return _sequence[i].Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
