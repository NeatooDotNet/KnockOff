...
partial class AsyncServiceKnockOff : global::KnockOff.Tests.IAsyncService, global::KnockOff.IKnockOffStub
{
	...
	public sealed class GetRequiredAsyncInterceptor
	{
		...
		internal global::System.Threading.Tasks.Task<string> Invoke(AsyncServiceKnockOff ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
				...
				throw new global::System.InvalidOperationException("No implementation provided for GetRequiredAsync. Configure via GetRequiredAsync.OnCall.");
			}
	...
	public bool Verify()
	{
		...
		result &= GetOptionalAsync.Verify();
		result &= GetRequiredAsync.Verify();
		result &= DoWorkValueTaskAsync.Verify();
		return result;
	}
