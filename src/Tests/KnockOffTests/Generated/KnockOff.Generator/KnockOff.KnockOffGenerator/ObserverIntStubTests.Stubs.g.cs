...
partial class ObserverIntStubTests
{
	...
	public static class Stubs
	{
		...
		{
			private readonly global::System.Collections.Generic.List<(global::System.Action<Stubs.IObserver, int> Callback, global::KnockOff.Times Times, MethodTrackingImpl Tracking)> _sequence = new();
			private int _sequenceIndex;
			private int _unconfiguredCallCount;
			...
			/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<Stubs.IObserver, int>> OnCall(global::System.Action<Stubs.IObserver, int> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_sequence.Clear();
				_sequence.Add((callback, times, tracking));
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<Stubs.IObserver, int>>
			{
				...
				/// <summary>Add another callback to the sequence.</summary>
				public global::KnockOff.IMethodSequence<global::System.Action<Stubs.IObserver, int>> ThenCall(global::System.Action<Stubs.IObserver, int> callback, global::KnockOff.Times times)
				{
					var tracking = new MethodTrackingImpl();
					_interceptor._sequence.Add((callback, times, tracking));
					return this;
