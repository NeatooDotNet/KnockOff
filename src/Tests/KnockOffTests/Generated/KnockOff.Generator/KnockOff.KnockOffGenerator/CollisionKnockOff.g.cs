...
partial class CollisionKnockOff : global::KnockOff.Tests.ICollision, global::KnockOff.IKnockOffStub
{
	...
	public sealed class ICollisionInterceptor
	{
		...
		internal string InvokeGet(bool strict)
		{
			...
			if (_getSequence != null && _getSequenceIndex >= _getSequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("ICollision (get)");
				return _valueSet ? _value : default!;
			}

			if (_source is { } src) return src.ICollision;

			if (strict) throw global::KnockOff.StubException.NotConfigured("", "ICollision");
			return _valueSet ? _value : default!;
		}
		...
		internal void InvokeSet(bool strict, string value)
		{
			...
			if (_setSequence != null && _setSequenceIndex >= _setSequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("ICollision (set)");
				return;
			}

			if (_source is { } src) { src.ICollision = value; return; }
		...
		public void VerifyGet(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalGetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ICollision (get)", times, TotalGetCount));
		}
		...
		public void VerifySet(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalSetCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("ICollision (set)", times, TotalSetCount));
		}

		/// <summary>Marks this property for verification by Stub.Verify(). Returns this for fluent chaining.</summary>
		public ICollisionInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; _isSetVerifiable = true; _setVerifiableTimes = null; return this; }
		...
		public ICollisionInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; _isSetVerifiable = true; _setVerifiableTimes = times; return this; }
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			if (_isGetVerifiable && !_isSetVerifiable)
			{
				...
				if (!times.Validate(TotalGetCount)) return new global::KnockOff.VerificationFailure("ICollision (get)", times, TotalGetCount);
			}
			if (_isSetVerifiable && !_isGetVerifiable)
			{
				var times = _setVerifiableTimes ?? global::KnockOff.Times.AtLeastOnce;
				if (!times.Validate(TotalSetCount)) return new global::KnockOff.VerificationFailure("ICollision (set)", times, TotalSetCount);
			}
			return null;
		}
		...
		{
			private readonly ICollisionInterceptor _interceptor;

			public PropertyGetTrackingImpl(ICollisionInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<string>
		{
			...
			public PropertyGetSequenceImpl(ICollisionInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertySetTrackingImpl : global::KnockOff.IPropertySetTracking<string>
		{
			...
			public PropertySetTrackingImpl(ICollisionInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class PropertySetSequenceImpl : global::KnockOff.IPropertySetSequence<string>
		{
			...
			public PropertySetSequenceImpl(ICollisionInterceptor interceptor) => _interceptor = interceptor;
	...
	{
		get => ICollision.InvokeGet(Strict);
		set => ICollision.InvokeSet(Strict, value);
	}
