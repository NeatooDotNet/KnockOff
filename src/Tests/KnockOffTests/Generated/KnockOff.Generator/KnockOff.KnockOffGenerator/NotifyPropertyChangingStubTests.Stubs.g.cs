...
partial class NotifyPropertyChangingStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class INotifyPropertyChanging_PropertyChangingInterceptor
		{
			...
			public void RecordAdd(global::System.ComponentModel.PropertyChangingEventHandler? handler) { _addCount++; Handler = (global::System.ComponentModel.PropertyChangingEventHandler?)global::System.Delegate.Combine(Handler, handler); }

			/// <summary>Records an event unsubscription.</summary>
			public void RecordRemove(global::System.ComponentModel.PropertyChangingEventHandler? handler) { _removeCount++; Handler = (global::System.ComponentModel.PropertyChangingEventHandler?)global::System.Delegate.Remove(Handler, handler); }
			...
			public void VerifyAdd(global::KnockOff.Times times)
			{
				if (!times.Validate(_addCount))
					throw new global::KnockOff.VerificationException($"Event 'PropertyChanging' add verification failed: expected {times}, but was called {_addCount} time(s).");
			}
			...
			public void VerifyRemove(global::KnockOff.Times times)
			{
				if (!times.Validate(_removeCount))
					throw new global::KnockOff.VerificationException($"Event 'PropertyChanging' remove verification failed: expected {times}, but was called {_removeCount} time(s).");
			}
