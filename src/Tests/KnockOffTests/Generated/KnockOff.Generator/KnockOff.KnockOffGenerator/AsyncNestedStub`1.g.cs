...
partial class AsyncNestedStub<T> : global::KnockOff.Tests.IAsyncNestedService<T>, global::KnockOff.IKnockOffStub where T : class
{
	...
	public sealed class GetAsyncInterceptor
	{
		...
		private global::System.Collections.Generic.List<(GetAsyncDelegate Callback, MethodTrackingImpl Tracking)>? _sequence;
		...
		public void Verify(global::KnockOff.Times times)
		{
			if (!times.Validate(TotalCallCount))
				throw new global::KnockOff.VerificationException(new global::KnockOff.VerificationFailure("GetAsync", times, TotalCallCount));
		}
		...
		public global::KnockOff.IMethodSequence<GetAsyncDelegate> OnCallSequence(GetAsyncDelegate callback)
		{
			_onCall = null;
			_onCallTracking = null;
			_hasOnCallValue = false;
			...
			_isVerifiable = false;
			_verifiableTimes = null;
			_sequence = new global::System.Collections.Generic.List<(GetAsyncDelegate Callback, MethodTrackingImpl Tracking)>();
		...
		internal global::System.Threading.Tasks.Task<T?> Invoke(bool strict)
		{
			...
			if (_sequence != null && _sequenceIndex >= _sequence.Count)
			{
				if (strict) throw global::KnockOff.StubException.SequenceExhausted("GetAsync");
		...
		internal global::KnockOff.VerificationFailure? CheckVerification()
		{
			...
			return times.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetAsync", times, TotalCallCount);
		}
		...
		internal global::KnockOff.VerificationFailure? CheckVerificationAll()
		{
			...
			return global::KnockOff.Times.AtLeastOnce.Validate(TotalCallCount) ? null : new global::KnockOff.VerificationFailure("GetAsync", global::KnockOff.Times.AtLeastOnce, TotalCallCount);
		}
		...
		private sealed class MethodTrackingImpl : global::KnockOff.IMethodTracking
		{
			...
			public MethodTrackingImpl(GetAsyncInterceptor interceptor) => _interceptor = interceptor;
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetAsyncDelegate>
		{
			...
			public global::KnockOff.IMethodSequence<GetAsyncDelegate> ThenCall(GetAsyncDelegate callback)
			{
			...
			public global::KnockOff.IMethodSequence<GetAsyncDelegate> Verifiable()
			{
				_interceptor._isVerifiable = true;
				_interceptor._verifiableTimes = null;
				return this;
	...
	public void Verify()
	{
		...
		if (GetAsync.CheckVerification() is { } getasyncFailure) failures.Add(getasyncFailure);
	...
	public void VerifyAll()
	{
		...
		if (GetAsync.CheckVerificationAll() is { } getasyncFailure) failures.Add(getasyncFailure);
