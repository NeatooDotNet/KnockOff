...
partial class ReadOnlyCollectionStringStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class IReadOnlyCollection_CountInterceptor
		{
			...
			public IReadOnlyCollection_CountInterceptor Verifiable() { _isGetVerifiable = true; _getVerifiableTimes = null; return this; }
			...
			public IReadOnlyCollection_CountInterceptor Verifiable(global::KnockOff.Times times) { _isGetVerifiable = true; _getVerifiableTimes = times; return this; }
			...
			{
				private readonly IReadOnlyCollection_CountInterceptor _interceptor;

				public PropertyGetTrackingImpl(IReadOnlyCollection_CountInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class PropertyGetSequenceImpl : global::KnockOff.IPropertyGetSequence<int>
			{
				...
				public PropertyGetSequenceImpl(IReadOnlyCollection_CountInterceptor interceptor) => _interceptor = interceptor;
		...
		public sealed class IReadOnlyCollection_GetEnumeratorInterceptor
		{
			...
			{
				private readonly IReadOnlyCollection_GetEnumeratorInterceptor _interceptor;

				public MethodTrackingImpl(IReadOnlyCollection_GetEnumeratorInterceptor interceptor) => _interceptor = interceptor;
			...
			private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<GetEnumeratorDelegate>
			{
				...
				public MethodSequenceImpl(IReadOnlyCollection_GetEnumeratorInterceptor interceptor) => _interceptor = interceptor;
