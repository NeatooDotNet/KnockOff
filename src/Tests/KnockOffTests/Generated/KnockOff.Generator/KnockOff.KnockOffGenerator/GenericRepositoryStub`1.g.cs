...
partial class GenericRepositoryStub<T> : global::KnockOff.Tests.IGenericRepository<T>, global::KnockOff.IKnockOffStub where T : class
{
	...
	public sealed class SaveInterceptor
	{
		...
		/// <summary>Configures callback with Times constraint. Returns sequence for ThenCall chaining.</summary>
		public global::KnockOff.IMethodSequence<global::System.Action<GenericRepositoryStub<T>, T>> OnCall(global::System.Action<GenericRepositoryStub<T>, T> callback, global::KnockOff.Times times)
		{
			var tracking = new MethodTrackingImpl();
			_sequence.Clear();
			_sequence.Add((callback, times, tracking));
		...
		private sealed class MethodSequenceImpl : global::KnockOff.IMethodSequence<global::System.Action<GenericRepositoryStub<T>, T>>
		{
			...
			/// <summary>Add another callback to the sequence.</summary>
			public global::KnockOff.IMethodSequence<global::System.Action<GenericRepositoryStub<T>, T>> ThenCall(global::System.Action<GenericRepositoryStub<T>, T> callback, global::KnockOff.Times times)
			{
				var tracking = new MethodTrackingImpl();
				_interceptor._sequence.Add((callback, times, tracking));
				return this;
