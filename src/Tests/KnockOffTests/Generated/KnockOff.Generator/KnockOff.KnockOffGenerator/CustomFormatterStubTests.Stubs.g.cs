...
partial class CustomFormatterStubTests
{
	...
	public static class Stubs
	{
		...
		public sealed class ICustomFormatter_FormatInterceptor
		{
			...
			public (string? format, object? arg, global::System.IFormatProvider? formatProvider)? LastCallArgs { get { foreach (var s in _sequence) if (s.Tracking.CallCount > 0) return s.Tracking.LastArgs; return _unconfiguredCallCount > 0 ? _unconfiguredLastArgs : default; } }
