...
partial class NestedValidateStub : global::Neatoo.IValidateBase, global::System.ComponentModel.INotifyPropertyChanged, global::Neatoo.INotifyNeatooPropertyChanged, global::Neatoo.IValidateMetaProperties, global::KnockOff.IKnockOffStub
{
	...
	public sealed class WaitForTasks1Interceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task WaitForTasksDelegate(NestedValidateStub ko);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(NestedValidateStub ko, bool strict)
		{
			if (_sequence.Count == 0)
			{
	...
	{
		/// <summary>Delegate for WaitForTasks.</summary>
		public delegate global::System.Threading.Tasks.Task WaitForTasksDelegate(NestedValidateStub ko, global::System.Threading.CancellationToken token);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(NestedValidateStub ko, bool strict, global::System.Threading.CancellationToken token)
		{
			if (_sequence.Count == 0)
			{
				if (strict) throw global::KnockOff.StubException.NotConfigured("", "WaitForTasks");
	...
	public sealed class RunRules1Interceptor
	{
		...
		public delegate global::System.Threading.Tasks.Task RunRulesDelegate(NestedValidateStub ko, string propertyName, global::System.Threading.CancellationToken? token);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(NestedValidateStub ko, bool strict, string propertyName, global::System.Threading.CancellationToken? token)
		{
			if (_sequence.Count == 0)
			{
	...
	{
		/// <summary>Delegate for RunRules.</summary>
		public delegate global::System.Threading.Tasks.Task RunRulesDelegate(NestedValidateStub ko, global::Neatoo.RunRulesFlag runRules, global::System.Threading.CancellationToken? token);
		...
		/// <summary>Invokes the configured callback. Called by explicit interface implementation.</summary>
		internal global::System.Threading.Tasks.Task Invoke(NestedValidateStub ko, bool strict, global::Neatoo.RunRulesFlag runRules, global::System.Threading.CancellationToken? token)
		{
			if (_sequence.Count == 0)
			{
				if (strict) throw global::KnockOff.StubException.NotConfigured("", "RunRules");
