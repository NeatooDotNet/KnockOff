...
<!-- snippet: framework-comparison-order-success-moq -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-order-success-knockoff -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-order-success-rocks -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-order-payment-failure-moq -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-order-payment-failure-knockoff -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-order-payment-failure-rocks -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-cache-hit-moq -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-cache-hit-knockoff -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-cache-hit-rocks -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-cache-miss-moq -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-cache-miss-knockoff -->
```cs
[Fact]
...
<!-- snippet: framework-comparison-cache-miss-rocks -->
```cs
[Fact]
