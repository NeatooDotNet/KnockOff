# v0.6.0 - Generic Methods Support

**Release Date:** 2026-01-04
**NuGet:** [KnockOff 0.6.0](https://nuget.org/packages/KnockOff/0.6.0)
...
knockOff.ISerializer.Deserialize.Of<User>().OnCall = ((json) =>
    JsonSerializer.Deserialize<User>(json)!;

// Different behavior for different types
knockOff.ISerializer.Deserialize.Of<Order>().OnCall = ((json) =>
    new Order { Id = 123 };
```
...
```csharp
knockOff.ISerializer.Convert.Of<string, int>().OnCall = ((s) => s.Length;
knockOff.ISerializer.Convert.Of<int, string>().OnCall = ((i) => i.ToString();
...
**Full Changelog**: https://github.com/NeatooDotNet/KnockOff/compare/v0.5.2...v0.6.0
