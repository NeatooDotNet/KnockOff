# v0.20.0 - Open Generic Delegate and Class Stubs

**Release Date:** 2026-01-15

## Summary

This release completes open generic inline stub support by adding delegates and classes to the existing interface support from v0.18.
...
userRepo.GetById.OnCall = ((id) => new User { Id = id };
