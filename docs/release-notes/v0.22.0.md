...
// Set up sequence
knockOff.GetById
    .OnCall((id) => new User { Id = 100 }, Times.Once)
    .ThenCall(((id) => new User { Id = 200 }, Times.Forever);
...
var lastId = knockOff.GetById.LastCallArg;  // ✓ 2
```
...
No migration required. This is a drop-in replacement for v0.21.0.
