...
**NuGet:** [KnockOff 0.4.1](https://nuget.org/packages/KnockOff/0.4.1)
...
// Configure behavior (v0.5.0+ syntax)
stub.IEntityBase.IsNew.OnGet = () => true;
stub.IEntityBase.IsModified.OnGet = () => true;
...
Requires: **Neatoo 10.2.0+** and **KnockOff 0.5.0+**

---

**Full Changelog**: https://github.com/NeatooDotNet/KnockOff/compare/v0.4.0...v0.4.1
