# v10.7.0 - Zero-Allocation Call Tracking
...
Breaking change that removes `AllCalls`, `AllGetKeys`, and `AllSetEntries` properties for zero-allocation call tracking, dramatically improving benchmark performance.
