# v0.7.0 - Breaking Changes Release

**Release Date:** 2026-01-06
**NuGet:** [KnockOff 0.7.0](https://nuget.org/packages/KnockOff/0.7.0)
...
knockOff.IService.GetUser.OnCall = ((id) =>
{
    allCalls.Add(id);
...
**Full Changelog**: https://github.com/NeatooDotNet/KnockOff/compare/v0.6.0...v0.7.0
