# v0.8.0 - Inline Stubs, Delegates, and Class Stubs

**Release Date:** 2026-01-07
**NuGet:** [KnockOff 0.8.0](https://nuget.org/packages/KnockOff/0.8.0)
...
public partial class MyTests
{
    ...
    public void Test()
    {
        ...
        userStub.GetUser.OnCall = ((id) => new User { Id = id };
...
public partial class ValidationTests
{
    ...
    public void Test()
    {
        ...
        stub.Interceptor.OnCall = ((value) => value != "duplicate";
...
> **Note:** The class stub API was changed in v0.9.0 to use composition instead of inheritance. See [v0.9.0 release notes](v0.9.0.md) for migration details.
...
knockOff.IUserService.GetUser.OnCall = ((id) => new User();
```
...
**Full Changelog**: https://github.com/NeatooDotNet/KnockOff/compare/v0.7.0...v0.8.0
