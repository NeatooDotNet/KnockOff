...
**Priority:** High
**Created:** 2026-02-05
**Last Updated:** 2026-02-05 (architect investigation)
...
**Affected generator locations:**

1. `WhenChainRenderer.cs` - `WhenChainImpl.Verify()` method
2. `MethodInterceptorRenderer.cs` - `CheckVerification()` single-signature
3. `MethodInterceptorRenderer.cs` - `CheckVerification()` multi-overload
4. `MethodInterceptorRenderer.cs` - `CheckVerificationAll()`
...
- [ ] Fix generator verification logic
- [ ] Verify all existing tests still pass
- [ ] Verify `UpdateTest_KnockOff_OnCall` passes
