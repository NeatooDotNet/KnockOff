...
|--|---------------------|-----------------|
| **Open Generic Interface** | ✅ Supported (v0.14)<br>`[KnockOff] class Stub<T> : IRepo<T>` | ✅ Supported (v0.18)<br>`[KnockOff(typeof(IRepo<>))]` |
| **Open Generic Class** | ❌ Not Supported<br>Standalone requires interface implementation | ✅ Supported (v0.20)<br>`[KnockOff(typeof(SomeClass<>))]` |
| **Open Generic Delegate** | ❌ Impossible<br>Can't inherit from delegates | ✅ Supported (v0.20)<br>`[KnockOff(typeof(Factory<>))]` |
...
|------|------|---------|----------|-------|
| ~~[generic-delegate-support.md](completed/generic-delegate-support.md)~~ | Delegate | Inline | ✅ Done | Completed in v0.20 |
| ~~[generic-inline-interface-support.md](generic-inline-interface-support.md)~~ | Interface | Inline | ✅ Done | Completed in v0.18 |
| ~~[generic-inline-class-support.md](completed/generic-inline-class-support.md)~~ | Class | Inline | ✅ Done | Completed in v0.20 |
...
- [x] Implement open generic delegate inline stubs → **Completed v0.20**
- [x] Implement open generic interface inline stubs → **Completed v0.18** (includes multi-param generics like `IKeyValueStore<TKey, TValue>` and type constraints like `where T : class`)
- [x] Implement open generic class inline stubs → **Completed v0.20**
