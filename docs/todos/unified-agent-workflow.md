...
- [ ] Update project-todos skill with role-specific guidance
- [ ] Update project-todos skill with enhanced plan template sections
- [ ] Update knockoff-architect agent with workflow integration
- [ ] Update knockoff-developer agent with workflow integration
- [ ] Update CLAUDE.md with plan mode directive
- [ ] Test the complete workflow with a sample feature request
