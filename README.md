...
For side-by-side comparisons of methods, argument matching, argument capture, properties, events, delegates, and indexers, see the [complete comparison guide](docs/comparison.md).
